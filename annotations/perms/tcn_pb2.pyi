...
class Tcn(_message.Message):
    __slots__ = ("wip", "app", "card", "features", "blacklisted")
    ...
    blacklisted: bool
    def __init__(self, wip: bool = ..., app: _Optional[_Union[_license_pb2.Application, str]] = ..., card: _Optional[_Union[_license_pb2.Card, str]] = ..., features: _Optional[_Iterable[str]] = ..., blacklisted: bool = ...) -> None: ...
