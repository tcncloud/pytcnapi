...
class Transcript(_message.Message):
    __slots__ = ("call", "sms", "org_id", "channel", "start_time", "create_time", "delete_time", "flag_summary", "transcript_sid")
