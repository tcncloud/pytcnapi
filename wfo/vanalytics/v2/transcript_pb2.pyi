...
class Transcript(_message.Message):
    __slots__ = ("call", "sms", "chat", "email", "channel", "start_time", "delete_time", "flag_summary", "transcript_sid", "summary")
    ...
    def __init__(self, call: _Optional[_Union[Call, _Mapping]] = ..., sms: _Optional[_Union[Sms, _Mapping]] = ..., chat: _Optional[_Union[Chat, _Mapping]] = ..., email: _Optional[_Union[Email, _Mapping]] = ..., channel: _Optional[_Union[_omnichannel_pb2.ChannelType, str]] = ..., start_time: _Optional[_Union[datetime.datetime, _timestamp_pb2.Timestamp, _Mapping]] = ..., delete_time: _Optional[_Union[datetime.datetime, _timestamp_pb2.Timestamp, _Mapping]] = ..., flag_summary: _Optional[_Union[FlagSummary, _Mapping]] = ..., transcript_sid: _Optional[int] = ..., summary: _Optional[_Union[_transcript_summary_pb2.TranscriptSummary, _Mapping]] = ...) -> None: ...
...
class FlagSummary(_message.Message):
    ...
    class Flag(_message.Message):
        ...
        def __init__(self, flag_sid: _Optional[int] = ..., name: _Optional[str] = ..., priority: _Optional[int] = ..., version: _Optional[int] = ..., filters: _Optional[_Iterable[_Union[FlagSummary.Filter, _Mapping]]] = ..., must_review: _Optional[bool] = ..., must_notify: _Optional[bool] = ..., reviews: _Optional[_Iterable[_Union[FlagSummary.Review, _Mapping]]] = ...) -> None: ...
...
class Sms(_message.Message):
    ...
    class Segment(_message.Message):
        ...
        def __init__(self, text: _Optional[str] = ..., offset: _Optional[_Union[datetime.timedelta, _duration_pb2.Duration, _Mapping]] = ..., attachments: _Optional[_Iterable[_Union[Sms.Segment.Attachment, _Mapping]]] = ...) -> None: ...
...
class Call(_message.Message):
    ...
    class Segment(_message.Message):
        ...
        def __init__(self, text: _Optional[str] = ..., offset: _Optional[_Union[datetime.timedelta, _duration_pb2.Duration, _Mapping]] = ..., duration: _Optional[_Union[datetime.timedelta, _duration_pb2.Duration, _Mapping]] = ...) -> None: ...
    class TalkOver(_message.Message):
        ...
        class Duration(_message.Message):
            ...
            percentage: int
            def __init__(self, total: _Optional[_Union[datetime.timedelta, _duration_pb2.Duration, _Mapping]] = ..., max: _Optional[_Union[datetime.timedelta, _duration_pb2.Duration, _Mapping]] = ..., percentage: _Optional[int] = ...) -> None: ...
...
class Chat(_message.Message):
    ...
    class Segment(_message.Message):
        ...
        text: str
        offset: _duration_pb2.Duration
        def __init__(self, text: _Optional[str] = ..., offset: _Optional[_Union[datetime.timedelta, _duration_pb2.Duration, _Mapping]] = ...) -> None: ...
    class Phone(_message.Message):
        __slots__ = ("raw",)
        RAW_FIELD_NUMBER: _ClassVar[int]
        raw: str
...
class Email(_message.Message):
    __slots__ = ("conversation_sid", "threads", "client_email_address", "agent_email_address", "campaign_sid", "agent_response")
    class AgentResponseEntry(_message.Message):
        __slots__ = ("key", "value")
        KEY_FIELD_NUMBER: _ClassVar[int]
        VALUE_FIELD_NUMBER: _ClassVar[int]
        key: str
        value: Email.AgentResponse
        def __init__(self, key: _Optional[str] = ..., value: _Optional[_Union[Email.AgentResponse, _Mapping]] = ...) -> None: ...
    class AgentResponse(_message.Message):
        __slots__ = ("values",)
        VALUES_FIELD_NUMBER: _ClassVar[int]
        values: _containers.RepeatedScalarFieldContainer[str]
    ...
    class Thread(_message.Message):
        ...
        SENTIMENT_FIELD_NUMBER: _ClassVar[int]
        id: int
        segments: _containers.RepeatedCompositeFieldContainer[Email.Segment]
        user_id: str
        sentiment: Sentiment
        def __init__(self, id: _Optional[int] = ..., segments: _Optional[_Iterable[_Union[Email.Segment, _Mapping]]] = ..., user_id: _Optional[str] = ..., sentiment: _Optional[_Union[Sentiment, _Mapping]] = ...) -> None: ...
    class Segment(_message.Message):
        __slots__ = ("text", "offset", "attachments")
        class Attachment(_message.Message):
            __slots__ = ("attachment_sid",)
        ...
        text: str
        offset: _duration_pb2.Duration
        attachments: _containers.RepeatedCompositeFieldContainer[Email.Segment.Attachment]
        def __init__(self, text: _Optional[str] = ..., offset: _Optional[_Union[datetime.timedelta, _duration_pb2.Duration, _Mapping]] = ..., attachments: _Optional[_Iterable[_Union[Email.Segment.Attachment, _Mapping]]] = ...) -> None: ...
    CONVERSATION_SID_FIELD_NUMBER: _ClassVar[int]
    THREADS_FIELD_NUMBER: _ClassVar[int]
    CLIENT_EMAIL_ADDRESS_FIELD_NUMBER: _ClassVar[int]
    AGENT_EMAIL_ADDRESS_FIELD_NUMBER: _ClassVar[int]
    CAMPAIGN_SID_FIELD_NUMBER: _ClassVar[int]
    AGENT_RESPONSE_FIELD_NUMBER: _ClassVar[int]
    conversation_sid: int
    threads: _containers.RepeatedCompositeFieldContainer[Email.Thread]
    client_email_address: str
    agent_email_address: str
    campaign_sid: int
    agent_response: _containers.MessageMap[str, Email.AgentResponse]
    def __init__(self, conversation_sid: _Optional[int] = ..., threads: _Optional[_Iterable[_Union[Email.Thread, _Mapping]]] = ..., client_email_address: _Optional[str] = ..., agent_email_address: _Optional[str] = ..., campaign_sid: _Optional[int] = ..., agent_response: _Optional[_Mapping[str, Email.AgentResponse]] = ...) -> None: ...
...
class Sentiment(_message.Message):
    ...
    class Sample(_message.Message):
        ...
        offset: _duration_pb2.Duration
        duration: _duration_pb2.Duration
        def __init__(self, estimate: _Optional[_Union[Sentiment.Estimate, _Mapping]] = ..., offset: _Optional[_Union[datetime.timedelta, _duration_pb2.Duration, _Mapping]] = ..., duration: _Optional[_Union[datetime.timedelta, _duration_pb2.Duration, _Mapping]] = ...) -> None: ...
...
class TranscriptQuery(_message.Message):
    ...
    class Metadata(_message.Message):
        ...
        email: TranscriptQuery.Email
        def __init__(self, call: _Optional[_Union[TranscriptQuery.Call, _Mapping]] = ..., sms: _Optional[_Union[TranscriptQuery.Sms, _Mapping]] = ..., chat: _Optional[_Union[TranscriptQuery.Chat, _Mapping]] = ..., email: _Optional[_Union[TranscriptQuery.Email, _Mapping]] = ...) -> None: ...
    class Call(_message.Message):
    ...
    class Email(_message.Message):
        __slots__ = ("conversation_sid", "campaign_sid", "client_email_address", "agent_email_address")
        class ConversationSid(_message.Message):
            __slots__ = ("any",)
            ANY_FIELD_NUMBER: _ClassVar[int]
            any: _containers.RepeatedScalarFieldContainer[int]
        ...
        class CampaignSid(_message.Message):
            ...
            any: _containers.RepeatedScalarFieldContainer[int]
            def __init__(self, any: _Optional[_Iterable[int]] = ...) -> None: ...
        class ClientEmailAddress(_message.Message):
            __slots__ = ("any",)
            ANY_FIELD_NUMBER: _ClassVar[int]
            any: _containers.RepeatedScalarFieldContainer[str]
            def __init__(self, any: _Optional[_Iterable[str]] = ...) -> None: ...
        class AgentEmailAddress(_message.Message):
            __slots__ = ("any",)
            ANY_FIELD_NUMBER: _ClassVar[int]
            any: _containers.RepeatedScalarFieldContainer[str]
            def __init__(self, any: _Optional[_Iterable[str]] = ...) -> None: ...
        ...
        CLIENT_EMAIL_ADDRESS_FIELD_NUMBER: _ClassVar[int]
        AGENT_EMAIL_ADDRESS_FIELD_NUMBER: _ClassVar[int]
        conversation_sid: TranscriptQuery.Email.ConversationSid
        campaign_sid: TranscriptQuery.Email.CampaignSid
        client_email_address: TranscriptQuery.Email.ClientEmailAddress
        agent_email_address: TranscriptQuery.Email.AgentEmailAddress
        def __init__(self, conversation_sid: _Optional[_Union[TranscriptQuery.Email.ConversationSid, _Mapping]] = ..., campaign_sid: _Optional[_Union[TranscriptQuery.Email.CampaignSid, _Mapping]] = ..., client_email_address: _Optional[_Union[TranscriptQuery.Email.ClientEmailAddress, _Mapping]] = ..., agent_email_address: _Optional[_Union[TranscriptQuery.Email.AgentEmailAddress, _Mapping]] = ...) -> None: ...
    class AgentResponse(_message.Message):
        __slots__ = ("key", "values", "numbers")
        class Values(_message.Message):
            __slots__ = ("starts_with", "contains")
    ...
    class Threads(_message.Message):
        ...
        class Text(_message.Message):
            ...
            class Timespan(_message.Message):
                ...
                def __init__(self, head: _Optional[_Union[datetime.timedelta, _duration_pb2.Duration, _Mapping]] = ..., tail: _Optional[_Union[datetime.timedelta, _duration_pb2.Duration, _Mapping]] = ...) -> None: ...
...
class SpanNear(_message.Message):
    ...
    def __init__(self, slop: _Optional[int] = ..., in_order: _Optional[bool] = ..., clauses: _Optional[_Iterable[_Union[SpanNear.Clause, _Mapping]]] = ...) -> None: ...
