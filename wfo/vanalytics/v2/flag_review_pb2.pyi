...
class FlagReview(_message.Message):
    ...
    def __init__(self, flag_review_sid: _Optional[int] = ..., transcript_sid: _Optional[int] = ..., create_time: _Optional[_Union[_timestamp_pb2.Timestamp, _Mapping]] = ..., notes: _Optional[str] = ..., flag_snapshot_sid: _Optional[int] = ...) -> None: ...
