...
class GetFilterRequest(_message.Message):
    __slots__ = ("name", "filter_sid")
    NAME_FIELD_NUMBER: _ClassVar[int]
    FILTER_SID_FIELD_NUMBER: _ClassVar[int]
    name: str
    filter_sid: int
    def __init__(self, name: _Optional[str] = ..., filter_sid: _Optional[int] = ...) -> None: ...

class Filter(_message.Message):
    __slots__ = ("filter_sid", "name", "create_time", "version", "transcript_query")
    FILTER_SID_FIELD_NUMBER: _ClassVar[int]
    NAME_FIELD_NUMBER: _ClassVar[int]
    ...
    def __init__(self, filter_sid: _Optional[int] = ..., name: _Optional[str] = ..., create_time: _Optional[_Union[datetime.datetime, _timestamp_pb2.Timestamp, _Mapping]] = ..., version: _Optional[int] = ..., transcript_query: _Optional[_Union[_transcript_pb2.TranscriptQuery, _Mapping]] = ...) -> None: ...
