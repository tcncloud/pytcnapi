...
from wfo.vanalytics.v2 import filter_snapshot_pb2 as _filter_snapshot_pb2
...
class ListFlagTranscriptFiltersRequest(_message.Message):
    __slots__ = ("transcript_sid", "flag_snapshot_mask", "filter_snapshot_mask")
...
class ListFlagTranscriptFiltersResponse(_message.Message):
    __slots__ = ("flag_transcript_filters",)
...
class FlagTranscriptFilter(_message.Message):
    __slots__ = ("flag_snapshot", "filter_snapshot")
