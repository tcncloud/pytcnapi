...
class OmniMessage(_message.Message):
    __slots__ = ("message_sid", "user_id", "sent_from", "sent_to", "channel_type", "reference_id", "ui_reference_id", "payload", "conversation_sid", "status", "date_created", "date_modified", "campaign_sid", "subject", "sender_type", "status_message", "sent_bcc")
    ...
    SENT_BCC_FIELD_NUMBER: _ClassVar[int]
    message_sid: int
    user_id: _wrappers_pb2.StringValue
    sent_from: str
    sent_to: str
