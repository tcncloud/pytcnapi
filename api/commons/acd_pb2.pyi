...
class TransferMember(_message.Message):
    __slots__ = ("identifier", "display_label", "member_type", "agent_session", "caller_sid", "outbound_id", "caller_id", "destination_number")
    ...
    def __init__(self, identifier: _Optional[str] = ..., display_label: _Optional[str] = ..., member_type: _Optional[_Union[TransferMemberType, str]] = ..., agent_session: _Optional[_Union[AgentSession, _Mapping]] = ..., caller_sid: _Optional[_Union[CallerSid, _Mapping]] = ..., outbound_id: _Optional[str] = ..., caller_id: _Optional[str] = ..., destination_number: _Optional[str] = ...) -> None: ...
