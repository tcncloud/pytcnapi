...
class NodeDefinition(_message.Message):
    __slots__ = ["id", "name", "description", "outputs", "error_node_id", "print", "random", "console_input", "comparator", "store_input", "chatbot", "omni_prompt", "omni_set_skill", "omni_to_agent", "omni_error", "omni_inject", "omni_inject_message", "omni_send_message", "omni_store", "omni_compare", "omni_bot_test_start", "omni_bot_test_step", "omni_bot_test_end", "test_bot_test_start", "test_bot_test_step", "test_bot_test_end"]
    ...
    OMNI_INJECT_MESSAGE_FIELD_NUMBER: _ClassVar[int]
    ...
    omni_inject_message: _omni_pb2.OmniNodeInjectMessage
