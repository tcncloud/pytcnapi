...
class NodeDefinition(_message.Message):
    __slots__ = ["id", "name", "description", "outputs", "error_node_id", "print", "random", "console_input", "comparator", "store_input", "chatbot", "omni_prompt", "omni_set_skill", "omni_to_agent", "omni_error", "omni_webhook", "omni_scrublist", "omni_end_conversation", "omni_bot_test_start", "omni_bot_test_step", "omni_bot_test_end", "test_bot_test_start", "test_bot_test_step", "test_bot_test_end"]
