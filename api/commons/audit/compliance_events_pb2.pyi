...
class ComplianceRndQueryEvent(_message.Message):
    ...
    def __init__(self, org_id: _Optional[str] = ..., phone_number: _Optional[str] = ..., result: _Optional[str] = ..., date_last_contact: _Optional[_Union[_timestamp_pb2.Timestamp, _Mapping]] = ...) -> None: ...
