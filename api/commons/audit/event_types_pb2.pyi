...
class EventType(int, metaclass=_enum_type_wrapper.EnumTypeWrapper):
    ...
    TICKET_TMPLATE_EDIT_EVENT: _ClassVar[EventType]
    TICKET_TMPLATE_CLOSE_EVENT: _ClassVar[EventType]
...
TICKET_TMPLATE_EDIT_EVENT: EventType
TICKET_TMPLATE_CLOSE_EVENT: EventType
