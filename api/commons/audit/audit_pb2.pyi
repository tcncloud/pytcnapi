...
from api.commons.audit import contactmanager_events_pb2 as _contactmanager_events_pb2
...
from api.commons.audit import organization_events_pb2 as _organization_events_pb2
from api.commons.audit import p3_amqp_events_pb2 as _p3_amqp_events_pb2
...
from api.commons.audit import wfm_events_pb2 as _wfm_events_pb2
...
class AuditEvent(_message.Message):
    ...
    VANA_CREATE_TRANSCRIPT_EVENT_FIELD_NUMBER: _ClassVar[int]
    VANA_CREATE_SENTIMENT_EVENT_FIELD_NUMBER: _ClassVar[int]
    VANA_CREATE_SUMMARY_EVENT_FIELD_NUMBER: _ClassVar[int]
    ...
    OMNICHANNEL_MESSAGE_SENT_EVENT_FIELD_NUMBER: _ClassVar[int]
    OMNICHANNEL_PROVIDER_RESPONSE_EVENT_FIELD_NUMBER: _ClassVar[int]
    OMNICHANNEL_PROVIDER_MESSAGE_FAILED_EVENT_FIELD_NUMBER: _ClassVar[int]
    OMNICHANNEL_INBOUND_PROVIDER_MESSAGE_EVENT_FIELD_NUMBER: _ClassVar[int]
    ...
    SCORECARDS_CREATE_SMART_EVALUATION_EVENT_FIELD_NUMBER: _ClassVar[int]
    TICKET_EVENT_FIELD_NUMBER: _ClassVar[int]
    TICKET_CUSTOM_FIELD_CREATE_EVENT_FIELD_NUMBER: _ClassVar[int]
    TICKET_CUSTOM_FIELD_EDIT_EVENT_FIELD_NUMBER: _ClassVar[int]
    ...
    BILLING_RATED_ITEMS_GENERATED_EVENT_FIELD_NUMBER: _ClassVar[int]
    BILLING_ACCUMULATE_ITEMS_EVENT_FIELD_NUMBER: _ClassVar[int]
    DELIVERY_FAILURE_EVENT_FIELD_NUMBER: _ClassVar[int]
    DELIVERY_SUCCESS_EVENT_FIELD_NUMBER: _ClassVar[int]
    CONTACT_MANAGER_ENTRY_ADD_EVENT_FIELD_NUMBER: _ClassVar[int]
    CONTACT_MANAGER_ENTRY_GET_ENC_EVENT_FIELD_NUMBER: _ClassVar[int]
    CONTACT_MANAGER_DELETE_EVENT_FIELD_NUMBER: _ClassVar[int]
    CONTACT_MANAGER_KYC_EVENT_FIELD_NUMBER: _ClassVar[int]
    CONTACT_MANAGER_ENTRY_EDIT_EVENT_FIELD_NUMBER: _ClassVar[int]
    CONTACT_MANAGER_LIST_UPLOAD_EVENT_FIELD_NUMBER: _ClassVar[int]
    CONTACT_MANAGER_KYC_VERIFICATION_EVENT_FIELD_NUMBER: _ClassVar[int]
    CONTACT_MANAGER_ENTRY_DELETE_EVENT_FIELD_NUMBER: _ClassVar[int]
    CONTACT_MANAGER_ENTRY_EXPUNGE_EVENT_FIELD_NUMBER: _ClassVar[int]
    CONTACT_MANAGER_ENTITY_ASSOCIATION_EVENT_FIELD_NUMBER: _ClassVar[int]
    ACCESS_TOKENS_EXPIRING_EVENT_FIELD_NUMBER: _ClassVar[int]
    WFM_PUBLISH_SCHEDULE_EVENT_FIELD_NUMBER: _ClassVar[int]
    P3_AMQP_CALL_RESULT_EVENT_FIELD_NUMBER: _ClassVar[int]
    P3_AMQP_AGENT_RESPONSE_EVENT_FIELD_NUMBER: _ClassVar[int]
    org_id: str
    region_id: str
    cluster_id: str
    ...
    vana_create_transcript_event: _vana_events_pb2.VanaCreateTranscriptEvent
    vana_create_sentiment_event: _vana_events_pb2.VanaCreateSentimentEvent
    vana_create_summary_event: _vana_events_pb2.VanaCreateSummaryEvent
    ...
    omnichannel_message_sent_event: _omnichannel_events_pb2.OmnichannelMessageSentEvent
    omnichannel_provider_response_event: _omnichannel_events_pb2.OmnichannelProviderResponseEvent
    omnichannel_provider_message_failed_event: _omnichannel_events_pb2.OmnichannelProviderMessageFailedEvent
    omnichannel_inbound_provider_message_event: _omnichannel_events_pb2.OmnichannelInboundProviderMessageEvent
    ...
    scorecards_create_smart_evaluation_event: _scorecards_events_pb2.ScorecardsCreateSmartEvaluationEvent
    ticket_event: _tickets_events_pb2.TicketEvent
    ticket_custom_field_create_event: _tickets_events_pb2.TicketCustomFieldCreateEvent
    ticket_custom_field_edit_event: _tickets_events_pb2.TicketCustomFieldEditEvent
    ...
    billing_rated_items_generated_event: _billing_events_pb2.BillingRatedItemsGeneratedEvent
    billing_accumulate_items_event: _billing_events_pb2.BillingAccumulateItemsEvent
