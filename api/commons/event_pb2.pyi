...
class Event(_message.Message):
    __slots__ = ("state", "event_time", "activated_conversation_event", "deactivated_conversation_event", "sent_message_event", "send_status_event", "pause_event", "resume_event")
...
class SentMessageEvent(_message.Message):
    __slots__ = ("response_time_seconds", "is_initial_agent_message", "conversation")
    ...
    conversation: _omnichannel_pb2.OmniConversation
    def __init__(self, response_time_seconds: _Optional[int] = ..., is_initial_agent_message: bool = ..., conversation: _Optional[_Union[_omnichannel_pb2.OmniConversation, _Mapping]] = ...) -> None: ...
...
class AsmEvent(_message.Message):
    __slots__ = ("state", "event_time", "activated_conversation_asm_event", "deactivated_conversation_asm_event", "sent_message_asm_event", "send_status_asm_event", "pause_event", "resume_event", "conversation_pulled_event")
    STATE_FIELD_NUMBER: _ClassVar[int]
    EVENT_TIME_FIELD_NUMBER: _ClassVar[int]
