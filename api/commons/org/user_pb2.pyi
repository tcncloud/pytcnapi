...
class UserMfaInfo(_message.Message):
    ...
    class OtpType(_message.Message):
        ...
        EMAIL_FIELD_NUMBER: _ClassVar[int]
        email: UserMfaInfo.OtpType.EmailDeliveryMethod
        def __init__(self, email: _Optional[_Union[UserMfaInfo.OtpType.EmailDeliveryMethod, _Mapping]] = ...) -> None: ...
    MFA_ENABLED_FIELD_NUMBER: _ClassVar[int]
    MFA_LOCKED_OUT_FIELD_NUMBER: _ClassVar[int]
    NONE_FIELD_NUMBER: _ClassVar[int]
    OTP_FIELD_NUMBER: _ClassVar[int]
    mfa_enabled: bool
    mfa_locked_out: bool
    none: UserMfaInfo.NoneSelected
    otp: UserMfaInfo.OtpType
    def __init__(self, mfa_enabled: bool = ..., mfa_locked_out: bool = ..., none: _Optional[_Union[UserMfaInfo.NoneSelected, _Mapping]] = ..., otp: _Optional[_Union[UserMfaInfo.OtpType, _Mapping]] = ...) -> None: ...
