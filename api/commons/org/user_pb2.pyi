...
class MfaInfo(_message.Message):
    __slots__ = ("user_id", "mfa_enabled", "none", "otp")
    ...
    otp: MfaInfo.OtpType
    def __init__(self, user_id: _Optional[str] = ..., mfa_enabled: bool = ..., none: _Optional[_Union[MfaInfo.NoneSelected, _Mapping]] = ..., otp: _Optional[_Union[MfaInfo.OtpType, _Mapping]] = ...) -> None: ...
