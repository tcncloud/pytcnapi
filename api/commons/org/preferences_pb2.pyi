...
class OrganizationPreferences(_message.Message):
    __slots__ = ("org_id", "default_country", "time_zone", "display_language", "operator_display_language", "operator_script_direction")
    ...
    OPERATOR_SCRIPT_DIRECTION_FIELD_NUMBER: _ClassVar[int]
    org_id: str
    default_country: _country_pb2.Country
    time_zone: _org_pb2.TimeZone
    display_language: _org_pb2.DisplayLanguage
    operator_display_language: _org_pb2.OperatorDisplayLanguage
    operator_script_direction: _org_pb2.OperatorScriptDirection
    def __init__(self, org_id: _Optional[str] = ..., default_country: _Optional[_Union[_country_pb2.Country, str]] = ..., time_zone: _Optional[_Union[_org_pb2.TimeZone, str]] = ..., display_language: _Optional[_Union[_org_pb2.DisplayLanguage, str]] = ..., operator_display_language: _Optional[_Union[_org_pb2.OperatorDisplayLanguage, str]] = ..., operator_script_direction: _Optional[_Union[_org_pb2.OperatorScriptDirection, str]] = ...) -> None: ...
