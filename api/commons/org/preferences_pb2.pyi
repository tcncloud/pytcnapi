...
class AuthenticationPreferences(_message.Message):
    __slots__ = ("org_id", "authorization_via_ip", "allowed_ips", "agent_api_key", "enable_2fa", "block_unverified_users", "email_mfa_settings", "duo_mfa_settings", "enable_force_password_reset_interval", "password_reset_day_interval")
    ...
    ENABLE_FORCE_PASSWORD_RESET_INTERVAL_FIELD_NUMBER: _ClassVar[int]
