...
class OrganizationPreferences(_message.Message):
    __slots__ = ("org_id", "default_country", "time_zone", "display_language", "operator_display_language", "use_script_direction_rigth_to_left")
    ...
    USE_SCRIPT_DIRECTION_RIGTH_TO_LEFT_FIELD_NUMBER: _ClassVar[int]
    org_id: str
    default_country: _country_pb2.Country
    time_zone: _org_pb2.TimeZone
    display_language: _org_pb2.DisplayLanguage
    operator_display_language: str
    use_script_direction_rigth_to_left: bool
    def __init__(self, org_id: _Optional[str] = ..., default_country: _Optional[_Union[_country_pb2.Country, str]] = ..., time_zone: _Optional[_Union[_org_pb2.TimeZone, str]] = ..., display_language: _Optional[_Union[_org_pb2.DisplayLanguage, str]] = ..., operator_display_language: _Optional[str] = ..., use_script_direction_rigth_to_left: bool = ...) -> None: ...
