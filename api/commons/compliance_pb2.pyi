...
class ScenarioResult(_message.Message):
    ...
    scenario_name: str
    def __init__(self, passed_value: _Optional[bool] = ..., should_allow_responses: _Optional[_Iterable[_Union[ScenarioRuleResponse, _Mapping]]] = ..., should_deny_responses: _Optional[_Iterable[_Union[ScenarioRuleResponse, _Mapping]]] = ..., scenario_name: _Optional[str] = ...) -> None: ...
...
class ScenarioRuleResponse(_message.Message):
    ...
    rule_text: str
    permit_value: bool
    def __init__(self, rule_text: _Optional[str] = ..., permit_value: _Optional[bool] = ...) -> None: ...
...
class ScrubEntryDetails(_message.Message):
    ...
    def __init__(self, content: _Optional[str] = ..., expiration_date: _Optional[_Union[datetime.datetime, _timestamp_pb2.Timestamp, _Mapping]] = ..., notes: _Optional[_Union[_wrappers_pb2.StringValue, _Mapping]] = ...) -> None: ...
...
class RuleResponse(_message.Message):
    ...
    permit: bool
    plugin_response: str
    def __init__(self, rule_text: _Optional[str] = ..., permit: _Optional[bool] = ..., plugin_response: _Optional[str] = ...) -> None: ...
