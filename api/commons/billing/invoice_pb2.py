...
if _descriptor._USE_C_DESCRIPTORS == False:
  ...
  _PRODUCT._serialized_options = b'\030\001'
  _INVOICEFORMAT._options = None
  _INVOICEFORMAT._serialized_options = b'\030\001'
  _INVOICE.fields_by_name['items']._options = None
  _INVOICE.fields_by_name['items']._serialized_options = b'\030\001'
  _INVOICE.fields_by_name['invoice_id']._options = None
  _INVOICE.fields_by_name['invoice_id']._serialized_options = b'\030\0010\001'
  _INVOICE.fields_by_name['billing_cycle']._options = None
  _INVOICE.fields_by_name['billing_cycle']._serialized_options = b'\030\001'
  _INVOICE.fields_by_name['create_time']._options = None
  _INVOICE.fields_by_name['create_time']._serialized_options = b'\030\001'
  _INVOICE.fields_by_name['update_time']._options = None
  _INVOICE.fields_by_name['update_time']._serialized_options = b'\030\001'
  _INVOICE._options = None
  _INVOICE._serialized_options = b'\030\001'
  _INVOICEITEM.fields_by_name['invoice_item_sid']._options = None
  _INVOICEITEM.fields_by_name['invoice_item_sid']._serialized_options = b'\030\001'
  _INVOICEITEM.fields_by_name['product']._options = None
  _INVOICEITEM.fields_by_name['product']._serialized_options = b'\030\001'
  _INVOICEITEM.fields_by_name['amount']._options = None
  _INVOICEITEM.fields_by_name['amount']._serialized_options = b'\030\001'
  _INVOICEITEM.fields_by_name['date_created']._options = None
  _INVOICEITEM.fields_by_name['date_created']._serialized_options = b'\030\001'
  _INVOICEITEM.fields_by_name['date_modified']._options = None
  _INVOICEITEM.fields_by_name['date_modified']._serialized_options = b'\030\001'
  _INVOICEITEM.fields_by_name['invoice_id']._options = None
  _INVOICEITEM.fields_by_name['invoice_id']._serialized_options = b'\030\0010\001'
  _INVOICEITEM._options = None
  _INVOICEITEM._serialized_options = b'\030\001'
