...
class Detail(_message.Message):
    ...
    billing_plan_id: int
    def __init__(self, billing_detail_sid: _Optional[int] = ..., event_type: _Optional[_Union[_event_types_pb2.EventType, str]] = ..., config_type: _Optional[_Union[DetailConfigType, str]] = ..., config: _Optional[_Union[DetailConfig, _Mapping]] = ..., date_created: _Optional[_Union[datetime.datetime, _timestamp_pb2.Timestamp, _Mapping]] = ..., date_modified: _Optional[_Union[datetime.datetime, _timestamp_pb2.Timestamp, _Mapping]] = ..., deleted_on: _Optional[_Union[datetime.datetime, _timestamp_pb2.Timestamp, _Mapping]] = ..., billing_plan_id: _Optional[int] = ...) -> None: ...
