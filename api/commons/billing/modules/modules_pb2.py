...
if _descriptor._USE_C_DESCRIPTORS == False:
  ...
  _BASICCONFIG.fields_by_name['rate']._options = None
  _BASICCONFIG.fields_by_name['rate']._serialized_options = b'\030\001'
  _BASICCONFIG._options = None
  _BASICCONFIG._serialized_options = b'\030\001'
  _BASICAMOUNTCONFIG.fields_by_name['amount']._options = None
  _BASICAMOUNTCONFIG.fields_by_name['amount']._serialized_options = b'\030\001'
  _BASICAMOUNTCONFIG.fields_by_name['rate']._options = None
  _BASICAMOUNTCONFIG.fields_by_name['rate']._serialized_options = b'\030\001'
  _BASICAMOUNTCONFIG.fields_by_name['min_increment']._options = None
  _BASICAMOUNTCONFIG.fields_by_name['min_increment']._serialized_options = b'\030\001'
  _BASICAMOUNTCONFIG.fields_by_name['max_increment']._options = None
  _BASICAMOUNTCONFIG.fields_by_name['max_increment']._serialized_options = b'\030\001'
  _BASICAMOUNTCONFIG._options = None
  _BASICAMOUNTCONFIG._serialized_options = b'\030\001'
