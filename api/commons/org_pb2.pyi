...
class TimeZone(int, metaclass=_enum_type_wrapper.EnumTypeWrapper):
    ...
    TIME_ZONE_AMERICA_BOGOTA: _ClassVar[TimeZone]
    TIME_ZONE_AMERICA_LIMA: _ClassVar[TimeZone]
...
class OperatorApplications(int, metaclass=_enum_type_wrapper.EnumTypeWrapper):
    ...
    CONTACTMANAGER_APP: _ClassVar[OperatorApplications]
    KNOWLEDGE_BASE_APP: _ClassVar[OperatorApplications]
...
TIME_ZONE_AMERICA_BOGOTA: TimeZone
TIME_ZONE_AMERICA_LIMA: TimeZone
...
CONTACTMANAGER_APP: OperatorApplications
KNOWLEDGE_BASE_APP: OperatorApplications
