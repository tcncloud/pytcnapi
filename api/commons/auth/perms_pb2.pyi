...
class Permission(int, metaclass=_enum_type_wrapper.EnumTypeWrapper):
    ...
    PERMISSION_ADHERENCE_ADMIN: _ClassVar[Permission]
    PERMISSION_ADHERENCE_MANAGER: _ClassVar[Permission]
    PERMISSION_ADHERENCE_MONITOR: _ClassVar[Permission]
...
PERMISSION_ADHERENCE_ADMIN: Permission
PERMISSION_ADHERENCE_MANAGER: Permission
PERMISSION_ADHERENCE_MONITOR: Permission
