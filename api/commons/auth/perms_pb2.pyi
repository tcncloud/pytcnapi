...
class Permission(int, metaclass=_enum_type_wrapper.EnumTypeWrapper):
    ...
    PERMISSION_ORG_EXPERIMENTAL_FEATURE: _ClassVar[Permission]
    ...
    PERMISSION_SUPPORT_EXPERIMENTAL_FEATURE: _ClassVar[Permission]
...
PERMISSION_ORG_EXPERIMENTAL_FEATURE: Permission
...
PERMISSION_SUPPORT_EXPERIMENTAL_FEATURE: Permission
