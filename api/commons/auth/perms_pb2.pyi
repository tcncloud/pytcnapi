...
class Permission(int, metaclass=_enum_type_wrapper.EnumTypeWrapper):
    ...
    PERMISSION_ACCESS_TOKEN_MANAGMENT: _ClassVar[Permission]
    ...
    PERMISSION_LABEL_ATTACH: _ClassVar[Permission]
    ...
    PERMISSION_AGENT_SCRIPTS_VIEW: _ClassVar[Permission]
    PERMISSION_AGENT_SCRIPTS_EDIT: _ClassVar[Permission]
    ...
    PERMISSION_COPY_TO_ORGANIZATION: _ClassVar[Permission]
    ...
    PERMISSION_VIEW_HOLD_QUEUE: _ClassVar[Permission]
    ...
    PERMISSION_AGENT_PLUGINS_VIEW: _ClassVar[Permission]
    PERMISSION_AGENT_HUNTGROUP_INTEGRATIONS_VIEW: _ClassVar[Permission]
    PERMISSION_MANUAL_CONVERSATION: _ClassVar[Permission]
    PERMISSION_AGENT_ASSISTED_PORTAL: _ClassVar[Permission]
    PERMISSION_CHANGE_OWN_HUNT_GROUP: _ClassVar[Permission]
    PERMISSION_CHANGE_OWN_SKILL_GROUPS: _ClassVar[Permission]
    ...
    PERMISSION_REPORT_GENERATOR_EDIT: _ClassVar[Permission]
    PERMISSION_ROOM303: _ClassVar[Permission]
    PERMISSION_ROOM303_MEMBER: _ClassVar[Permission]
    PERMISSION_ROOM303_SUPERVISOR: _ClassVar[Permission]
    ...
    PERMISSION_OMNI_BOSS_EDIT: _ClassVar[Permission]
    ...
    PERMISSIONS_INTEGRATIONS_KEY_CREATION: _ClassVar[Permission]
    PERMISSION_WFM: _ClassVar[Permission]
    PERMISSION_AGENT_PORTAL: _ClassVar[Permission]
    PERMISSION_WFM_ADHERENCE_ADMIN: _ClassVar[Permission]
    PERMISSION_WFM_ADHERENCE_MANAGER: _ClassVar[Permission]
    PERMISSION_WFM_ADHERENCE_MONITOR: _ClassVar[Permission]
    ...
    PERMISSION_SCORECARDS_LEARNING_OPPORTUNITIES: _ClassVar[Permission]
    ...
    PERMISSION_PBX_SOFTPHONE_WIDGET: _ClassVar[Permission]
    ...
    PERMISSION_NEWSROOM_CLIENT_CONTROL: _ClassVar[Permission]
    PERMISSION_CONTACTMANAGER_ADMIN: _ClassVar[Permission]
    PERMISSION_CONTACTMANAGER_APP: _ClassVar[Permission]
    PERMISSION_KNOWLEDGE_BASE_EDIT: _ClassVar[Permission]
    PERMISSION_RULE_ENGINE: _ClassVar[Permission]
...
PERMISSION_ACCESS_TOKEN_MANAGMENT: Permission
...
PERMISSION_VIEW_HOLD_QUEUE: Permission
...
PERMISSION_AGENT_PLUGINS_VIEW: Permission
PERMISSION_AGENT_HUNTGROUP_INTEGRATIONS_VIEW: Permission
PERMISSION_MANUAL_CONVERSATION: Permission
PERMISSION_AGENT_ASSISTED_PORTAL: Permission
PERMISSION_CHANGE_OWN_HUNT_GROUP: Permission
PERMISSION_CHANGE_OWN_SKILL_GROUPS: Permission
...
PERMISSION_REPORT_GENERATOR_EDIT: Permission
PERMISSION_ROOM303: Permission
PERMISSION_ROOM303_MEMBER: Permission
PERMISSION_ROOM303_SUPERVISOR: Permission
...
PERMISSION_OMNI_BOSS_EDIT: Permission
...
PERMISSIONS_INTEGRATIONS_KEY_CREATION: Permission
PERMISSION_WFM: Permission
PERMISSION_AGENT_PORTAL: Permission
PERMISSION_WFM_ADHERENCE_ADMIN: Permission
PERMISSION_WFM_ADHERENCE_MANAGER: Permission
PERMISSION_WFM_ADHERENCE_MONITOR: Permission
...
PERMISSION_SCORECARDS_LEARNING_OPPORTUNITIES: Permission
...
PERMISSION_PBX_SOFTPHONE_WIDGET: Permission
PERMISSION_NEWSROOM_VIEW: Permission
PERMISSION_NEWSROOM_EDIT: Permission
PERMISSION_NEWSROOM_PUBLISH: Permission
PERMISSION_NEWSROOM_CLIENT_CONTROL: Permission
PERMISSION_CONTACTMANAGER_ADMIN: Permission
PERMISSION_CONTACTMANAGER_APP: Permission
PERMISSION_KNOWLEDGE_BASE_EDIT: Permission
PERMISSION_RULE_ENGINE: Permission
