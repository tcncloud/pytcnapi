...
class RequestMethod(int, metaclass=_enum_type_wrapper.EnumTypeWrapper):
    ...
    REQUEST_METHOD_PRIOCOMMERCE_GET_CUSTOMER: _ClassVar[RequestMethod]
...
REQUEST_METHOD_PRIOCOMMERCE_GET_CUSTOMER: RequestMethod
...
class VerificationPriocommerceGetCustomer(_message.Message):
    __slots__ = []
    def __init__(self) -> None: ...
...
class ExecutePriocommerceAchGetCustomer(_message.Message):
    __slots__ = []
    def __init__(self) -> None: ...
