...
class IntegrationType(int, metaclass=_enum_type_wrapper.EnumTypeWrapper):
    ...
    INTEGRATION_TYPE_FINVI: _ClassVar[IntegrationType]
    INTEGRATION_TYPE_NAVIGA_DTI_CIRC: _ClassVar[IntegrationType]
    INTEGRATION_TYPE_NAVIGA_DTI_CS: _ClassVar[IntegrationType]
    INTEGRATION_TYPE_SWERVEPAY: _ClassVar[IntegrationType]
    INTEGRATION_TYPE_VERADIGM: _ClassVar[IntegrationType]
    INTEGRATION_TYPE_VERADIGM_PRACTICE_MANAGEMENT: _ClassVar[IntegrationType]
    INTEGRATION_TYPE_PDCFLOW: _ClassVar[IntegrationType]
    INTEGRATION_TYPE_DEBUG: _ClassVar[IntegrationType]
    INTEGRATION_TYPE_ACQUIRED: _ClassVar[IntegrationType]
    INTEGRATION_TYPE_GENERIC: _ClassVar[IntegrationType]
    INTEGRATION_TYPE_HEALTHPAY24: _ClassVar[IntegrationType]
    INTEGRATION_TYPE_FINVI_FACS: _ClassVar[IntegrationType]
    INTEGRATION_TYPE_FINVI_VELOSIDY: _ClassVar[IntegrationType]
    INTEGRATION_TYPE_CLOVER: _ClassVar[IntegrationType]
    INTEGRATION_TYPE_NUVEI: _ClassVar[IntegrationType]
    INTEGRATION_TYPE_CALLIPAY: _ClassVar[IntegrationType]
    INTEGRATION_TYPE_TRATTA: _ClassVar[IntegrationType]
    INTEGRATION_TYPE_FORTIS: _ClassVar[IntegrationType]
    INTEGRATION_TYPE_BLINKPAYMENT: _ClassVar[IntegrationType]
    INTEGRATION_TYPE_WAYSTAR: _ClassVar[IntegrationType]
    INTEGRATION_TYPE_ACIWORLDWIDE: _ClassVar[IntegrationType]
...
class RequestMethod(int, metaclass=_enum_type_wrapper.EnumTypeWrapper):
    ...
    REQUEST_METHOD_BRAINTREE_CREDITAUTHORIZEPAYMENT: _ClassVar[RequestMethod]
    ...
    REQUEST_METHOD_RELATIENT_GETPATIENTBALANCE_NEW: _ClassVar[RequestMethod]
    REQUEST_METHOD_RELATIENT_GETPATIENTCCTOKENS_NEW: _ClassVar[RequestMethod]
    REQUEST_METHOD_RELATIENT_POSTPATIENTTOKEN_NEW: _ClassVar[RequestMethod]
    REQUEST_METHOD_RELATIENT_POSTPATIENTBALANCE_NEW: _ClassVar[RequestMethod]
    ...
    REQUEST_METHOD_INTERPROSE_GETBUNDLE: _ClassVar[RequestMethod]
    ...
    REQUEST_METHOD_BILLINGTREE_GETACCESSTOKEN: _ClassVar[RequestMethod]
    REQUEST_METHOD_BILLINGTREE_TOKENIZE_CARD: _ClassVar[RequestMethod]
    REQUEST_METHOD_BILLINGTREE_TOKENIZE_ACH: _ClassVar[RequestMethod]
    REQUEST_METHOD_BILLINGTREE_TRANSACTION_CARD_SALE: _ClassVar[RequestMethod]
    REQUEST_METHOD_BILLINGTREE_TRANSACTION_ACH_SALE: _ClassVar[RequestMethod]
    REQUEST_METHOD_BILLINGTREE_QUERYFEE: _ClassVar[RequestMethod]
    ...
    REQUEST_METHOD_JOURNEY_SEARCH: _ClassVar[RequestMethod]
    ...
    REQUEST_METHOD_NTVB_COMPLETE_PENDING_ORDER: _ClassVar[RequestMethod]
    REQUEST_METHOD_NTVB_PLACE_ORDER: _ClassVar[RequestMethod]
    ...
    REQUEST_METHOD_ELAVON_ELECTRONIC_CHECK_PURCHASE: _ClassVar[RequestMethod]
    REQUEST_METHOD_ELAVON_SUBMIT_INSTALLMENT_PAYMENT: _ClassVar[RequestMethod]
    ...
    REQUEST_METHOD_PAY_SCOUT_CREDIT_CARD_SALE_RECURRING: _ClassVar[RequestMethod]
    REQUEST_METHOD_PAY_SCOUT_ECHECK_SALE_RECURRING: _ClassVar[RequestMethod]
    REQUEST_METHOD_PAY_SCOUT_GET_CONSUMER_FEE: _ClassVar[RequestMethod]
    REQUEST_METHOD_PAY_SCOUT_STORE_TOKEN: _ClassVar[RequestMethod]
    ...
    REQUST_METHOD_PIANO_ADD_PAYMENT: _ClassVar[RequestMethod]
    REQUEST_METHOD_PIANO_UPDATE_PAYMENT: _ClassVar[RequestMethod]
    ...
    REQUEST_METHOD_NEWZWARE_SUBSCRIPTION_RESTART: _ClassVar[RequestMethod]
    ...
    REQUEST_METHOD_FINVI_EXILE_QUERY_RECORDS: _ClassVar[RequestMethod]
    REQUEST_METHOD_FINVI_EXILE_READ_FIELDS: _ClassVar[RequestMethod]
    REQUEST_METHOD_FINVI_EXILE_WRITE_FIELDS: _ClassVar[RequestMethod]
    REQUEST_METHOD_FINVI_EXILE_EXECUTE_LOGIC: _ClassVar[RequestMethod]
    REQUEST_METHOD_FINVI_EXILE_CREATE_PAYMENT: _ClassVar[RequestMethod]
    REQUEST_METHOD_FINVI_EXILE_POP_ACCOUNT: _ClassVar[RequestMethod]
    REQUEST_METHOD_NAVIGA_DTI_CIRC_CREATE_PAYMENT: _ClassVar[RequestMethod]
    REQUEST_METHOD_NAVIGA_DTI_CIRC_CHANGE_BILLING: _ClassVar[RequestMethod]
    REQUEST_METHOD_NAVIGA_DTI_CS_AUTO_RENEW_INFO: _ClassVar[RequestMethod]
    REQUEST_METHOD_NAVIGA_DTI_CS_AUTO_TRAN: _ClassVar[RequestMethod]
    REQUEST_METHOD_NAVIGA_DTI_CS_BILLING_INFO: _ClassVar[RequestMethod]
    REQUEST_METHOD_NAVIGA_DTI_CS_LOGIN: _ClassVar[RequestMethod]
    REQUEST_METHOD_NAVIGA_DTI_CS_PAY_INFO: _ClassVar[RequestMethod]
    REQUEST_METHOD_NAVIGA_DTI_CS_PAY_TRAN: _ClassVar[RequestMethod]
    REQUEST_METHOD_NAVIGA_DTI_CS_RENEW_INFO: _ClassVar[RequestMethod]
    REQUEST_METHOD_NAVIGA_DTI_CS_SEARCH_PAGE: _ClassVar[RequestMethod]
    REQUEST_METHOD_NAVIGA_DTI_CS_SERVICE_ERROR_INFO: _ClassVar[RequestMethod]
    REQUEST_METHOD_NAVIGA_DTI_CS_SERVICE_ERROR_TRANS: _ClassVar[RequestMethod]
    REQUEST_METHOD_NAVIGA_DTI_CS_STOP_INFO: _ClassVar[RequestMethod]
    REQUEST_METHOD_NAVIGA_DTI_CS_STOP_TRANS: _ClassVar[RequestMethod]
    REQUEST_METHOD_SWERVEPAY_CREATE_CUSTOMER: _ClassVar[RequestMethod]
    REQUEST_METHOD_SWERVEPAY_QUERY_CUSTOMER_DETAILS: _ClassVar[RequestMethod]
    REQUEST_METHOD_SWERVEPAY_QUERY_CUSTOMER_TOKEN_DETAILS: _ClassVar[RequestMethod]
    REQUEST_METHOD_SWERVEPAY_QUERY_CUSTOMER_TOKENS: _ClassVar[RequestMethod]
    REQUEST_METHOD_SWERVEPAY_QUERY_CUSTOMER_TRANSACTIONS: _ClassVar[RequestMethod]
    REQUEST_METHOD_SWERVEPAY_QUERY_CUSTOMERS: _ClassVar[RequestMethod]
    REQUEST_METHOD_SWERVEPAY_QUERY_TRANSACTION_DETAILS: _ClassVar[RequestMethod]
    REQUEST_METHOD_SWERVEPAY_QUERY_TRANSACTIONS: _ClassVar[RequestMethod]
    REQUEST_METHOD_SWERVEPAY_REMOVE_CUSTOMER_TOKEN: _ClassVar[RequestMethod]
    REQUEST_METHOD_SWERVEPAY_UPDATE_CUSTOMER: _ClassVar[RequestMethod]
    REQUEST_METHOD_SWERVEPAY_CREATE_TRANSACTION_AUTH: _ClassVar[RequestMethod]
    REQUEST_METHOD_SWERVEPAY_CREATE_TRANSACTION_CAPTURE: _ClassVar[RequestMethod]
    REQUEST_METHOD_SWERVEPAY_CREATE_TRANSACTION_CREDIT: _ClassVar[RequestMethod]
    REQUEST_METHOD_SWERVEPAY_CREATE_TRANSACTION_REFUND: _ClassVar[RequestMethod]
    REQUEST_METHOD_SWERVEPAY_CREATE_TRANSACTION_SALE: _ClassVar[RequestMethod]
    REQUEST_METHOD_SWERVEPAY_CREATE_TRANSACTION_VALIDATE: _ClassVar[RequestMethod]
    REQUEST_METHOD_SWERVEPAY_PROCESS_NEW_TRANSACTION_AUTH: _ClassVar[RequestMethod]
    REQUEST_METHOD_SWERVEPAY_PROCESS_NEW_TRANSACTION_CAPTURE: _ClassVar[RequestMethod]
    REQUEST_METHOD_SWERVEPAY_PROCESS_NEW_TRANSACTION_CREDIT: _ClassVar[RequestMethod]
    REQUEST_METHOD_SWERVEPAY_PROCESS_NEW_TRANSACTION_REFUND: _ClassVar[RequestMethod]
    REQUEST_METHOD_SWERVEPAY_PROCESS_NEW_TRANSACTION_SALE: _ClassVar[RequestMethod]
    REQUEST_METHOD_SWERVEPAY_PROCESS_NEW_TRANSACTION_VALIDATE: _ClassVar[RequestMethod]
    REQUEST_METHOD_VERADIGM_GET_TOKEN: _ClassVar[RequestMethod]
    REQUEST_METHOD_VERADIGM_GET_USER_AUTHENTICATION: _ClassVar[RequestMethod]
    REQUEST_METHOD_VERADIGM_GET_LOCATIONS: _ClassVar[RequestMethod]
    REQUEST_METHOD_VERADIGM_GET_PATIENT_ACCOUNT_BALANCE: _ClassVar[RequestMethod]
    REQUEST_METHOD_VERADIGM_GET_PAYMENTS: _ClassVar[RequestMethod]
    REQUEST_METHOD_VERADIGM_GET_PLACES_OF_SERVICE: _ClassVar[RequestMethod]
    REQUEST_METHOD_VERADIGM_SAVE_PAYMENT_TRANSACTION: _ClassVar[RequestMethod]
    REQUEST_METHOD_VERADIGM_SAVE_REFUND_TRANSACTION: _ClassVar[RequestMethod]
    REQUEST_METHOD_VERADIGM_SAVE_VOUCHER_PAYMENT: _ClassVar[RequestMethod]
    REQUEST_METHOD_VERADIGM_PRACTICE_MANAGEMENT_GET_TOKEN: _ClassVar[RequestMethod]
    REQUEST_METHOD_VERADIGM_PRACTICE_MANAGEMENT_GET_USER_AUTHENTICATION: _ClassVar[RequestMethod]
    REQUEST_METHOD_VERADIGM_PRACTICE_MANAGEMENT_GET_LOCATIONS: _ClassVar[RequestMethod]
    REQUEST_METHOD_VERADIGM_PRACTICE_MANAGEMENT_GET_PATIENT_ACCOUNT_BALANCE: _ClassVar[RequestMethod]
    REQUEST_METHOD_VERADIGM_PRACTICE_MANAGEMENT_GET_PAYMENTS: _ClassVar[RequestMethod]
    REQUEST_METHOD_VERADIGM_PRACTICE_MANAGEMENT_GET_PLACES_OF_SERVICE: _ClassVar[RequestMethod]
    REQUEST_METHOD_VERADIGM_PRACTICE_MANAGEMENT_SAVE_PAYMENT_TRANSACTION: _ClassVar[RequestMethod]
    REQUEST_METHOD_VERADIGM_PRACTICE_MANAGEMENT_SAVE_REFUND_TRANSACTION: _ClassVar[RequestMethod]
    REQUEST_METHOD_VERADIGM_PRACTICE_MANAGEMENT_SAVE_VOUCHER_PAYMENT: _ClassVar[RequestMethod]
    REQUEST_METHOD_VERADIGM_PRACTICE_MANAGEMENT_GET_PRACTITIONERS: _ClassVar[RequestMethod]
    REQUEST_METHOD_VERADIGM_PRACTICE_MANAGEMENT_GET_TRANSACTION_CODES: _ClassVar[RequestMethod]
    REQUEST_METHOD_VERADIGM_PRACTICE_MANAGEMENT_GET_DEPARTMENTS: _ClassVar[RequestMethod]
    REQUEST_METHOD_PDCFLOW_TOKENIZE_CREDIT_CARD: _ClassVar[RequestMethod]
    REQUEST_METHOD_PDCFLOW_CC_TRANSACTION: _ClassVar[RequestMethod]
    REQUEST_METHOD_DEBUG_ECHO: _ClassVar[RequestMethod]
    REQUESET_METHOD_DEBUG_VALIDATE: _ClassVar[RequestMethod]
    REQUEST_METHOD_ACQUIRED_PROCESS_PAYMENT: _ClassVar[RequestMethod]
    REQUEST_METHOD_GENERIC_REQUEST: _ClassVar[RequestMethod]
    REQUEST_METHOD_HEALTHPAY24_ACCOUNTS_RECEIVABLE: _ClassVar[RequestMethod]
    REQUEST_METHOD_FINVI_FACS_PROCESS_PAYMENT: _ClassVar[RequestMethod]
    REQUEST_METHOD_FINVI_VELOSIDY_ACCOUNT_SEARCH: _ClassVar[RequestMethod]
    REQUEST_METHOD_FINVI_VELOSIDY_ONE_TIME_SALE: _ClassVar[RequestMethod]
    REQUEST_METHOD_FINVI_VELOSIDY_PLAN_OFFER: _ClassVar[RequestMethod]
    REQUEST_METHOD_FINVI_VELOSIDY_PLAN_RECURRING_CREATE: _ClassVar[RequestMethod]
    REQUEST_METHOD_FINVI_VELOSIDY_PENDING_PAYMENT: _ClassVar[RequestMethod]
    REQUEST_METHOD_FINVI_VELOSIDY_PLAN_ONE_TIME_FUTURE: _ClassVar[RequestMethod]
    REQUEST_METHOD_CLOVER_PAYMENT_CARD_SALE_TRANSACTION: _ClassVar[RequestMethod]
    REQUEST_METHOD_NUVEI_PAYMENT: _ClassVar[RequestMethod]
    REQUEST_METHOD_CALLIPAY_CC_PAYMENT: _ClassVar[RequestMethod]
    REQUEST_METHOD_CALLIPAY_CHECK_PAYMENT: _ClassVar[RequestMethod]
    REQUEST_METHOD_TRATTA_CHARGE_CC: _ClassVar[RequestMethod]
    REQUEST_METHOD_TRATTA_CHARGE_ACH: _ClassVar[RequestMethod]
    REQUEST_METHOD_TRATTA_CHARGE_CC_POST_DATED: _ClassVar[RequestMethod]
    REQUEST_METHOD_TRATTA_CHARGE_ACH_POST_DATED: _ClassVar[RequestMethod]
    REQUEST_METHOD_FORTIS_CREATE_ACHTOKEN: _ClassVar[RequestMethod]
    REQUEST_METHOD_FORTIS_CREATE_CCTOKEN: _ClassVar[RequestMethod]
    REQUEST_METHOD_FORTIS_TOKEN_ACH_DEBIT_PAYMENT: _ClassVar[RequestMethod]
    REQUEST_METHOD_FORTIS_TOKEN_CC_PAYMENT: _ClassVar[RequestMethod]
    REQUEST_METHOD_BLINKPAYMENT_CHARGE_CC: _ClassVar[RequestMethod]
    REQUEST_METHOD_BLINKPAYMENT_CHARGE_ACH: _ClassVar[RequestMethod]
    REQUEST_METHOD_WAYSTAR_CC_PAYMENT: _ClassVar[RequestMethod]
    REQUEST_METHOD_WAYSTAR_ACH_PAYMENT: _ClassVar[RequestMethod]
    REQUEST_METHOD_ACIWORLDWIDE_CHARGE_CC: _ClassVar[RequestMethod]
    REQUEST_METHOD_ACIWORLDWIDE_CHARGE_ACH: _ClassVar[RequestMethod]
...
class Validation(int, metaclass=_enum_type_wrapper.EnumTypeWrapper):
    ...
    VALIDATION_SELECT: _ClassVar[Validation]
...
INTEGRATION_TYPE_FINVI: IntegrationType
INTEGRATION_TYPE_NAVIGA_DTI_CIRC: IntegrationType
INTEGRATION_TYPE_NAVIGA_DTI_CS: IntegrationType
INTEGRATION_TYPE_SWERVEPAY: IntegrationType
INTEGRATION_TYPE_VERADIGM: IntegrationType
INTEGRATION_TYPE_VERADIGM_PRACTICE_MANAGEMENT: IntegrationType
INTEGRATION_TYPE_PDCFLOW: IntegrationType
INTEGRATION_TYPE_DEBUG: IntegrationType
INTEGRATION_TYPE_ACQUIRED: IntegrationType
INTEGRATION_TYPE_GENERIC: IntegrationType
INTEGRATION_TYPE_HEALTHPAY24: IntegrationType
INTEGRATION_TYPE_FINVI_FACS: IntegrationType
INTEGRATION_TYPE_FINVI_VELOSIDY: IntegrationType
INTEGRATION_TYPE_CLOVER: IntegrationType
INTEGRATION_TYPE_NUVEI: IntegrationType
INTEGRATION_TYPE_CALLIPAY: IntegrationType
INTEGRATION_TYPE_TRATTA: IntegrationType
INTEGRATION_TYPE_FORTIS: IntegrationType
INTEGRATION_TYPE_BLINKPAYMENT: IntegrationType
INTEGRATION_TYPE_WAYSTAR: IntegrationType
INTEGRATION_TYPE_ACIWORLDWIDE: IntegrationType
...
REQUEST_METHOD_BRAINTREE_CREDITAUTHORIZEPAYMENT: RequestMethod
...
REQUEST_METHOD_RELATIENT_GETPATIENTBALANCE_NEW: RequestMethod
REQUEST_METHOD_RELATIENT_GETPATIENTCCTOKENS_NEW: RequestMethod
REQUEST_METHOD_RELATIENT_POSTPATIENTTOKEN_NEW: RequestMethod
REQUEST_METHOD_RELATIENT_POSTPATIENTBALANCE_NEW: RequestMethod
...
REQUEST_METHOD_INTERPROSE_GETBUNDLE: RequestMethod
...
REQUEST_METHOD_BILLINGTREE_GETACCESSTOKEN: RequestMethod
REQUEST_METHOD_BILLINGTREE_TOKENIZE_CARD: RequestMethod
REQUEST_METHOD_BILLINGTREE_TOKENIZE_ACH: RequestMethod
REQUEST_METHOD_BILLINGTREE_TRANSACTION_CARD_SALE: RequestMethod
REQUEST_METHOD_BILLINGTREE_TRANSACTION_ACH_SALE: RequestMethod
REQUEST_METHOD_BILLINGTREE_QUERYFEE: RequestMethod
...
REQUEST_METHOD_JOURNEY_SEARCH: RequestMethod
...
REQUEST_METHOD_NTVB_COMPLETE_PENDING_ORDER: RequestMethod
REQUEST_METHOD_NTVB_PLACE_ORDER: RequestMethod
...
REQUEST_METHOD_ELAVON_ELECTRONIC_CHECK_PURCHASE: RequestMethod
REQUEST_METHOD_ELAVON_SUBMIT_INSTALLMENT_PAYMENT: RequestMethod
...
REQUEST_METHOD_PAY_SCOUT_CREDIT_CARD_SALE_RECURRING: RequestMethod
REQUEST_METHOD_PAY_SCOUT_ECHECK_SALE_RECURRING: RequestMethod
REQUEST_METHOD_PAY_SCOUT_GET_CONSUMER_FEE: RequestMethod
REQUEST_METHOD_PAY_SCOUT_STORE_TOKEN: RequestMethod
...
REQUST_METHOD_PIANO_ADD_PAYMENT: RequestMethod
REQUEST_METHOD_PIANO_UPDATE_PAYMENT: RequestMethod
...
REQUEST_METHOD_NEWZWARE_SUBSCRIPTION_RESTART: RequestMethod
...
REQUEST_METHOD_FINVI_EXILE_QUERY_RECORDS: RequestMethod
REQUEST_METHOD_FINVI_EXILE_READ_FIELDS: RequestMethod
REQUEST_METHOD_FINVI_EXILE_WRITE_FIELDS: RequestMethod
REQUEST_METHOD_FINVI_EXILE_EXECUTE_LOGIC: RequestMethod
REQUEST_METHOD_FINVI_EXILE_CREATE_PAYMENT: RequestMethod
REQUEST_METHOD_FINVI_EXILE_POP_ACCOUNT: RequestMethod
REQUEST_METHOD_NAVIGA_DTI_CIRC_CREATE_PAYMENT: RequestMethod
REQUEST_METHOD_NAVIGA_DTI_CIRC_CHANGE_BILLING: RequestMethod
REQUEST_METHOD_NAVIGA_DTI_CS_AUTO_RENEW_INFO: RequestMethod
REQUEST_METHOD_NAVIGA_DTI_CS_AUTO_TRAN: RequestMethod
REQUEST_METHOD_NAVIGA_DTI_CS_BILLING_INFO: RequestMethod
REQUEST_METHOD_NAVIGA_DTI_CS_LOGIN: RequestMethod
REQUEST_METHOD_NAVIGA_DTI_CS_PAY_INFO: RequestMethod
REQUEST_METHOD_NAVIGA_DTI_CS_PAY_TRAN: RequestMethod
REQUEST_METHOD_NAVIGA_DTI_CS_RENEW_INFO: RequestMethod
REQUEST_METHOD_NAVIGA_DTI_CS_SEARCH_PAGE: RequestMethod
REQUEST_METHOD_NAVIGA_DTI_CS_SERVICE_ERROR_INFO: RequestMethod
REQUEST_METHOD_NAVIGA_DTI_CS_SERVICE_ERROR_TRANS: RequestMethod
REQUEST_METHOD_NAVIGA_DTI_CS_STOP_INFO: RequestMethod
REQUEST_METHOD_NAVIGA_DTI_CS_STOP_TRANS: RequestMethod
REQUEST_METHOD_SWERVEPAY_CREATE_CUSTOMER: RequestMethod
REQUEST_METHOD_SWERVEPAY_QUERY_CUSTOMER_DETAILS: RequestMethod
REQUEST_METHOD_SWERVEPAY_QUERY_CUSTOMER_TOKEN_DETAILS: RequestMethod
REQUEST_METHOD_SWERVEPAY_QUERY_CUSTOMER_TOKENS: RequestMethod
REQUEST_METHOD_SWERVEPAY_QUERY_CUSTOMER_TRANSACTIONS: RequestMethod
REQUEST_METHOD_SWERVEPAY_QUERY_CUSTOMERS: RequestMethod
REQUEST_METHOD_SWERVEPAY_QUERY_TRANSACTION_DETAILS: RequestMethod
REQUEST_METHOD_SWERVEPAY_QUERY_TRANSACTIONS: RequestMethod
REQUEST_METHOD_SWERVEPAY_REMOVE_CUSTOMER_TOKEN: RequestMethod
REQUEST_METHOD_SWERVEPAY_UPDATE_CUSTOMER: RequestMethod
REQUEST_METHOD_SWERVEPAY_CREATE_TRANSACTION_AUTH: RequestMethod
REQUEST_METHOD_SWERVEPAY_CREATE_TRANSACTION_CAPTURE: RequestMethod
REQUEST_METHOD_SWERVEPAY_CREATE_TRANSACTION_CREDIT: RequestMethod
REQUEST_METHOD_SWERVEPAY_CREATE_TRANSACTION_REFUND: RequestMethod
REQUEST_METHOD_SWERVEPAY_CREATE_TRANSACTION_SALE: RequestMethod
REQUEST_METHOD_SWERVEPAY_CREATE_TRANSACTION_VALIDATE: RequestMethod
REQUEST_METHOD_SWERVEPAY_PROCESS_NEW_TRANSACTION_AUTH: RequestMethod
REQUEST_METHOD_SWERVEPAY_PROCESS_NEW_TRANSACTION_CAPTURE: RequestMethod
REQUEST_METHOD_SWERVEPAY_PROCESS_NEW_TRANSACTION_CREDIT: RequestMethod
REQUEST_METHOD_SWERVEPAY_PROCESS_NEW_TRANSACTION_REFUND: RequestMethod
REQUEST_METHOD_SWERVEPAY_PROCESS_NEW_TRANSACTION_SALE: RequestMethod
REQUEST_METHOD_SWERVEPAY_PROCESS_NEW_TRANSACTION_VALIDATE: RequestMethod
REQUEST_METHOD_VERADIGM_GET_TOKEN: RequestMethod
REQUEST_METHOD_VERADIGM_GET_USER_AUTHENTICATION: RequestMethod
REQUEST_METHOD_VERADIGM_GET_LOCATIONS: RequestMethod
REQUEST_METHOD_VERADIGM_GET_PATIENT_ACCOUNT_BALANCE: RequestMethod
REQUEST_METHOD_VERADIGM_GET_PAYMENTS: RequestMethod
REQUEST_METHOD_VERADIGM_GET_PLACES_OF_SERVICE: RequestMethod
REQUEST_METHOD_VERADIGM_SAVE_PAYMENT_TRANSACTION: RequestMethod
REQUEST_METHOD_VERADIGM_SAVE_REFUND_TRANSACTION: RequestMethod
REQUEST_METHOD_VERADIGM_SAVE_VOUCHER_PAYMENT: RequestMethod
REQUEST_METHOD_VERADIGM_PRACTICE_MANAGEMENT_GET_TOKEN: RequestMethod
REQUEST_METHOD_VERADIGM_PRACTICE_MANAGEMENT_GET_USER_AUTHENTICATION: RequestMethod
REQUEST_METHOD_VERADIGM_PRACTICE_MANAGEMENT_GET_LOCATIONS: RequestMethod
REQUEST_METHOD_VERADIGM_PRACTICE_MANAGEMENT_GET_PATIENT_ACCOUNT_BALANCE: RequestMethod
REQUEST_METHOD_VERADIGM_PRACTICE_MANAGEMENT_GET_PAYMENTS: RequestMethod
REQUEST_METHOD_VERADIGM_PRACTICE_MANAGEMENT_GET_PLACES_OF_SERVICE: RequestMethod
REQUEST_METHOD_VERADIGM_PRACTICE_MANAGEMENT_SAVE_PAYMENT_TRANSACTION: RequestMethod
REQUEST_METHOD_VERADIGM_PRACTICE_MANAGEMENT_SAVE_REFUND_TRANSACTION: RequestMethod
REQUEST_METHOD_VERADIGM_PRACTICE_MANAGEMENT_SAVE_VOUCHER_PAYMENT: RequestMethod
REQUEST_METHOD_VERADIGM_PRACTICE_MANAGEMENT_GET_PRACTITIONERS: RequestMethod
REQUEST_METHOD_VERADIGM_PRACTICE_MANAGEMENT_GET_TRANSACTION_CODES: RequestMethod
REQUEST_METHOD_VERADIGM_PRACTICE_MANAGEMENT_GET_DEPARTMENTS: RequestMethod
REQUEST_METHOD_PDCFLOW_TOKENIZE_CREDIT_CARD: RequestMethod
REQUEST_METHOD_PDCFLOW_CC_TRANSACTION: RequestMethod
REQUEST_METHOD_DEBUG_ECHO: RequestMethod
REQUESET_METHOD_DEBUG_VALIDATE: RequestMethod
REQUEST_METHOD_ACQUIRED_PROCESS_PAYMENT: RequestMethod
REQUEST_METHOD_GENERIC_REQUEST: RequestMethod
REQUEST_METHOD_HEALTHPAY24_ACCOUNTS_RECEIVABLE: RequestMethod
REQUEST_METHOD_FINVI_FACS_PROCESS_PAYMENT: RequestMethod
REQUEST_METHOD_FINVI_VELOSIDY_ACCOUNT_SEARCH: RequestMethod
REQUEST_METHOD_FINVI_VELOSIDY_ONE_TIME_SALE: RequestMethod
REQUEST_METHOD_FINVI_VELOSIDY_PLAN_OFFER: RequestMethod
REQUEST_METHOD_FINVI_VELOSIDY_PLAN_RECURRING_CREATE: RequestMethod
REQUEST_METHOD_FINVI_VELOSIDY_PENDING_PAYMENT: RequestMethod
REQUEST_METHOD_FINVI_VELOSIDY_PLAN_ONE_TIME_FUTURE: RequestMethod
REQUEST_METHOD_CLOVER_PAYMENT_CARD_SALE_TRANSACTION: RequestMethod
REQUEST_METHOD_NUVEI_PAYMENT: RequestMethod
REQUEST_METHOD_CALLIPAY_CC_PAYMENT: RequestMethod
REQUEST_METHOD_CALLIPAY_CHECK_PAYMENT: RequestMethod
REQUEST_METHOD_TRATTA_CHARGE_CC: RequestMethod
REQUEST_METHOD_TRATTA_CHARGE_ACH: RequestMethod
REQUEST_METHOD_TRATTA_CHARGE_CC_POST_DATED: RequestMethod
REQUEST_METHOD_TRATTA_CHARGE_ACH_POST_DATED: RequestMethod
REQUEST_METHOD_FORTIS_CREATE_ACHTOKEN: RequestMethod
REQUEST_METHOD_FORTIS_CREATE_CCTOKEN: RequestMethod
REQUEST_METHOD_FORTIS_TOKEN_ACH_DEBIT_PAYMENT: RequestMethod
REQUEST_METHOD_FORTIS_TOKEN_CC_PAYMENT: RequestMethod
REQUEST_METHOD_BLINKPAYMENT_CHARGE_CC: RequestMethod
REQUEST_METHOD_BLINKPAYMENT_CHARGE_ACH: RequestMethod
REQUEST_METHOD_WAYSTAR_CC_PAYMENT: RequestMethod
REQUEST_METHOD_WAYSTAR_ACH_PAYMENT: RequestMethod
REQUEST_METHOD_ACIWORLDWIDE_CHARGE_CC: RequestMethod
REQUEST_METHOD_ACIWORLDWIDE_CHARGE_ACH: RequestMethod
...
class Fee(_message.Message):
    ...
    def __init__(self, name: _Optional[str] = ..., flat: _Optional[_Union[_money_pb2.Money, _Mapping]] = ..., percentage: _Optional[_Union[Percentage, _Mapping]] = ..., flat_and_percentage: _Optional[_Union[FlatAndPercentage, _Mapping]] = ..., lookup: _Optional[_Union[Lookup, _Mapping]] = ..., display: _Optional[bool] = ..., destination_field: _Optional[str] = ...) -> None: ...
...
class Lookup(_message.Message):
    ...
    response_field: str
    as_percentage: bool
    def __init__(self, plugin_instance_id: _Optional[str] = ..., method: _Optional[_Union[RequestMethod, str]] = ..., response_field: _Optional[str] = ..., as_percentage: _Optional[bool] = ...) -> None: ...
...
class ReceiptField(_message.Message):
    ...
    format: str
    copiable: bool
    def __init__(self, name: _Optional[str] = ..., display_name: _Optional[str] = ..., value: _Optional[str] = ..., validation_type: _Optional[_Union[Validation, str]] = ..., format: _Optional[str] = ..., copiable: _Optional[bool] = ...) -> None: ...
...
class PaymentFlow(_message.Message):
    ...
    PAYMENTSTELLA_CC_FIELD_NUMBER: _ClassVar[int]
    PAYMENTSTELLA_ECHECK_FIELD_NUMBER: _ClassVar[int]
    SWERVEPAY_CC_FIELD_NUMBER: _ClassVar[int]
    SWERVEPAY_ACH_FIELD_NUMBER: _ClassVar[int]
...
class ExecuteFlow(_message.Message):
    __slots__ = ("plugin_instance_id", "braintree_credit_sale", "braintree_bank_sale", "braintree_credit_authorize_payment", "relatient_get_patient_balance", "relatient_get_patient_cc_tokens", "relatient_post_patient_token", "relatient_post_patient_balance", "relatient_get_patient", "relatient_post_balance_by_id", "relatient_create_fortis_achtoken", "relatient_create_fortis_cctoken", "relatient_fortis_token_ach_debit_payment", "relatient_fortis_token_cc_payment", "relatient_get_patient_balance_new", "relatient_get_patient_cc_tokens_new", "relatient_post_patient_token_new", "relatient_post_patient_balance_new", "cybersource_credit_payment", "cybersource_echeck_payment", "circpro_phone_lookup_with_bundle", "circpro_phone_lookup", "circpro_vacation_restart_inquiry", "circpro_complaint_inquiry", "circpro_account_inquiry", "circpro_account_inquiry_with_tax", "circpro_account_inquiry_with_tax_bundle", "circpro_complaint_codes", "circpro_complaint_update", "circpro_vacation_update", "circpro_restart_update", "circpro_law_immediate_payment", "circpro_law_update_data_with_pac", "circpro_law_get_customers", "circpro_law_get_payment_types", "authorizenet_charge_credit_card", "authorizenet_debit_bank_account", "authorizenet_create_customer_payment_profile", "authorizenet_paypal_transaction", "authorizenet_google_pay_transaction", "authorizenet_apple_pay_transaction", "authorizenet_pay_pal_auth_capture", "expitrans_cc_transaction", "expitrans_ach_transaction", "axiamedfusion_cc_transaction", "axiamedfusion_ach_transaction", "axiamedfusion_card_verify", "instamed_payment_sale", "instamed_void_payment", "usaepay_submit_cc_payments", "usaepay_submit_ach_payments", "usaepay_get_cc_token", "ezidebit_submit_cc_payments", "ezidebit_submit_ach_payments", "bambora_submit_cc_payments", "bambora_submit_ach_payments", "repay_store_card", "repay_payment_token", "repay_ach_payment_token", "axia_submit_sale_request_by_cc", "axia_submit_sale_request_by_check", "securetrading_send_payment", "payment_vision_submit_card_sale_request_by_cc", "payment_vision_submit_card_sale_request_by_ach", "interprose_lookup_account", "interprose_submit_card_sale_request_by_cc", "interprose_submit_card_sale_request_by_ach", "interprose_lookup_payment_id", "interprose_lookup_account_by_form_id", "interprose_get_bundle", "dallasnews_search_by_phone", "dallasnews_search_by_zip_street", "dallasnews_search_by", "dallasnews_create_vacation", "dallasnews_get_vacation", "dallasnews_get_vacation_days_between", "dallasnews_get_vacation_with_cutoff", "dallasnews_delete_vacation", "dallasnews_add_complaint", "dallasnews_update_phone_number", "dallasnews_stop_account", "dallasnews_cc_payment_token", "dallasnews_ach_payment_token", "payway_submit_card_sale_request", "payway_create_token_request", "payway_submit_ach_sale_request", "billingtree_submit_card_sale_request", "billingtree_get_access_token", "billingtree_tokenize_card", "billingtree_tokenize_ach", "billingtree_transaction_card_sale", "billingtree_transaction_ach_sale", "billingtree_query_fee", "experian_cc_payment_request", "experian_cc_payment_plan_request", "experian_balancerequest", "experian_ach_payment_request", "experian_ach_payment_plan_request", "experian_stella_card_entry", "experian_stella_echeck", "experian_stella_card_device_tokenization", "experian_stella_token_payment", "experian_stella_ach_tokenization", "experian_stella_add_usa_epay_token", "experian_stella_payment_plans", "experian_stella_auth", "experian_stella_card_entry_tokenization", "experian_stella_payment_plans_by_patient", "newscycle_login", "newscycle_search_page", "newscycle_billing_info", "newscycle_service_error_info", "newscycle_service_error_trans", "newscycle_stop_info", "newscycle_stop_trans", "newscycle_renew_info", "newscycle_auto_renew_info", "newscycle_auto_tran", "newscycle_pay_info", "newscycle_pay_tran", "trustcommerce_credit_sale", "trustcommerce_ach_sale", "vantiv_credit_sale", "vantiv_ach_sale", "journey_latest", "journey_list", "journey_update", "journey_search", "athenahealth_get_patients", "athenahealth_get_patients_with_id", "athenahealth_cc_payment", "brainworks_get_customers_by_phone", "brainworks_get_suspends", "brainworks_get_customer_by_cust_id_v2", "brainworks_get_complaints", "brainworks_get_codes_or_types", "brainworks_stop_suspends", "brainworks_start_suspends", "brainworks_send_complaint", "brainworks_get_customer_by_cust_id", "osgconnect_cc_payments", "osgconnect_ach_payments", "osgconnect_validate_account_no", "ntvb_credit_missed_delivery", "ntvb_customer_search", "ntvb_end_call", "ntvb_integration_definition", "ntvb_missed_delivery", "ntvb_remove_autorenewal", "ntvb_renew_subscription", "ntvb_renewal_offers", "ntvb_set_autorenewal", "ntvb_start_incoming_call", "ntvb_start_outgoing_call", "ntvb_subscription_info", "ntvb_vacation_stop", "ntvb_authtest", "ntvb_complete_pending_order", "ntvb_place_order", "elavon_credit_card_sale", "elavon_add_recurring", "elavon_dcc_response", "elavon_delete_recurring", "elavon_update_recurring", "elavon_health_care_cc_sale", "elavon_add_installment", "elavon_update_installment", "elavon_delete_installment", "elavon_mcc_credit_card_sale", "elavon_electronic_check_purchase", "elavon_submit_installment_sale", "globalPayments_card_sale", "globalPayments_get_transaction_by_id", "globalPayments_list_transactions", "globalPayments_refund_sale", "globalPayments_reverse_sale_or_refund", "payscout_credit_sale", "payscout_echeck_sale", "payscout_credit_sale_recurring", "payscout_echeck_sale_recurring", "payscout_get_consumer_fee", "payscout_store_token", "i2c_echo", "i2c_balance_inquiry", "i2c_verify_user", "i2c_search_customer", "i2c_make_payment", "i2c_get_cardholder_profile", "i2c_get_cardholder_statement", "i2c_get_cardholder_balance", "i2c_get_creditpayment_info", "i2c_transaction_history", "opayo_cc_payment", "shift4_cc_payment", "shift4_access_token", "poscorp_accesstoken", "poscorp_lookup_guarantor", "poscorp_update_payment_status", "PIANO_GET_USER", "PIANO_UPDATE_USER", "PIANO_UPDATE_SUBSCRIPTION", "PIANO_GET_PAYMENT", "PIANO_LIST_SUBSCRIPTION", "PIANO_LASTACCESS_CONVERSION", "PIANO_ADD_PAYMENT", "PIANO_UPDATE_PAYMENT", "epic_get_token", "epic_get_patient", "epic_match_patient", "epic_search_appointment", "epic_find_appointment", "epic_book_appointment", "epic_get_account", "epic_receive_communication_2", "epic_receive_communication_3", "epic_post_patient_made_payment", "epic_get_patient_billing_details", "epic_call_patient", "epic_hangup_call", "epic_get_account_access_identifiers", "epic_get_account_billing_summary", "newzware_phone_lookup", "newzware_account_inquiry", "newzware_cc_payment", "newzware_ach_Payment", "newzware_complaint_history", "newzware_complaint_update", "newzware_vacation_restart", "newzware_vacation_update", "newzware_phone_lookup_multi", "newzware_subscription_restart", "priocommerce_ach_payment", "priocommerce_cc_payment", "naviga_create_payment", "naviga_change_billing", "paynseconds_tokenize_card", "sutherlandrev_payment_connect", "finvi_exile_query_records", "finvi_exile_read_fields", "finvi_exile_write_fields", "finvi_exile_execute_logic", "finvi_exile_create_payment", "finvi_exile_pop_account", "naviga_dti_circ_create_payment", "naviga_dti_circ_change_billing", "naviga_dti_cs_auto_renew_info", "naviga_dti_cs_auto_tran", "naviga_dti_cs_billing_info", "naviga_dti_cs_login", "naviga_dti_cs_pay_info", "naviga_dti_cs_pay_tran", "naviga_dti_cs_renew_info", "naviga_dti_cs_search_page", "naviga_dti_cs_service_error_info", "naviga_dti_cs_service_error_trans", "naviga_dti_cs_stop_info", "naviga_dti_cs_stop_trans", "swervepay_create_customer", "swervepay_query_customer_details", "swervepay_query_customer_token_details", "swervepay_query_customer_tokens", "swervepay_query_customer_transactions", "swervepay_query_customers", "swervepay_query_transaction_details", "swervepay_query_transactions", "swervepay_remove_customer_token", "swervepay_update_customer", "swervepay_create_transaction_auth", "swervepay_create_transaction_capture", "swervepay_create_transaction_credit", "swervepay_create_transaction_refund", "swervepay_create_transaction_sale", "swervepay_create_transaction_validate", "swervepay_process_new_transaction_auth", "swervepay_process_new_transaction_capture", "swervepay_process_new_transaction_credit", "swervepay_process_new_transaction_refund", "swervepay_process_new_transaction_sale", "swervepay_process_new_transaction_validate", "veradigm_get_locations", "veradigm_get_patient_account_balance", "veradigm_get_payments", "veradigm_get_places_of_service", "veradigm_save_payment_transaction", "veradigm_save_refund_transaction", "veradigm_save_voucher_payment", "veradigm_practice_management_get_token", "veradigm_practice_management_get_user_authentication", "veradigm_practice_management_get_locations", "veradigm_practice_management_get_patient_account_balance", "veradigm_practice_management_get_payments", "veradigm_practice_management_get_places_of_service", "veradigm_practice_management_save_payment_transaction", "veradigm_practice_management_save_refund_transaction", "veradigm_practice_management_save_voucher_payment", "veradigm_practice_management_get_practitioners", "veradigm_practice_management_get_transaction_codes", "veradigm_practice_management_get_departments", "pdcflow_tokenize_credit_card", "pdcflow_cc_transaction", "debug_echo", "debug_validate", "acquired_process_payment", "generic_request", "healthpay24_accounts_receivable", "finvi_facs_process_payment", "finvi_velosidy_account_search", "finvi_velosidy_one_time_sale", "finvi_velosidy_plan_offer", "finvi_velosidy_plan_recurring_create", "finvi_velosidy_pending_payment", "finvi_velosidy_plan_one_time_future", "clover_payment_card_sale_transaction", "nuvei_payment", "callipay_cc_payment", "callipay_check_payment", "tratta_cc_charge", "tratta_ach_charge", "tratta_cc_charge_post_dated", "tratta_ach_charge_post_dated", "fortis_create_achtoken", "fortis_create_cctoken", "fortis_token_ach_debit_payment", "fortis_token_cc_payment", "blinkpayment_charge_cc", "blinkpayment_charge_ach", "waystar_cc_payment", "waystar_ach_payment", "aciworldwide_cc_payment", "aciworldwide_ach_payment")
    PLUGIN_INSTANCE_ID_FIELD_NUMBER: _ClassVar[int]
    BRAINTREE_CREDIT_SALE_FIELD_NUMBER: _ClassVar[int]
    BRAINTREE_BANK_SALE_FIELD_NUMBER: _ClassVar[int]
    BRAINTREE_CREDIT_AUTHORIZE_PAYMENT_FIELD_NUMBER: _ClassVar[int]
    ...
    RELATIENT_GET_PATIENT_BALANCE_NEW_FIELD_NUMBER: _ClassVar[int]
    RELATIENT_GET_PATIENT_CC_TOKENS_NEW_FIELD_NUMBER: _ClassVar[int]
    RELATIENT_POST_PATIENT_TOKEN_NEW_FIELD_NUMBER: _ClassVar[int]
    RELATIENT_POST_PATIENT_BALANCE_NEW_FIELD_NUMBER: _ClassVar[int]
    ...
    INTERPROSE_GET_BUNDLE_FIELD_NUMBER: _ClassVar[int]
    ...
    BILLINGTREE_GET_ACCESS_TOKEN_FIELD_NUMBER: _ClassVar[int]
    BILLINGTREE_TOKENIZE_CARD_FIELD_NUMBER: _ClassVar[int]
    BILLINGTREE_TOKENIZE_ACH_FIELD_NUMBER: _ClassVar[int]
    BILLINGTREE_TRANSACTION_CARD_SALE_FIELD_NUMBER: _ClassVar[int]
    BILLINGTREE_TRANSACTION_ACH_SALE_FIELD_NUMBER: _ClassVar[int]
    BILLINGTREE_QUERY_FEE_FIELD_NUMBER: _ClassVar[int]
    ...
    JOURNEY_SEARCH_FIELD_NUMBER: _ClassVar[int]
    ...
    NTVB_COMPLETE_PENDING_ORDER_FIELD_NUMBER: _ClassVar[int]
    NTVB_PLACE_ORDER_FIELD_NUMBER: _ClassVar[int]
    ...
    ELAVON_ELECTRONIC_CHECK_PURCHASE_FIELD_NUMBER: _ClassVar[int]
    ELAVON_SUBMIT_INSTALLMENT_SALE_FIELD_NUMBER: _ClassVar[int]
    ...
    PAYSCOUT_CREDIT_SALE_RECURRING_FIELD_NUMBER: _ClassVar[int]
    PAYSCOUT_ECHECK_SALE_RECURRING_FIELD_NUMBER: _ClassVar[int]
    PAYSCOUT_GET_CONSUMER_FEE_FIELD_NUMBER: _ClassVar[int]
    PAYSCOUT_STORE_TOKEN_FIELD_NUMBER: _ClassVar[int]
    ...
    PIANO_ADD_PAYMENT_FIELD_NUMBER: _ClassVar[int]
    PIANO_UPDATE_PAYMENT_FIELD_NUMBER: _ClassVar[int]
    ...
    NEWZWARE_SUBSCRIPTION_RESTART_FIELD_NUMBER: _ClassVar[int]
    ...
    SUTHERLANDREV_PAYMENT_CONNECT_FIELD_NUMBER: _ClassVar[int]
    FINVI_EXILE_QUERY_RECORDS_FIELD_NUMBER: _ClassVar[int]
    FINVI_EXILE_READ_FIELDS_FIELD_NUMBER: _ClassVar[int]
    FINVI_EXILE_WRITE_FIELDS_FIELD_NUMBER: _ClassVar[int]
    FINVI_EXILE_EXECUTE_LOGIC_FIELD_NUMBER: _ClassVar[int]
    FINVI_EXILE_CREATE_PAYMENT_FIELD_NUMBER: _ClassVar[int]
    FINVI_EXILE_POP_ACCOUNT_FIELD_NUMBER: _ClassVar[int]
    NAVIGA_DTI_CIRC_CREATE_PAYMENT_FIELD_NUMBER: _ClassVar[int]
    NAVIGA_DTI_CIRC_CHANGE_BILLING_FIELD_NUMBER: _ClassVar[int]
    NAVIGA_DTI_CS_AUTO_RENEW_INFO_FIELD_NUMBER: _ClassVar[int]
    NAVIGA_DTI_CS_AUTO_TRAN_FIELD_NUMBER: _ClassVar[int]
    NAVIGA_DTI_CS_BILLING_INFO_FIELD_NUMBER: _ClassVar[int]
    NAVIGA_DTI_CS_LOGIN_FIELD_NUMBER: _ClassVar[int]
    NAVIGA_DTI_CS_PAY_INFO_FIELD_NUMBER: _ClassVar[int]
    NAVIGA_DTI_CS_PAY_TRAN_FIELD_NUMBER: _ClassVar[int]
    NAVIGA_DTI_CS_RENEW_INFO_FIELD_NUMBER: _ClassVar[int]
    NAVIGA_DTI_CS_SEARCH_PAGE_FIELD_NUMBER: _ClassVar[int]
    NAVIGA_DTI_CS_SERVICE_ERROR_INFO_FIELD_NUMBER: _ClassVar[int]
    NAVIGA_DTI_CS_SERVICE_ERROR_TRANS_FIELD_NUMBER: _ClassVar[int]
    NAVIGA_DTI_CS_STOP_INFO_FIELD_NUMBER: _ClassVar[int]
    NAVIGA_DTI_CS_STOP_TRANS_FIELD_NUMBER: _ClassVar[int]
    SWERVEPAY_CREATE_CUSTOMER_FIELD_NUMBER: _ClassVar[int]
    SWERVEPAY_QUERY_CUSTOMER_DETAILS_FIELD_NUMBER: _ClassVar[int]
    SWERVEPAY_QUERY_CUSTOMER_TOKEN_DETAILS_FIELD_NUMBER: _ClassVar[int]
    SWERVEPAY_QUERY_CUSTOMER_TOKENS_FIELD_NUMBER: _ClassVar[int]
    SWERVEPAY_QUERY_CUSTOMER_TRANSACTIONS_FIELD_NUMBER: _ClassVar[int]
    SWERVEPAY_QUERY_CUSTOMERS_FIELD_NUMBER: _ClassVar[int]
    SWERVEPAY_QUERY_TRANSACTION_DETAILS_FIELD_NUMBER: _ClassVar[int]
    SWERVEPAY_QUERY_TRANSACTIONS_FIELD_NUMBER: _ClassVar[int]
    SWERVEPAY_REMOVE_CUSTOMER_TOKEN_FIELD_NUMBER: _ClassVar[int]
    SWERVEPAY_UPDATE_CUSTOMER_FIELD_NUMBER: _ClassVar[int]
    SWERVEPAY_CREATE_TRANSACTION_AUTH_FIELD_NUMBER: _ClassVar[int]
    SWERVEPAY_CREATE_TRANSACTION_CAPTURE_FIELD_NUMBER: _ClassVar[int]
    SWERVEPAY_CREATE_TRANSACTION_CREDIT_FIELD_NUMBER: _ClassVar[int]
    SWERVEPAY_CREATE_TRANSACTION_REFUND_FIELD_NUMBER: _ClassVar[int]
    SWERVEPAY_CREATE_TRANSACTION_SALE_FIELD_NUMBER: _ClassVar[int]
    SWERVEPAY_CREATE_TRANSACTION_VALIDATE_FIELD_NUMBER: _ClassVar[int]
    SWERVEPAY_PROCESS_NEW_TRANSACTION_AUTH_FIELD_NUMBER: _ClassVar[int]
    SWERVEPAY_PROCESS_NEW_TRANSACTION_CAPTURE_FIELD_NUMBER: _ClassVar[int]
    SWERVEPAY_PROCESS_NEW_TRANSACTION_CREDIT_FIELD_NUMBER: _ClassVar[int]
    SWERVEPAY_PROCESS_NEW_TRANSACTION_REFUND_FIELD_NUMBER: _ClassVar[int]
    SWERVEPAY_PROCESS_NEW_TRANSACTION_SALE_FIELD_NUMBER: _ClassVar[int]
    SWERVEPAY_PROCESS_NEW_TRANSACTION_VALIDATE_FIELD_NUMBER: _ClassVar[int]
    VERADIGM_GET_LOCATIONS_FIELD_NUMBER: _ClassVar[int]
    VERADIGM_GET_PATIENT_ACCOUNT_BALANCE_FIELD_NUMBER: _ClassVar[int]
    VERADIGM_GET_PAYMENTS_FIELD_NUMBER: _ClassVar[int]
    VERADIGM_GET_PLACES_OF_SERVICE_FIELD_NUMBER: _ClassVar[int]
    VERADIGM_SAVE_PAYMENT_TRANSACTION_FIELD_NUMBER: _ClassVar[int]
    VERADIGM_SAVE_REFUND_TRANSACTION_FIELD_NUMBER: _ClassVar[int]
    VERADIGM_SAVE_VOUCHER_PAYMENT_FIELD_NUMBER: _ClassVar[int]
    VERADIGM_PRACTICE_MANAGEMENT_GET_TOKEN_FIELD_NUMBER: _ClassVar[int]
    VERADIGM_PRACTICE_MANAGEMENT_GET_USER_AUTHENTICATION_FIELD_NUMBER: _ClassVar[int]
    VERADIGM_PRACTICE_MANAGEMENT_GET_LOCATIONS_FIELD_NUMBER: _ClassVar[int]
    VERADIGM_PRACTICE_MANAGEMENT_GET_PATIENT_ACCOUNT_BALANCE_FIELD_NUMBER: _ClassVar[int]
    VERADIGM_PRACTICE_MANAGEMENT_GET_PAYMENTS_FIELD_NUMBER: _ClassVar[int]
    VERADIGM_PRACTICE_MANAGEMENT_GET_PLACES_OF_SERVICE_FIELD_NUMBER: _ClassVar[int]
    VERADIGM_PRACTICE_MANAGEMENT_SAVE_PAYMENT_TRANSACTION_FIELD_NUMBER: _ClassVar[int]
    VERADIGM_PRACTICE_MANAGEMENT_SAVE_REFUND_TRANSACTION_FIELD_NUMBER: _ClassVar[int]
    VERADIGM_PRACTICE_MANAGEMENT_SAVE_VOUCHER_PAYMENT_FIELD_NUMBER: _ClassVar[int]
    VERADIGM_PRACTICE_MANAGEMENT_GET_PRACTITIONERS_FIELD_NUMBER: _ClassVar[int]
    VERADIGM_PRACTICE_MANAGEMENT_GET_TRANSACTION_CODES_FIELD_NUMBER: _ClassVar[int]
    VERADIGM_PRACTICE_MANAGEMENT_GET_DEPARTMENTS_FIELD_NUMBER: _ClassVar[int]
    PDCFLOW_TOKENIZE_CREDIT_CARD_FIELD_NUMBER: _ClassVar[int]
    PDCFLOW_CC_TRANSACTION_FIELD_NUMBER: _ClassVar[int]
    DEBUG_ECHO_FIELD_NUMBER: _ClassVar[int]
    DEBUG_VALIDATE_FIELD_NUMBER: _ClassVar[int]
    ACQUIRED_PROCESS_PAYMENT_FIELD_NUMBER: _ClassVar[int]
    GENERIC_REQUEST_FIELD_NUMBER: _ClassVar[int]
    HEALTHPAY24_ACCOUNTS_RECEIVABLE_FIELD_NUMBER: _ClassVar[int]
    FINVI_FACS_PROCESS_PAYMENT_FIELD_NUMBER: _ClassVar[int]
    FINVI_VELOSIDY_ACCOUNT_SEARCH_FIELD_NUMBER: _ClassVar[int]
    FINVI_VELOSIDY_ONE_TIME_SALE_FIELD_NUMBER: _ClassVar[int]
    FINVI_VELOSIDY_PLAN_OFFER_FIELD_NUMBER: _ClassVar[int]
    FINVI_VELOSIDY_PLAN_RECURRING_CREATE_FIELD_NUMBER: _ClassVar[int]
    FINVI_VELOSIDY_PENDING_PAYMENT_FIELD_NUMBER: _ClassVar[int]
    FINVI_VELOSIDY_PLAN_ONE_TIME_FUTURE_FIELD_NUMBER: _ClassVar[int]
    CLOVER_PAYMENT_CARD_SALE_TRANSACTION_FIELD_NUMBER: _ClassVar[int]
    NUVEI_PAYMENT_FIELD_NUMBER: _ClassVar[int]
    CALLIPAY_CC_PAYMENT_FIELD_NUMBER: _ClassVar[int]
    CALLIPAY_CHECK_PAYMENT_FIELD_NUMBER: _ClassVar[int]
    TRATTA_CC_CHARGE_FIELD_NUMBER: _ClassVar[int]
    TRATTA_ACH_CHARGE_FIELD_NUMBER: _ClassVar[int]
    TRATTA_CC_CHARGE_POST_DATED_FIELD_NUMBER: _ClassVar[int]
    TRATTA_ACH_CHARGE_POST_DATED_FIELD_NUMBER: _ClassVar[int]
    FORTIS_CREATE_ACHTOKEN_FIELD_NUMBER: _ClassVar[int]
    FORTIS_CREATE_CCTOKEN_FIELD_NUMBER: _ClassVar[int]
    FORTIS_TOKEN_ACH_DEBIT_PAYMENT_FIELD_NUMBER: _ClassVar[int]
    FORTIS_TOKEN_CC_PAYMENT_FIELD_NUMBER: _ClassVar[int]
    BLINKPAYMENT_CHARGE_CC_FIELD_NUMBER: _ClassVar[int]
    BLINKPAYMENT_CHARGE_ACH_FIELD_NUMBER: _ClassVar[int]
    WAYSTAR_CC_PAYMENT_FIELD_NUMBER: _ClassVar[int]
    WAYSTAR_ACH_PAYMENT_FIELD_NUMBER: _ClassVar[int]
    ACIWORLDWIDE_CC_PAYMENT_FIELD_NUMBER: _ClassVar[int]
    ACIWORLDWIDE_ACH_PAYMENT_FIELD_NUMBER: _ClassVar[int]
    plugin_instance_id: str
    braintree_credit_sale: ExecuteBraintreeCreditSale
    braintree_bank_sale: ExecuteBraintreeBankSale
    braintree_credit_authorize_payment: ExecuteBraintreeCreditAuthorizePayment
    ...
    relatient_get_patient_balance_new: ExecuteRelatientGetPatientBalanceNew
    relatient_get_patient_cc_tokens_new: ExecuteRelatientGetPatientCcTokensNew
    relatient_post_patient_token_new: ExecuteRelatientPostPatientTokenNew
    relatient_post_patient_balance_new: ExecuteRelatientPostPatientBalanceNew
    ...
    interprose_get_bundle: ExecuteInterproseGetBundle
    ...
    billingtree_get_access_token: ExecuteBillingtreeGetAccessToken
    billingtree_tokenize_card: ExecuteBillingtreeTokenizeCard
    billingtree_tokenize_ach: ExecuteBillingtreeTokenizeAch
    billingtree_transaction_card_sale: ExecuteBillingtreeTransactionCardSale
    billingtree_transaction_ach_sale: ExecuteBillingtreeTransactionAchSale
    billingtree_query_fee: ExecuteBillingtreeQueryFee
    ...
    journey_search: ExecuteJourneySearch
    ...
    ntvb_complete_pending_order: ExecuteNtvbCompletePendingOrder
    ntvb_place_order: ExecuteNtvbPlaceOrder
    ...
    elavon_electronic_check_purchase: ExecuteElavonElectronicCheckPurchase
    elavon_submit_installment_sale: ExecuteElavonSubmitInstallmentSale
    ...
    payscout_credit_sale_recurring: ExecutePayScoutCreditCardSaleRecurring
    payscout_echeck_sale_recurring: ExecutePayScoutEcheckSaleRecurring
    payscout_get_consumer_fee: ExecutePayScoutGetConsumerFee
    payscout_store_token: ExecutePayScoutStoreToken
    ...
    PIANO_ADD_PAYMENT: ExacutePianoAddPayment
    PIANO_UPDATE_PAYMENT: ExacutePianoUpdatePayment
    ...
    newzware_subscription_restart: ExecuteNewzwareSubscriptionRestart
    ...
    sutherlandrev_payment_connect: ExecuteSutherlandrevPaymentConnect
    finvi_exile_query_records: ExecuteFinviExileQueryRecords
    finvi_exile_read_fields: ExecuteFinviExileReadFields
    finvi_exile_write_fields: ExecuteFinviExileWriteFields
    finvi_exile_execute_logic: ExecuteFinviExileExecuteLogic
    finvi_exile_create_payment: ExecuteFinviExileCreatePayment
    finvi_exile_pop_account: ExecuteFinviExilePopAccount
    naviga_dti_circ_create_payment: ExecuteNavigaDTICircCreatePayment
    naviga_dti_circ_change_billing: ExecuteNavigaDTICircChangeBilling
    naviga_dti_cs_auto_renew_info: ExecuteNavigaDTICSAutoRenewInfo
    naviga_dti_cs_auto_tran: ExecuteNavigaDTICSAutoTran
    naviga_dti_cs_billing_info: ExecuteNavigaDTICSBillingInfo
    naviga_dti_cs_login: ExecuteNavigaDTICSLogin
    naviga_dti_cs_pay_info: ExecuteNavigaDTICSPayInfo
    naviga_dti_cs_pay_tran: ExecuteNavigaDTICSPayTran
    naviga_dti_cs_renew_info: ExecuteNavigaDTICSRenewInfo
    naviga_dti_cs_search_page: ExecuteNavigaDTICSSearchPage
    naviga_dti_cs_service_error_info: ExecuteNavigaDTICSServiceErrorInfo
    naviga_dti_cs_service_error_trans: ExecuteNavigaDTICSServiceErrorTrans
    naviga_dti_cs_stop_info: ExecuteNavigaDTICSStopInfo
    naviga_dti_cs_stop_trans: ExecuteNavigaDTICSStopTrans
    swervepay_create_customer: ExecuteSwervepayCreateCustomer
    swervepay_query_customer_details: ExecuteSwervepayQueryCustomerDetails
    swervepay_query_customer_token_details: ExecuteSwervepayQueryCustomerTokenDetails
    swervepay_query_customer_tokens: ExecuteSwervepayQueryQueryCustomerTokens
    swervepay_query_customer_transactions: ExecuteSwervepayQueryCustomerTransactions
    swervepay_query_customers: ExecuteSwervepayQueryCustomers
    swervepay_query_transaction_details: ExecuteSwervepayQueryQueryTransactionDetails
    swervepay_query_transactions: ExecuteSwervepayQueryTransactions
    swervepay_remove_customer_token: ExecuteSwervepayRemoveCustomerToken
    swervepay_update_customer: ExecuteSwervepayUpdateCustomer
    swervepay_create_transaction_auth: ExecuteSwervepayCreateTransactionAuth
    swervepay_create_transaction_capture: ExecuteSwervepayCreateTransactionCapture
    swervepay_create_transaction_credit: ExecuteSwervepayCreateTransactionCredit
    swervepay_create_transaction_refund: ExecuteSwervepayCreateTransactionRefund
    swervepay_create_transaction_sale: ExecuteSwervepayCreateTransactionSale
    swervepay_create_transaction_validate: ExecuteSwervepayCreateTransactionValidate
    swervepay_process_new_transaction_auth: ExecuteSwervepayProcessNewTransactionAuth
    swervepay_process_new_transaction_capture: ExecuteSwervepayProcessNewTransactionCapture
    swervepay_process_new_transaction_credit: ExecuteSwervepayProcessNewTransactionCredit
    swervepay_process_new_transaction_refund: ExecuteSwervepayProcessNewTransactionRefund
    swervepay_process_new_transaction_sale: ExecuteSwervepayProcessNewTransactionSale
    swervepay_process_new_transaction_validate: ExecuteSwervepayProcessNewTransactionValidate
    veradigm_get_locations: ExecuteVeradigmGetLocations
    veradigm_get_patient_account_balance: ExecuteVeradigmGetPatientAccountBalance
    veradigm_get_payments: ExecuteVeradigmGetPayments
    veradigm_get_places_of_service: ExecuteVeradigmGetPlacesOfService
    veradigm_save_payment_transaction: ExecuteVeradigmSavePaymentTransaction
    veradigm_save_refund_transaction: ExecuteVeradigmSaveRefundTransaction
    veradigm_save_voucher_payment: ExecuteVeradigmSaveVoucherPayment
    veradigm_practice_management_get_token: ExecuteVeradigmPracticeManagementGetToken
    veradigm_practice_management_get_user_authentication: ExecuteVeradigmPracticeManagementGetUserAuthentication
    veradigm_practice_management_get_locations: ExecuteVeradigmPracticeManagementGetLocations
    veradigm_practice_management_get_patient_account_balance: ExecuteVeradigmPracticeManagementGetPatientAccountBalance
    veradigm_practice_management_get_payments: ExecuteVeradigmPracticeManagementGetPayments
    veradigm_practice_management_get_places_of_service: ExecuteVeradigmPracticeManagementGetPlacesOfService
    veradigm_practice_management_save_payment_transaction: ExecuteVeradigmPracticeManagementSavePaymentTransaction
    veradigm_practice_management_save_refund_transaction: ExecuteVeradigmPracticeManagementSaveRefundTransaction
    veradigm_practice_management_save_voucher_payment: ExecuteVeradigmPracticeManagementSaveVoucherPayment
    veradigm_practice_management_get_practitioners: ExecuteVeradigmPracticeManagementGetPractitioners
    veradigm_practice_management_get_transaction_codes: ExecuteVeradigmPracticeManagementGetTransactionCodes
    veradigm_practice_management_get_departments: ExecuteVeradigmPracticeManagementGetDepartments
    pdcflow_tokenize_credit_card: ExecutePDCFlowTokenizeCreditCard
    pdcflow_cc_transaction: ExecutePDCFlowCCTransaction
    debug_echo: ExecuteDebugEcho
    debug_validate: ExecuteDebugValidate
    acquired_process_payment: ExecuteAcquiredProcessPayment
    generic_request: ExecuteGenericRequest
    healthpay24_accounts_receivable: ExecuteHealthpay24AccountsReceivable
    finvi_facs_process_payment: ExecuteFinviFacsProcessPayment
    finvi_velosidy_account_search: ExecuteFinviVelosidyAccountSearch
    finvi_velosidy_one_time_sale: ExecuteFinviVelosidyOneTimeSale
    finvi_velosidy_plan_offer: ExecuteFinviVelosidyPlanOffer
    finvi_velosidy_plan_recurring_create: ExecuteFinviVelosidyPlanRecurringCreate
    finvi_velosidy_pending_payment: ExecuteFinviVelosidyPendingPayment
    finvi_velosidy_plan_one_time_future: ExecuteFinviVelosidyPlanOneTimeFuture
    clover_payment_card_sale_transaction: ExecuteCloverPaymentCardSaleTransaction
    nuvei_payment: ExecuteNuveiPayment
    callipay_cc_payment: ExecuteCallipayCcPayment
    callipay_check_payment: ExecuteCallipayCheckPayment
    tratta_cc_charge: ExecuteTrattaCcCharge
    tratta_ach_charge: ExecuteTrattaAchCharge
    tratta_cc_charge_post_dated: ExecuteTrattaCcChargePostDated
    tratta_ach_charge_post_dated: ExecuteTrattaAchChargePostDated
    fortis_create_achtoken: ExecuteFortisCreateAchtoken
    fortis_create_cctoken: ExecuteFortisCreateCctoken
    fortis_token_ach_debit_payment: ExecuteFortisTokenAchDebitPayment
    fortis_token_cc_payment: ExecuteFortisTokenCcPayment
    blinkpayment_charge_cc: ExecuteBlinkPaymentChargeCc
    blinkpayment_charge_ach: ExecuteBlinkPaymentChargeAch
    waystar_cc_payment: ExecuteWayStarCcPayment
    waystar_ach_payment: ExecuteWayStarAchPayment
    aciworldwide_cc_payment: ExecuteACIWorldwideCcPayment
    aciworldwide_ach_payment: ExecuteACIWorldwideAchPayment
    def __init__(self, plugin_instance_id: _Optional[str] = ..., braintree_credit_sale: _Optional[_Union[ExecuteBraintreeCreditSale, _Mapping]] = ..., braintree_bank_sale: _Optional[_Union[ExecuteBraintreeBankSale, _Mapping]] = ..., braintree_credit_authorize_payment: _Optional[_Union[ExecuteBraintreeCreditAuthorizePayment, _Mapping]] = ..., relatient_get_patient_balance: _Optional[_Union[ExecuteRelatientGetPatientBalance, _Mapping]] = ..., relatient_get_patient_cc_tokens: _Optional[_Union[ExecuteRelatientGetPatientCcTokens, _Mapping]] = ..., relatient_post_patient_token: _Optional[_Union[ExecuteRelatientPostPatientToken, _Mapping]] = ..., relatient_post_patient_balance: _Optional[_Union[ExecuteRelatientPostPatientBalance, _Mapping]] = ..., relatient_get_patient: _Optional[_Union[ExecuteRelatientGetPatient, _Mapping]] = ..., relatient_post_balance_by_id: _Optional[_Union[ExecuteRelatientPostBalanceById, _Mapping]] = ..., relatient_create_fortis_achtoken: _Optional[_Union[ExecuteRelatientCreateFortisAchtoken, _Mapping]] = ..., relatient_create_fortis_cctoken: _Optional[_Union[ExecuteRelatientCreateFortisCctoken, _Mapping]] = ..., relatient_fortis_token_ach_debit_payment: _Optional[_Union[ExecuteRelatientFortisTokenAchDebitPayment, _Mapping]] = ..., relatient_fortis_token_cc_payment: _Optional[_Union[ExecuteRelatientFortisTokenCcPayment, _Mapping]] = ..., relatient_get_patient_balance_new: _Optional[_Union[ExecuteRelatientGetPatientBalanceNew, _Mapping]] = ..., relatient_get_patient_cc_tokens_new: _Optional[_Union[ExecuteRelatientGetPatientCcTokensNew, _Mapping]] = ..., relatient_post_patient_token_new: _Optional[_Union[ExecuteRelatientPostPatientTokenNew, _Mapping]] = ..., relatient_post_patient_balance_new: _Optional[_Union[ExecuteRelatientPostPatientBalanceNew, _Mapping]] = ..., cybersource_credit_payment: _Optional[_Union[ExecuteCybersourceCreditPayment, _Mapping]] = ..., cybersource_echeck_payment: _Optional[_Union[ExecuteCybersourceEcheckPayment, _Mapping]] = ..., circpro_phone_lookup_with_bundle: _Optional[_Union[ExecuteCircproPhoneLookupWithBundle, _Mapping]] = ..., circpro_phone_lookup: _Optional[_Union[ExecuteCircproPhoneLookup, _Mapping]] = ..., circpro_vacation_restart_inquiry: _Optional[_Union[ExecuteCircproVacationRestartInquiry, _Mapping]] = ..., circpro_complaint_inquiry: _Optional[_Union[ExecuteCircproComplaintInquiry, _Mapping]] = ..., circpro_account_inquiry: _Optional[_Union[ExecuteCircproAccountInquiry, _Mapping]] = ..., circpro_account_inquiry_with_tax: _Optional[_Union[ExecuteCircproAccountInquiryWithTax, _Mapping]] = ..., circpro_account_inquiry_with_tax_bundle: _Optional[_Union[ExecuteCircproAccountInquiryWithTaxBundle, _Mapping]] = ..., circpro_complaint_codes: _Optional[_Union[ExecuteCircproComplaintCodes, _Mapping]] = ..., circpro_complaint_update: _Optional[_Union[ExecuteCircproComplaintUpdate, _Mapping]] = ..., circpro_vacation_update: _Optional[_Union[ExecuteCircproVacationUpdate, _Mapping]] = ..., circpro_restart_update: _Optional[_Union[ExecuteCircproRestartUpdate, _Mapping]] = ..., circpro_law_immediate_payment: _Optional[_Union[ExecuteCircproLawImmediatePayment, _Mapping]] = ..., circpro_law_update_data_with_pac: _Optional[_Union[ExecuteCircproLawUpdateDataWithPac, _Mapping]] = ..., circpro_law_get_customers: _Optional[_Union[ExecuteCircproLawGetCustomers, _Mapping]] = ..., circpro_law_get_payment_types: _Optional[_Union[ExecuteCircproLawGetPaymentTypes, _Mapping]] = ..., authorizenet_charge_credit_card: _Optional[_Union[ExecuteAuthorizenetChargeCreditCard, _Mapping]] = ..., authorizenet_debit_bank_account: _Optional[_Union[ExecuteAuthorizenetDebitBankAccount, _Mapping]] = ..., authorizenet_create_customer_payment_profile: _Optional[_Union[ExecuteAuthorizenetCreateCustomerPaymentProfile, _Mapping]] = ..., authorizenet_paypal_transaction: _Optional[_Union[ExecuteAuthorizenetPaypalTransaction, _Mapping]] = ..., authorizenet_google_pay_transaction: _Optional[_Union[ExecuteAuthorizenetGooglePayTransaction, _Mapping]] = ..., authorizenet_apple_pay_transaction: _Optional[_Union[ExecuteAuthorizenetApplePayTransaction, _Mapping]] = ..., authorizenet_pay_pal_auth_capture: _Optional[_Union[ExecuteAuthorizenetPayPalAuthCapture, _Mapping]] = ..., expitrans_cc_transaction: _Optional[_Union[ExecuteExpitransCcTransaction, _Mapping]] = ..., expitrans_ach_transaction: _Optional[_Union[ExecuteExpitransAchTransaction, _Mapping]] = ..., axiamedfusion_cc_transaction: _Optional[_Union[ExecuteAxiamedfusionCcTransaction, _Mapping]] = ..., axiamedfusion_ach_transaction: _Optional[_Union[ExecuteAxiamedfusionAchTransaction, _Mapping]] = ..., axiamedfusion_card_verify: _Optional[_Union[ExecuteAxiamedfusionCardVerify, _Mapping]] = ..., instamed_payment_sale: _Optional[_Union[ExecuteInstamedPaymentSale, _Mapping]] = ..., instamed_void_payment: _Optional[_Union[ExecuteInstamedVoidPayment, _Mapping]] = ..., usaepay_submit_cc_payments: _Optional[_Union[ExecuteUsaepaySubmitCcPayments, _Mapping]] = ..., usaepay_submit_ach_payments: _Optional[_Union[ExecuteUsaepaySubmitAchPayments, _Mapping]] = ..., usaepay_get_cc_token: _Optional[_Union[ExecuteUsaepayGetCcToken, _Mapping]] = ..., ezidebit_submit_cc_payments: _Optional[_Union[ExecuteEzidebitSubmitCcPayments, _Mapping]] = ..., ezidebit_submit_ach_payments: _Optional[_Union[ExecuteEzidebitSubmitAchPayments, _Mapping]] = ..., bambora_submit_cc_payments: _Optional[_Union[ExecuteBamboraSubmitCcPayments, _Mapping]] = ..., bambora_submit_ach_payments: _Optional[_Union[ExecuteBamboraSubmitAchPayments, _Mapping]] = ..., repay_store_card: _Optional[_Union[ExecuteRepayStoreCard, _Mapping]] = ..., repay_payment_token: _Optional[_Union[ExecuteRepayPaymentToken, _Mapping]] = ..., repay_ach_payment_token: _Optional[_Union[ExecuteRepayAchPaymentToken, _Mapping]] = ..., axia_submit_sale_request_by_cc: _Optional[_Union[ExecuteAxiaSubmitSaleRequestByCc, _Mapping]] = ..., axia_submit_sale_request_by_check: _Optional[_Union[ExecuteAxiaSubmitSaleRequestByCheck, _Mapping]] = ..., securetrading_send_payment: _Optional[_Union[ExecuteSecuretradingSendPayment, _Mapping]] = ..., payment_vision_submit_card_sale_request_by_cc: _Optional[_Union[ExecutePaymentVisionSubmitCardSaleRequestByCc, _Mapping]] = ..., payment_vision_submit_card_sale_request_by_ach: _Optional[_Union[ExecutePaymentVisionSubmitCardSaleRequestByAch, _Mapping]] = ..., interprose_lookup_account: _Optional[_Union[ExecuteInterproseLookupAccount, _Mapping]] = ..., interprose_submit_card_sale_request_by_cc: _Optional[_Union[ExecuteInterproseSubmitCardSaleRequestByCc, _Mapping]] = ..., interprose_submit_card_sale_request_by_ach: _Optional[_Union[ExecuteInterproseSubmitCardSaleRequestByAch, _Mapping]] = ..., interprose_lookup_payment_id: _Optional[_Union[ExecuteInterproseLookupPaymentId, _Mapping]] = ..., interprose_lookup_account_by_form_id: _Optional[_Union[ExecuteInterproseLookupAccountByFormId, _Mapping]] = ..., interprose_get_bundle: _Optional[_Union[ExecuteInterproseGetBundle, _Mapping]] = ..., dallasnews_search_by_phone: _Optional[_Union[ExecuteDallasnewsSearchByPhone, _Mapping]] = ..., dallasnews_search_by_zip_street: _Optional[_Union[ExecuteDallasnewsSearchByZipStreet, _Mapping]] = ..., dallasnews_search_by: _Optional[_Union[ExecuteDallasnewsSearchBy, _Mapping]] = ..., dallasnews_create_vacation: _Optional[_Union[ExecuteDallasnewsCreateVacation, _Mapping]] = ..., dallasnews_get_vacation: _Optional[_Union[ExecuteDallasnewsGetVacation, _Mapping]] = ..., dallasnews_get_vacation_days_between: _Optional[_Union[ExecuteDallasnewsGetVacationDaysBetween, _Mapping]] = ..., dallasnews_get_vacation_with_cutoff: _Optional[_Union[ExecuteDallasnewsGetVacationWithCutoff, _Mapping]] = ..., dallasnews_delete_vacation: _Optional[_Union[ExecuteDallasnewsDeleteVacation, _Mapping]] = ..., dallasnews_add_complaint: _Optional[_Union[ExecuteDallasnewsAddComplaint, _Mapping]] = ..., dallasnews_update_phone_number: _Optional[_Union[ExecuteDallasnewsUpdatePhoneNumber, _Mapping]] = ..., dallasnews_stop_account: _Optional[_Union[ExecuteDallasnewsStopAccount, _Mapping]] = ..., dallasnews_cc_payment_token: _Optional[_Union[ExecuteDallasnewsCcPaymentToken, _Mapping]] = ..., dallasnews_ach_payment_token: _Optional[_Union[ExecuteDallasnewsAchPaymentToken, _Mapping]] = ..., payway_submit_card_sale_request: _Optional[_Union[ExecutePaywaySubmitCardSaleRequest, _Mapping]] = ..., payway_create_token_request: _Optional[_Union[ExecutePaywayCreateTokenRequest, _Mapping]] = ..., payway_submit_ach_sale_request: _Optional[_Union[ExecutePaywaySubmitACHSaleRequest, _Mapping]] = ..., billingtree_submit_card_sale_request: _Optional[_Union[ExecuteBillingtreeSubmitCardSaleRequest, _Mapping]] = ..., billingtree_get_access_token: _Optional[_Union[ExecuteBillingtreeGetAccessToken, _Mapping]] = ..., billingtree_tokenize_card: _Optional[_Union[ExecuteBillingtreeTokenizeCard, _Mapping]] = ..., billingtree_tokenize_ach: _Optional[_Union[ExecuteBillingtreeTokenizeAch, _Mapping]] = ..., billingtree_transaction_card_sale: _Optional[_Union[ExecuteBillingtreeTransactionCardSale, _Mapping]] = ..., billingtree_transaction_ach_sale: _Optional[_Union[ExecuteBillingtreeTransactionAchSale, _Mapping]] = ..., billingtree_query_fee: _Optional[_Union[ExecuteBillingtreeQueryFee, _Mapping]] = ..., experian_cc_payment_request: _Optional[_Union[ExecuteExperianCcPaymentRequest, _Mapping]] = ..., experian_cc_payment_plan_request: _Optional[_Union[ExecuteExperianCcPaymentPlanRequest, _Mapping]] = ..., experian_balancerequest: _Optional[_Union[ExecuteExperianBalancerequest, _Mapping]] = ..., experian_ach_payment_request: _Optional[_Union[ExecuteExperianAchPaymentRequest, _Mapping]] = ..., experian_ach_payment_plan_request: _Optional[_Union[ExecuteExperianAchPaymentPlanRequest, _Mapping]] = ..., experian_stella_card_entry: _Optional[_Union[ExecuteExperianStellaCardEntry, _Mapping]] = ..., experian_stella_echeck: _Optional[_Union[ExecuteExperianStellaECheck, _Mapping]] = ..., experian_stella_card_device_tokenization: _Optional[_Union[ExecuteExperianStellaCardDeviceTokenization, _Mapping]] = ..., experian_stella_token_payment: _Optional[_Union[ExecuteExperianStellaTokenPayment, _Mapping]] = ..., experian_stella_ach_tokenization: _Optional[_Union[ExecuteExperianStellaAchTokenization, _Mapping]] = ..., experian_stella_add_usa_epay_token: _Optional[_Union[ExecuteExperianStellaAddusaepaytoken, _Mapping]] = ..., experian_stella_payment_plans: _Optional[_Union[ExecuteExperianStellaPaymentPlans, _Mapping]] = ..., experian_stella_auth: _Optional[_Union[ExecuteExperianStellaAuth, _Mapping]] = ..., experian_stella_card_entry_tokenization: _Optional[_Union[ExecuteExperianStellaCardEntryTokenization, _Mapping]] = ..., experian_stella_payment_plans_by_patient: _Optional[_Union[ExecuteExperianStellaPaymentPlansByPatient, _Mapping]] = ..., newscycle_login: _Optional[_Union[ExecuteNewscycleLogin, _Mapping]] = ..., newscycle_search_page: _Optional[_Union[ExecuteNewscycleSearchPage, _Mapping]] = ..., newscycle_billing_info: _Optional[_Union[ExecuteNewscycleBillingInfo, _Mapping]] = ..., newscycle_service_error_info: _Optional[_Union[ExecuteNewscycleServiceErrorInfo, _Mapping]] = ..., newscycle_service_error_trans: _Optional[_Union[ExecuteNewscycleServiceErrorTrans, _Mapping]] = ..., newscycle_stop_info: _Optional[_Union[ExecuteNewscycleStopInfo, _Mapping]] = ..., newscycle_stop_trans: _Optional[_Union[ExecuteNewscycleStopTrans, _Mapping]] = ..., newscycle_renew_info: _Optional[_Union[ExecuteNewscycleRenewInfo, _Mapping]] = ..., newscycle_auto_renew_info: _Optional[_Union[ExecuteNewscycleAutoRenewInfo, _Mapping]] = ..., newscycle_auto_tran: _Optional[_Union[ExecuteNewscycleAutoTran, _Mapping]] = ..., newscycle_pay_info: _Optional[_Union[ExecuteNewscyclePayInfo, _Mapping]] = ..., newscycle_pay_tran: _Optional[_Union[ExecuteNewscyclePayTran, _Mapping]] = ..., trustcommerce_credit_sale: _Optional[_Union[ExecuteTrustcommerceCreditSale, _Mapping]] = ..., trustcommerce_ach_sale: _Optional[_Union[ExecuteTrustcommerceAchSale, _Mapping]] = ..., vantiv_credit_sale: _Optional[_Union[ExecuteVantivCreditSale, _Mapping]] = ..., vantiv_ach_sale: _Optional[_Union[ExecuteVantivAchSale, _Mapping]] = ..., journey_latest: _Optional[_Union[ExecuteJourneyLatest, _Mapping]] = ..., journey_list: _Optional[_Union[ExecuteJourneyList, _Mapping]] = ..., journey_update: _Optional[_Union[ExecuteJourneyUpdate, _Mapping]] = ..., journey_search: _Optional[_Union[ExecuteJourneySearch, _Mapping]] = ..., athenahealth_get_patients: _Optional[_Union[ExecuteAthenahealthGetPatients, _Mapping]] = ..., athenahealth_get_patients_with_id: _Optional[_Union[ExecuteAthenahealthGetPatientsWithId, _Mapping]] = ..., athenahealth_cc_payment: _Optional[_Union[ExecuteAthenahealthCcPayment, _Mapping]] = ..., brainworks_get_customers_by_phone: _Optional[_Union[ExecuteBrainworksGetCustomersByPhone, _Mapping]] = ..., brainworks_get_suspends: _Optional[_Union[ExecuteBrainworksGetSuspends, _Mapping]] = ..., brainworks_get_customer_by_cust_id_v2: _Optional[_Union[ExecuteBrainworksGetCustomerByCustIdV2, _Mapping]] = ..., brainworks_get_complaints: _Optional[_Union[ExecuteBrainworksGetComplaints, _Mapping]] = ..., brainworks_get_codes_or_types: _Optional[_Union[ExecuteBrainworksGetCodesOrTypes, _Mapping]] = ..., brainworks_stop_suspends: _Optional[_Union[ExecuteBrainworksStopSuspends, _Mapping]] = ..., brainworks_start_suspends: _Optional[_Union[ExecuteBrainworksStartSuspends, _Mapping]] = ..., brainworks_send_complaint: _Optional[_Union[ExecuteBrainworksSendComplaint, _Mapping]] = ..., brainworks_get_customer_by_cust_id: _Optional[_Union[ExecuteBrainworksGetCustomerByCustId, _Mapping]] = ..., osgconnect_cc_payments: _Optional[_Union[ExecuteOsgconnectCcPayments, _Mapping]] = ..., osgconnect_ach_payments: _Optional[_Union[ExecuteOsgconnectAchPayments, _Mapping]] = ..., osgconnect_validate_account_no: _Optional[_Union[ExecuteOsgconnectValidateAccountNo, _Mapping]] = ..., ntvb_credit_missed_delivery: _Optional[_Union[ExecuteNtvbCreditMissedDelivery, _Mapping]] = ..., ntvb_customer_search: _Optional[_Union[ExecuteNtvbCustomerSearch, _Mapping]] = ..., ntvb_end_call: _Optional[_Union[ExecuteNtvbEndCall, _Mapping]] = ..., ntvb_integration_definition: _Optional[_Union[ExecuteNtvbIntegrationDefinition, _Mapping]] = ..., ntvb_missed_delivery: _Optional[_Union[ExecuteNtvbMissedDelivery, _Mapping]] = ..., ntvb_remove_autorenewal: _Optional[_Union[ExecuteNtvbRemoveAutorenewal, _Mapping]] = ..., ntvb_renew_subscription: _Optional[_Union[ExecuteNtvbRenewSubscription, _Mapping]] = ..., ntvb_renewal_offers: _Optional[_Union[ExecuteNtvbRenewalOffers, _Mapping]] = ..., ntvb_set_autorenewal: _Optional[_Union[ExecuteNtvbSetAutorenewal, _Mapping]] = ..., ntvb_start_incoming_call: _Optional[_Union[ExecuteNtvbStartIncomingCall, _Mapping]] = ..., ntvb_start_outgoing_call: _Optional[_Union[ExecuteNtvbStartOutgoingCall, _Mapping]] = ..., ntvb_subscription_info: _Optional[_Union[ExecuteNtvbSubscriptionInfo, _Mapping]] = ..., ntvb_vacation_stop: _Optional[_Union[ExecuteNtvbVacationStop, _Mapping]] = ..., ntvb_authtest: _Optional[_Union[ExecuteNtvbAuthtest, _Mapping]] = ..., ntvb_complete_pending_order: _Optional[_Union[ExecuteNtvbCompletePendingOrder, _Mapping]] = ..., ntvb_place_order: _Optional[_Union[ExecuteNtvbPlaceOrder, _Mapping]] = ..., elavon_credit_card_sale: _Optional[_Union[ExecuteElavonCreditCardSale, _Mapping]] = ..., elavon_add_recurring: _Optional[_Union[ExecuteElavonAddRecurring, _Mapping]] = ..., elavon_dcc_response: _Optional[_Union[ExecuteElavonDccResponse, _Mapping]] = ..., elavon_delete_recurring: _Optional[_Union[ExecuteElavonDeleteRecurring, _Mapping]] = ..., elavon_update_recurring: _Optional[_Union[ExecuteElavonUpdateRecurring, _Mapping]] = ..., elavon_health_care_cc_sale: _Optional[_Union[ExecuteElavonHealthCareCCSale, _Mapping]] = ..., elavon_add_installment: _Optional[_Union[ExecuteElavonAddInstallment, _Mapping]] = ..., elavon_update_installment: _Optional[_Union[ExecuteElavonUpdateInstallment, _Mapping]] = ..., elavon_delete_installment: _Optional[_Union[ExecuteElavonDeleteInstallment, _Mapping]] = ..., elavon_mcc_credit_card_sale: _Optional[_Union[ExecuteElavonMccCreditCardSale, _Mapping]] = ..., elavon_electronic_check_purchase: _Optional[_Union[ExecuteElavonElectronicCheckPurchase, _Mapping]] = ..., elavon_submit_installment_sale: _Optional[_Union[ExecuteElavonSubmitInstallmentSale, _Mapping]] = ..., globalPayments_card_sale: _Optional[_Union[ExecuteGlobalPaymentsCardSale, _Mapping]] = ..., globalPayments_get_transaction_by_id: _Optional[_Union[ExecuteGlobalPaymentsGetTransactionByID, _Mapping]] = ..., globalPayments_list_transactions: _Optional[_Union[ExecuteGlobalPaymentsListTransactions, _Mapping]] = ..., globalPayments_refund_sale: _Optional[_Union[ExecuteGlobalPaymentsRefundSale, _Mapping]] = ..., globalPayments_reverse_sale_or_refund: _Optional[_Union[ExecuteGlobalPaymentsReverseSaleOrRefund, _Mapping]] = ..., payscout_credit_sale: _Optional[_Union[ExecutePayScoutCreditCardSale, _Mapping]] = ..., payscout_echeck_sale: _Optional[_Union[ExecutePayScoutEcheckSale, _Mapping]] = ..., payscout_credit_sale_recurring: _Optional[_Union[ExecutePayScoutCreditCardSaleRecurring, _Mapping]] = ..., payscout_echeck_sale_recurring: _Optional[_Union[ExecutePayScoutEcheckSaleRecurring, _Mapping]] = ..., payscout_get_consumer_fee: _Optional[_Union[ExecutePayScoutGetConsumerFee, _Mapping]] = ..., payscout_store_token: _Optional[_Union[ExecutePayScoutStoreToken, _Mapping]] = ..., i2c_echo: _Optional[_Union[ExecuteI2cEcho, _Mapping]] = ..., i2c_balance_inquiry: _Optional[_Union[ExecuteI2cBalanceInquiry, _Mapping]] = ..., i2c_verify_user: _Optional[_Union[ExecuteI2cVerifyUser, _Mapping]] = ..., i2c_search_customer: _Optional[_Union[ExecuteI2cSearchCustomer, _Mapping]] = ..., i2c_make_payment: _Optional[_Union[ExecuteI2cMakePayment, _Mapping]] = ..., i2c_get_cardholder_profile: _Optional[_Union[ExecuteI2cGetCardholderProfile, _Mapping]] = ..., i2c_get_cardholder_statement: _Optional[_Union[ExecuteI2cGetCardholderStatement, _Mapping]] = ..., i2c_get_cardholder_balance: _Optional[_Union[ExecuteI2cGetCardholderBalance, _Mapping]] = ..., i2c_get_creditpayment_info: _Optional[_Union[ExecuteI2cGetCreditPaymentInfo, _Mapping]] = ..., i2c_transaction_history: _Optional[_Union[ExecuteI2cTransactionHistory, _Mapping]] = ..., opayo_cc_payment: _Optional[_Union[ExecuteOpayoCcPayments, _Mapping]] = ..., shift4_cc_payment: _Optional[_Union[ExecuteShift4CcPayments, _Mapping]] = ..., shift4_access_token: _Optional[_Union[ExecuteShift4CcPayments, _Mapping]] = ..., poscorp_accesstoken: _Optional[_Union[ExecutePoscorpAccesstoken, _Mapping]] = ..., poscorp_lookup_guarantor: _Optional[_Union[ExecutePoscorpLookupGuarantor, _Mapping]] = ..., poscorp_update_payment_status: _Optional[_Union[ExecutePoscorpUpdatePaymentStatus, _Mapping]] = ..., PIANO_GET_USER: _Optional[_Union[ExecutePianoGetUser, _Mapping]] = ..., PIANO_UPDATE_USER: _Optional[_Union[ExecutePianoUpdateUser, _Mapping]] = ..., PIANO_UPDATE_SUBSCRIPTION: _Optional[_Union[ExecutePianoUpdateSubscription, _Mapping]] = ..., PIANO_GET_PAYMENT: _Optional[_Union[ExecutePianoGetPayment, _Mapping]] = ..., PIANO_LIST_SUBSCRIPTION: _Optional[_Union[ExecutePianoListSubscription, _Mapping]] = ..., PIANO_LASTACCESS_CONVERSION: _Optional[_Union[ExecutePianoLastAccessConversion, _Mapping]] = ..., PIANO_ADD_PAYMENT: _Optional[_Union[ExacutePianoAddPayment, _Mapping]] = ..., PIANO_UPDATE_PAYMENT: _Optional[_Union[ExacutePianoUpdatePayment, _Mapping]] = ..., epic_get_token: _Optional[_Union[ExecuteEpicGetToken, _Mapping]] = ..., epic_get_patient: _Optional[_Union[ExecuteEpicGetPatient, _Mapping]] = ..., epic_match_patient: _Optional[_Union[ExecuteEpicMatchPatient, _Mapping]] = ..., epic_search_appointment: _Optional[_Union[ExecuteEpicSearchAppointment, _Mapping]] = ..., epic_find_appointment: _Optional[_Union[ExecuteEpicFindAppointment, _Mapping]] = ..., epic_book_appointment: _Optional[_Union[ExecuteEpicBookAppointment, _Mapping]] = ..., epic_get_account: _Optional[_Union[ExecuteEpicGetAccount, _Mapping]] = ..., epic_receive_communication_2: _Optional[_Union[ExecuteEpicReceiveCommunication2, _Mapping]] = ..., epic_receive_communication_3: _Optional[_Union[ExecuteEpicReceiveCommunication3, _Mapping]] = ..., epic_post_patient_made_payment: _Optional[_Union[ExecuteEpicPostPatientMadePayment, _Mapping]] = ..., epic_get_patient_billing_details: _Optional[_Union[ExecuteEpicGetPatientBillingDetails, _Mapping]] = ..., epic_call_patient: _Optional[_Union[ExecuteEpicCallPatient, _Mapping]] = ..., epic_hangup_call: _Optional[_Union[ExecuteEpicHangupCall, _Mapping]] = ..., epic_get_account_access_identifiers: _Optional[_Union[ExecuteEpicGetAccountAccessIdentifiers, _Mapping]] = ..., epic_get_account_billing_summary: _Optional[_Union[ExecuteEpicGetAccountBillingSummary, _Mapping]] = ..., newzware_phone_lookup: _Optional[_Union[ExecuteNewzwarePhoneLookup, _Mapping]] = ..., newzware_account_inquiry: _Optional[_Union[ExecuteNewzwareAccountInquiry, _Mapping]] = ..., newzware_cc_payment: _Optional[_Union[ExecuteNewzwareCcPayment, _Mapping]] = ..., newzware_ach_Payment: _Optional[_Union[ExecuteNewzwareAchPayment, _Mapping]] = ..., newzware_complaint_history: _Optional[_Union[ExecuteNewzwareComplaintHistory, _Mapping]] = ..., newzware_complaint_update: _Optional[_Union[ExecuteNewzwareComplaintUpdate, _Mapping]] = ..., newzware_vacation_restart: _Optional[_Union[ExecuteNewzwareVacationRestart, _Mapping]] = ..., newzware_vacation_update: _Optional[_Union[ExecuteNewzwareVacationUpdate, _Mapping]] = ..., newzware_phone_lookup_multi: _Optional[_Union[ExecuteNewzwarePhoneLookupMulti, _Mapping]] = ..., newzware_subscription_restart: _Optional[_Union[ExecuteNewzwareSubscriptionRestart, _Mapping]] = ..., priocommerce_ach_payment: _Optional[_Union[ExecutePriocommerceAchPayment, _Mapping]] = ..., priocommerce_cc_payment: _Optional[_Union[ExecutePriocommerceCcPayment, _Mapping]] = ..., naviga_create_payment: _Optional[_Union[ExecuteNavigaCreatePayment, _Mapping]] = ..., naviga_change_billing: _Optional[_Union[ExecuteNavigaChangeBilling, _Mapping]] = ..., paynseconds_tokenize_card: _Optional[_Union[ExecutePaynsecondsTokenizeCard, _Mapping]] = ..., sutherlandrev_payment_connect: _Optional[_Union[ExecuteSutherlandrevPaymentConnect, _Mapping]] = ..., finvi_exile_query_records: _Optional[_Union[ExecuteFinviExileQueryRecords, _Mapping]] = ..., finvi_exile_read_fields: _Optional[_Union[ExecuteFinviExileReadFields, _Mapping]] = ..., finvi_exile_write_fields: _Optional[_Union[ExecuteFinviExileWriteFields, _Mapping]] = ..., finvi_exile_execute_logic: _Optional[_Union[ExecuteFinviExileExecuteLogic, _Mapping]] = ..., finvi_exile_create_payment: _Optional[_Union[ExecuteFinviExileCreatePayment, _Mapping]] = ..., finvi_exile_pop_account: _Optional[_Union[ExecuteFinviExilePopAccount, _Mapping]] = ..., naviga_dti_circ_create_payment: _Optional[_Union[ExecuteNavigaDTICircCreatePayment, _Mapping]] = ..., naviga_dti_circ_change_billing: _Optional[_Union[ExecuteNavigaDTICircChangeBilling, _Mapping]] = ..., naviga_dti_cs_auto_renew_info: _Optional[_Union[ExecuteNavigaDTICSAutoRenewInfo, _Mapping]] = ..., naviga_dti_cs_auto_tran: _Optional[_Union[ExecuteNavigaDTICSAutoTran, _Mapping]] = ..., naviga_dti_cs_billing_info: _Optional[_Union[ExecuteNavigaDTICSBillingInfo, _Mapping]] = ..., naviga_dti_cs_login: _Optional[_Union[ExecuteNavigaDTICSLogin, _Mapping]] = ..., naviga_dti_cs_pay_info: _Optional[_Union[ExecuteNavigaDTICSPayInfo, _Mapping]] = ..., naviga_dti_cs_pay_tran: _Optional[_Union[ExecuteNavigaDTICSPayTran, _Mapping]] = ..., naviga_dti_cs_renew_info: _Optional[_Union[ExecuteNavigaDTICSRenewInfo, _Mapping]] = ..., naviga_dti_cs_search_page: _Optional[_Union[ExecuteNavigaDTICSSearchPage, _Mapping]] = ..., naviga_dti_cs_service_error_info: _Optional[_Union[ExecuteNavigaDTICSServiceErrorInfo, _Mapping]] = ..., naviga_dti_cs_service_error_trans: _Optional[_Union[ExecuteNavigaDTICSServiceErrorTrans, _Mapping]] = ..., naviga_dti_cs_stop_info: _Optional[_Union[ExecuteNavigaDTICSStopInfo, _Mapping]] = ..., naviga_dti_cs_stop_trans: _Optional[_Union[ExecuteNavigaDTICSStopTrans, _Mapping]] = ..., swervepay_create_customer: _Optional[_Union[ExecuteSwervepayCreateCustomer, _Mapping]] = ..., swervepay_query_customer_details: _Optional[_Union[ExecuteSwervepayQueryCustomerDetails, _Mapping]] = ..., swervepay_query_customer_token_details: _Optional[_Union[ExecuteSwervepayQueryCustomerTokenDetails, _Mapping]] = ..., swervepay_query_customer_tokens: _Optional[_Union[ExecuteSwervepayQueryQueryCustomerTokens, _Mapping]] = ..., swervepay_query_customer_transactions: _Optional[_Union[ExecuteSwervepayQueryCustomerTransactions, _Mapping]] = ..., swervepay_query_customers: _Optional[_Union[ExecuteSwervepayQueryCustomers, _Mapping]] = ..., swervepay_query_transaction_details: _Optional[_Union[ExecuteSwervepayQueryQueryTransactionDetails, _Mapping]] = ..., swervepay_query_transactions: _Optional[_Union[ExecuteSwervepayQueryTransactions, _Mapping]] = ..., swervepay_remove_customer_token: _Optional[_Union[ExecuteSwervepayRemoveCustomerToken, _Mapping]] = ..., swervepay_update_customer: _Optional[_Union[ExecuteSwervepayUpdateCustomer, _Mapping]] = ..., swervepay_create_transaction_auth: _Optional[_Union[ExecuteSwervepayCreateTransactionAuth, _Mapping]] = ..., swervepay_create_transaction_capture: _Optional[_Union[ExecuteSwervepayCreateTransactionCapture, _Mapping]] = ..., swervepay_create_transaction_credit: _Optional[_Union[ExecuteSwervepayCreateTransactionCredit, _Mapping]] = ..., swervepay_create_transaction_refund: _Optional[_Union[ExecuteSwervepayCreateTransactionRefund, _Mapping]] = ..., swervepay_create_transaction_sale: _Optional[_Union[ExecuteSwervepayCreateTransactionSale, _Mapping]] = ..., swervepay_create_transaction_validate: _Optional[_Union[ExecuteSwervepayCreateTransactionValidate, _Mapping]] = ..., swervepay_process_new_transaction_auth: _Optional[_Union[ExecuteSwervepayProcessNewTransactionAuth, _Mapping]] = ..., swervepay_process_new_transaction_capture: _Optional[_Union[ExecuteSwervepayProcessNewTransactionCapture, _Mapping]] = ..., swervepay_process_new_transaction_credit: _Optional[_Union[ExecuteSwervepayProcessNewTransactionCredit, _Mapping]] = ..., swervepay_process_new_transaction_refund: _Optional[_Union[ExecuteSwervepayProcessNewTransactionRefund, _Mapping]] = ..., swervepay_process_new_transaction_sale: _Optional[_Union[ExecuteSwervepayProcessNewTransactionSale, _Mapping]] = ..., swervepay_process_new_transaction_validate: _Optional[_Union[ExecuteSwervepayProcessNewTransactionValidate, _Mapping]] = ..., veradigm_get_locations: _Optional[_Union[ExecuteVeradigmGetLocations, _Mapping]] = ..., veradigm_get_patient_account_balance: _Optional[_Union[ExecuteVeradigmGetPatientAccountBalance, _Mapping]] = ..., veradigm_get_payments: _Optional[_Union[ExecuteVeradigmGetPayments, _Mapping]] = ..., veradigm_get_places_of_service: _Optional[_Union[ExecuteVeradigmGetPlacesOfService, _Mapping]] = ..., veradigm_save_payment_transaction: _Optional[_Union[ExecuteVeradigmSavePaymentTransaction, _Mapping]] = ..., veradigm_save_refund_transaction: _Optional[_Union[ExecuteVeradigmSaveRefundTransaction, _Mapping]] = ..., veradigm_save_voucher_payment: _Optional[_Union[ExecuteVeradigmSaveVoucherPayment, _Mapping]] = ..., veradigm_practice_management_get_token: _Optional[_Union[ExecuteVeradigmPracticeManagementGetToken, _Mapping]] = ..., veradigm_practice_management_get_user_authentication: _Optional[_Union[ExecuteVeradigmPracticeManagementGetUserAuthentication, _Mapping]] = ..., veradigm_practice_management_get_locations: _Optional[_Union[ExecuteVeradigmPracticeManagementGetLocations, _Mapping]] = ..., veradigm_practice_management_get_patient_account_balance: _Optional[_Union[ExecuteVeradigmPracticeManagementGetPatientAccountBalance, _Mapping]] = ..., veradigm_practice_management_get_payments: _Optional[_Union[ExecuteVeradigmPracticeManagementGetPayments, _Mapping]] = ..., veradigm_practice_management_get_places_of_service: _Optional[_Union[ExecuteVeradigmPracticeManagementGetPlacesOfService, _Mapping]] = ..., veradigm_practice_management_save_payment_transaction: _Optional[_Union[ExecuteVeradigmPracticeManagementSavePaymentTransaction, _Mapping]] = ..., veradigm_practice_management_save_refund_transaction: _Optional[_Union[ExecuteVeradigmPracticeManagementSaveRefundTransaction, _Mapping]] = ..., veradigm_practice_management_save_voucher_payment: _Optional[_Union[ExecuteVeradigmPracticeManagementSaveVoucherPayment, _Mapping]] = ..., veradigm_practice_management_get_practitioners: _Optional[_Union[ExecuteVeradigmPracticeManagementGetPractitioners, _Mapping]] = ..., veradigm_practice_management_get_transaction_codes: _Optional[_Union[ExecuteVeradigmPracticeManagementGetTransactionCodes, _Mapping]] = ..., veradigm_practice_management_get_departments: _Optional[_Union[ExecuteVeradigmPracticeManagementGetDepartments, _Mapping]] = ..., pdcflow_tokenize_credit_card: _Optional[_Union[ExecutePDCFlowTokenizeCreditCard, _Mapping]] = ..., pdcflow_cc_transaction: _Optional[_Union[ExecutePDCFlowCCTransaction, _Mapping]] = ..., debug_echo: _Optional[_Union[ExecuteDebugEcho, _Mapping]] = ..., debug_validate: _Optional[_Union[ExecuteDebugValidate, _Mapping]] = ..., acquired_process_payment: _Optional[_Union[ExecuteAcquiredProcessPayment, _Mapping]] = ..., generic_request: _Optional[_Union[ExecuteGenericRequest, _Mapping]] = ..., healthpay24_accounts_receivable: _Optional[_Union[ExecuteHealthpay24AccountsReceivable, _Mapping]] = ..., finvi_facs_process_payment: _Optional[_Union[ExecuteFinviFacsProcessPayment, _Mapping]] = ..., finvi_velosidy_account_search: _Optional[_Union[ExecuteFinviVelosidyAccountSearch, _Mapping]] = ..., finvi_velosidy_one_time_sale: _Optional[_Union[ExecuteFinviVelosidyOneTimeSale, _Mapping]] = ..., finvi_velosidy_plan_offer: _Optional[_Union[ExecuteFinviVelosidyPlanOffer, _Mapping]] = ..., finvi_velosidy_plan_recurring_create: _Optional[_Union[ExecuteFinviVelosidyPlanRecurringCreate, _Mapping]] = ..., finvi_velosidy_pending_payment: _Optional[_Union[ExecuteFinviVelosidyPendingPayment, _Mapping]] = ..., finvi_velosidy_plan_one_time_future: _Optional[_Union[ExecuteFinviVelosidyPlanOneTimeFuture, _Mapping]] = ..., clover_payment_card_sale_transaction: _Optional[_Union[ExecuteCloverPaymentCardSaleTransaction, _Mapping]] = ..., nuvei_payment: _Optional[_Union[ExecuteNuveiPayment, _Mapping]] = ..., callipay_cc_payment: _Optional[_Union[ExecuteCallipayCcPayment, _Mapping]] = ..., callipay_check_payment: _Optional[_Union[ExecuteCallipayCheckPayment, _Mapping]] = ..., tratta_cc_charge: _Optional[_Union[ExecuteTrattaCcCharge, _Mapping]] = ..., tratta_ach_charge: _Optional[_Union[ExecuteTrattaAchCharge, _Mapping]] = ..., tratta_cc_charge_post_dated: _Optional[_Union[ExecuteTrattaCcChargePostDated, _Mapping]] = ..., tratta_ach_charge_post_dated: _Optional[_Union[ExecuteTrattaAchChargePostDated, _Mapping]] = ..., fortis_create_achtoken: _Optional[_Union[ExecuteFortisCreateAchtoken, _Mapping]] = ..., fortis_create_cctoken: _Optional[_Union[ExecuteFortisCreateCctoken, _Mapping]] = ..., fortis_token_ach_debit_payment: _Optional[_Union[ExecuteFortisTokenAchDebitPayment, _Mapping]] = ..., fortis_token_cc_payment: _Optional[_Union[ExecuteFortisTokenCcPayment, _Mapping]] = ..., blinkpayment_charge_cc: _Optional[_Union[ExecuteBlinkPaymentChargeCc, _Mapping]] = ..., blinkpayment_charge_ach: _Optional[_Union[ExecuteBlinkPaymentChargeAch, _Mapping]] = ..., waystar_cc_payment: _Optional[_Union[ExecuteWayStarCcPayment, _Mapping]] = ..., waystar_ach_payment: _Optional[_Union[ExecuteWayStarAchPayment, _Mapping]] = ..., aciworldwide_cc_payment: _Optional[_Union[ExecuteACIWorldwideCcPayment, _Mapping]] = ..., aciworldwide_ach_payment: _Optional[_Union[ExecuteACIWorldwideAchPayment, _Mapping]] = ...) -> None: ...
...
class PaymentExperianCC(_message.Message):
    ...
    def __init__(self, use_invoice_account_number: _Optional[bool] = ...) -> None: ...
...
class PaymentStellaCc(_message.Message):
    __slots__ = ()
    def __init__(self) -> None: ...

class PaymentStellaECheck(_message.Message):
    __slots__ = ()
    def __init__(self) -> None: ...

class PaymentFinviCC(_message.Message):
    __slots__ = ()
    def __init__(self) -> None: ...

class PaymentFinviACH(_message.Message):
    __slots__ = ()
    def __init__(self) -> None: ...

class PaymentSwervePayCC(_message.Message):
    __slots__ = ()
    def __init__(self) -> None: ...

class PaymentSwervePayACH(_message.Message):
    __slots__ = ()
    def __init__(self) -> None: ...
...
class ExecuteBraintreeCreditAuthorizePayment(_message.Message):
    __slots__ = ()
    def __init__(self) -> None: ...
...
class ExecuteRelatientGetPatientBalanceNew(_message.Message):
    __slots__ = ()
    def __init__(self) -> None: ...

class ExecuteRelatientGetPatientCcTokensNew(_message.Message):
    __slots__ = ()
    def __init__(self) -> None: ...

class ExecuteRelatientPostPatientTokenNew(_message.Message):
    __slots__ = ()
    def __init__(self) -> None: ...

class ExecuteRelatientPostPatientBalanceNew(_message.Message):
    __slots__ = ()
    def __init__(self) -> None: ...
...
class ExecuteInterproseGetBundle(_message.Message):
    __slots__ = ()
    def __init__(self) -> None: ...
...
class ExecuteBillingtreeGetAccessToken(_message.Message):
    __slots__ = ()
    def __init__(self) -> None: ...

class ExecuteBillingtreeTokenizeCard(_message.Message):
    __slots__ = ()
    def __init__(self) -> None: ...

class ExecuteBillingtreeTokenizeAch(_message.Message):
    __slots__ = ()
    def __init__(self) -> None: ...

class ExecuteBillingtreeTransactionCardSale(_message.Message):
    __slots__ = ()
    def __init__(self) -> None: ...

class ExecuteBillingtreeTransactionAchSale(_message.Message):
    __slots__ = ()
    def __init__(self) -> None: ...

class ExecuteBillingtreeQueryFee(_message.Message):
    __slots__ = ()
    def __init__(self) -> None: ...
...
class ExecuteJourneySearch(_message.Message):
    __slots__ = ()
    def __init__(self) -> None: ...
...
class ExecuteNtvbCompletePendingOrder(_message.Message):
    __slots__ = ()
    def __init__(self) -> None: ...

class ExecuteNtvbPlaceOrder(_message.Message):
    __slots__ = ()
    def __init__(self) -> None: ...
...
class ExecuteElavonElectronicCheckPurchase(_message.Message):
    __slots__ = ()
    def __init__(self) -> None: ...

class ExecuteElavonSubmitInstallmentSale(_message.Message):
    __slots__ = ()
    def __init__(self) -> None: ...
...
class ExecutePayScoutCreditCardSaleRecurring(_message.Message):
    __slots__ = ()
    def __init__(self) -> None: ...

class ExecutePayScoutEcheckSaleRecurring(_message.Message):
    __slots__ = ()
    def __init__(self) -> None: ...

class ExecutePayScoutGetConsumerFee(_message.Message):
    __slots__ = ()
    def __init__(self) -> None: ...

class ExecutePayScoutStoreToken(_message.Message):
    __slots__ = ()
    def __init__(self) -> None: ...
...
class ExacutePianoAddPayment(_message.Message):
    __slots__ = ()
    def __init__(self) -> None: ...

class ExacutePianoUpdatePayment(_message.Message):
    __slots__ = ()
    def __init__(self) -> None: ...
...
class ExecuteNewzwareSubscriptionRestart(_message.Message):
    __slots__ = ()
    def __init__(self) -> None: ...
...
class ExecuteSutherlandrevPaymentConnect(_message.Message):
    __slots__ = ()
    def __init__(self) -> None: ...

class ExecuteDebugEcho(_message.Message):
    __slots__ = ()
    def __init__(self) -> None: ...

class ExecuteDebugValidate(_message.Message):
    __slots__ = ()
    def __init__(self) -> None: ...

class ExecuteFinviExileQueryRecords(_message.Message):
    __slots__ = ()
    def __init__(self) -> None: ...

class ExecuteFinviExileReadFields(_message.Message):
    __slots__ = ()
    def __init__(self) -> None: ...

class ExecuteFinviExileWriteFields(_message.Message):
    __slots__ = ()
    def __init__(self) -> None: ...

class ExecuteFinviExileExecuteLogic(_message.Message):
    __slots__ = ()
    def __init__(self) -> None: ...

class ExecuteFinviExileCreatePayment(_message.Message):
    __slots__ = ()
    def __init__(self) -> None: ...

class ExecuteFinviExilePopAccount(_message.Message):
    __slots__ = ()
    def __init__(self) -> None: ...

class ExecuteSwervepayCreateCustomer(_message.Message):
    __slots__ = ()
    def __init__(self) -> None: ...

class ExecuteSwervepayQueryCustomerDetails(_message.Message):
    __slots__ = ()
    def __init__(self) -> None: ...

class ExecuteSwervepayQueryCustomerTokenDetails(_message.Message):
    __slots__ = ()
    def __init__(self) -> None: ...

class ExecuteSwervepayQueryQueryCustomerTokens(_message.Message):
    __slots__ = ()
    def __init__(self) -> None: ...

class ExecuteSwervepayQueryCustomerTransactions(_message.Message):
    __slots__ = ()
    def __init__(self) -> None: ...

class ExecuteSwervepayQueryCustomers(_message.Message):
    __slots__ = ()
    def __init__(self) -> None: ...

class ExecuteSwervepayQueryQueryTransactionDetails(_message.Message):
    __slots__ = ()
    def __init__(self) -> None: ...

class ExecuteSwervepayQueryTransactions(_message.Message):
    __slots__ = ()
    def __init__(self) -> None: ...

class ExecuteSwervepayRemoveCustomerToken(_message.Message):
    __slots__ = ()
    def __init__(self) -> None: ...

class ExecuteSwervepayUpdateCustomer(_message.Message):
    __slots__ = ()
    def __init__(self) -> None: ...

class ExecuteSwervepayCreateTransactionAuth(_message.Message):
    __slots__ = ()
    def __init__(self) -> None: ...

class ExecuteSwervepayCreateTransactionCapture(_message.Message):
    __slots__ = ()
    def __init__(self) -> None: ...

class ExecuteSwervepayCreateTransactionCredit(_message.Message):
    __slots__ = ()
    def __init__(self) -> None: ...

class ExecuteSwervepayCreateTransactionRefund(_message.Message):
    __slots__ = ()
    def __init__(self) -> None: ...

class ExecuteSwervepayCreateTransactionSale(_message.Message):
    __slots__ = ()
    def __init__(self) -> None: ...

class ExecuteSwervepayCreateTransactionValidate(_message.Message):
    __slots__ = ()
    def __init__(self) -> None: ...

class ExecuteSwervepayProcessNewTransactionAuth(_message.Message):
    __slots__ = ()
    def __init__(self) -> None: ...

class ExecuteSwervepayProcessNewTransactionCapture(_message.Message):
    __slots__ = ()
    def __init__(self) -> None: ...

class ExecuteSwervepayProcessNewTransactionCredit(_message.Message):
    __slots__ = ()
    def __init__(self) -> None: ...

class ExecuteSwervepayProcessNewTransactionRefund(_message.Message):
    __slots__ = ()
    def __init__(self) -> None: ...

class ExecuteSwervepayProcessNewTransactionSale(_message.Message):
    __slots__ = ()
    def __init__(self) -> None: ...

class ExecuteSwervepayProcessNewTransactionValidate(_message.Message):
    __slots__ = ()
    def __init__(self) -> None: ...

class ExecuteNavigaDTICircCreatePayment(_message.Message):
    __slots__ = ()
    def __init__(self) -> None: ...

class ExecuteNavigaDTICircChangeBilling(_message.Message):
    __slots__ = ()
    def __init__(self) -> None: ...

class ExecuteNavigaDTICSAutoRenewInfo(_message.Message):
    __slots__ = ()
    def __init__(self) -> None: ...

class ExecuteNavigaDTICSAutoTran(_message.Message):
    __slots__ = ()
    def __init__(self) -> None: ...

class ExecuteNavigaDTICSBillingInfo(_message.Message):
    __slots__ = ()
    def __init__(self) -> None: ...

class ExecuteNavigaDTICSLogin(_message.Message):
    __slots__ = ()
    def __init__(self) -> None: ...

class ExecuteNavigaDTICSPayInfo(_message.Message):
    __slots__ = ()
    def __init__(self) -> None: ...

class ExecuteNavigaDTICSPayTran(_message.Message):
    __slots__ = ()
    def __init__(self) -> None: ...

class ExecuteNavigaDTICSRenewInfo(_message.Message):
    __slots__ = ()
    def __init__(self) -> None: ...

class ExecuteNavigaDTICSSearchPage(_message.Message):
    __slots__ = ()
    def __init__(self) -> None: ...

class ExecuteNavigaDTICSServiceErrorInfo(_message.Message):
    __slots__ = ()
    def __init__(self) -> None: ...

class ExecuteNavigaDTICSServiceErrorTrans(_message.Message):
    __slots__ = ()
    def __init__(self) -> None: ...

class ExecuteNavigaDTICSStopInfo(_message.Message):
    __slots__ = ()
    def __init__(self) -> None: ...

class ExecuteNavigaDTICSStopTrans(_message.Message):
    __slots__ = ()
    def __init__(self) -> None: ...

class ExecuteVeradigmGetLocations(_message.Message):
    __slots__ = ()
    def __init__(self) -> None: ...

class ExecuteVeradigmGetPatientAccountBalance(_message.Message):
    __slots__ = ()
    def __init__(self) -> None: ...

class ExecuteVeradigmGetPayments(_message.Message):
    __slots__ = ()
    def __init__(self) -> None: ...

class ExecuteVeradigmGetPlacesOfService(_message.Message):
    __slots__ = ()
    def __init__(self) -> None: ...

class ExecuteVeradigmSavePaymentTransaction(_message.Message):
    __slots__ = ()
    def __init__(self) -> None: ...

class ExecuteVeradigmSaveRefundTransaction(_message.Message):
    __slots__ = ()
    def __init__(self) -> None: ...

class ExecuteVeradigmSaveVoucherPayment(_message.Message):
    __slots__ = ()
    def __init__(self) -> None: ...

class ExecuteVeradigmPracticeManagementGetToken(_message.Message):
    __slots__ = ()
    def __init__(self) -> None: ...

class ExecuteVeradigmPracticeManagementGetUserAuthentication(_message.Message):
    __slots__ = ()
    def __init__(self) -> None: ...

class ExecuteVeradigmPracticeManagementGetLocations(_message.Message):
    __slots__ = ()
    def __init__(self) -> None: ...

class ExecuteVeradigmPracticeManagementGetPatientAccountBalance(_message.Message):
    __slots__ = ()
    def __init__(self) -> None: ...

class ExecuteVeradigmPracticeManagementGetPayments(_message.Message):
    __slots__ = ()
    def __init__(self) -> None: ...

class ExecuteVeradigmPracticeManagementGetPlacesOfService(_message.Message):
    __slots__ = ()
    def __init__(self) -> None: ...

class ExecuteVeradigmPracticeManagementSavePaymentTransaction(_message.Message):
    __slots__ = ()
    def __init__(self) -> None: ...

class ExecuteVeradigmPracticeManagementSaveRefundTransaction(_message.Message):
    __slots__ = ()
    def __init__(self) -> None: ...

class ExecuteVeradigmPracticeManagementSaveVoucherPayment(_message.Message):
    __slots__ = ()
    def __init__(self) -> None: ...

class ExecuteVeradigmPracticeManagementGetPractitioners(_message.Message):
    __slots__ = ()
    def __init__(self) -> None: ...

class ExecuteVeradigmPracticeManagementGetTransactionCodes(_message.Message):
    __slots__ = ()
    def __init__(self) -> None: ...

class ExecuteVeradigmPracticeManagementGetDepartments(_message.Message):
    __slots__ = ()
    def __init__(self) -> None: ...

class ExecutePDCFlowTokenizeCreditCard(_message.Message):
    __slots__ = ()
    def __init__(self) -> None: ...

class ExecutePDCFlowCCTransaction(_message.Message):
    __slots__ = ()
    def __init__(self) -> None: ...

class ExecuteAcquiredProcessPayment(_message.Message):
    __slots__ = ()
    def __init__(self) -> None: ...

class ExecuteGenericRequest(_message.Message):
    __slots__ = ()
    def __init__(self) -> None: ...

class ExecuteHealthpay24AccountsReceivable(_message.Message):
    __slots__ = ()
    def __init__(self) -> None: ...

class ExecuteFinviFacsProcessPayment(_message.Message):
    __slots__ = ()
    def __init__(self) -> None: ...

class ExecuteFinviVelosidyAccountSearch(_message.Message):
    __slots__ = ()
    def __init__(self) -> None: ...

class ExecuteFinviVelosidyOneTimeSale(_message.Message):
    __slots__ = ()
    def __init__(self) -> None: ...

class ExecuteFinviVelosidyPlanOffer(_message.Message):
    __slots__ = ()
    def __init__(self) -> None: ...

class ExecuteFinviVelosidyPlanRecurringCreate(_message.Message):
    __slots__ = ()
    def __init__(self) -> None: ...

class ExecuteFinviVelosidyPendingPayment(_message.Message):
    __slots__ = ()
    def __init__(self) -> None: ...

class ExecuteFinviVelosidyPlanOneTimeFuture(_message.Message):
    __slots__ = ()
    def __init__(self) -> None: ...

class ExecuteCloverPaymentCardSaleTransaction(_message.Message):
    __slots__ = ()
    def __init__(self) -> None: ...

class ExecuteNuveiPayment(_message.Message):
    __slots__ = ()
    def __init__(self) -> None: ...

class ExecuteCallipayCcPayment(_message.Message):
    __slots__ = ()
    def __init__(self) -> None: ...

class ExecuteCallipayCheckPayment(_message.Message):
    __slots__ = ()
    def __init__(self) -> None: ...

class ExecuteTrattaCcCharge(_message.Message):
    __slots__ = ()
    def __init__(self) -> None: ...

class ExecuteTrattaAchCharge(_message.Message):
    __slots__ = ()
    def __init__(self) -> None: ...

class ExecuteTrattaCcChargePostDated(_message.Message):
    __slots__ = ()
    def __init__(self) -> None: ...

class ExecuteTrattaAchChargePostDated(_message.Message):
    __slots__ = ()
    def __init__(self) -> None: ...

class ExecuteFortisCreateAchtoken(_message.Message):
    __slots__ = ()
    def __init__(self) -> None: ...

class ExecuteFortisCreateCctoken(_message.Message):
    __slots__ = ()
    def __init__(self) -> None: ...

class ExecuteFortisTokenAchDebitPayment(_message.Message):
    __slots__ = ()
    def __init__(self) -> None: ...

class ExecuteFortisTokenCcPayment(_message.Message):
    __slots__ = ()
    def __init__(self) -> None: ...

class ExecuteBlinkPaymentChargeCc(_message.Message):
    __slots__ = ()
    def __init__(self) -> None: ...

class ExecuteBlinkPaymentChargeAch(_message.Message):
    __slots__ = ()
    def __init__(self) -> None: ...

class ExecuteWayStarCcPayment(_message.Message):
    __slots__ = ()
    def __init__(self) -> None: ...

class ExecuteWayStarAchPayment(_message.Message):
    __slots__ = ()
    def __init__(self) -> None: ...

class ExecuteACIWorldwideCcPayment(_message.Message):
    __slots__ = ()
    def __init__(self) -> None: ...

class ExecuteACIWorldwideAchPayment(_message.Message):
    __slots__ = ()
    def __init__(self) -> None: ...
