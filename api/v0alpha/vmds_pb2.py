...
if _descriptor._USE_C_DESCRIPTORS == False:
  ...
  _VMDS.methods_by_name['GetVoicemailMetadata']._serialized_options = b'\272\270\221\002\002\030\001\202\323\344\223\002+\"&/api/v0alpha/vmds/getvoicemailmetadata:\001*'
  _VMDS.methods_by_name['GetVoicemailMessageCount']._options = None
  _VMDS.methods_by_name['GetVoicemailMessageCount']._serialized_options = b'\272\270\221\002\002\030\001\202\323\344\223\002/\"*/api/v0alpha/vmds/getvoicemailmessagecount:\001*'
  _VMDS.methods_by_name['DeleteVoicemail']._options = None
  _VMDS.methods_by_name['DeleteVoicemail']._serialized_options = b'\272\270\221\002\002\030\001\202\323\344\223\002&\"!/api/v0alpha/vmds/deletevoicemail:\001*'
  _VMDS.methods_by_name['DeleteGreeting']._options = None
  _VMDS.methods_by_name['DeleteGreeting']._serialized_options = b'\272\270\221\002\002\030\001\202\323\344\223\002%\" /api/v0alpha/vmds/deletegreeting:\001*'
  _VMDS.methods_by_name['UpdateUploadName']._options = None
  _VMDS.methods_by_name['UpdateUploadName']._serialized_options = b'\272\270\221\002\002\030\001\202\323\344\223\002\'\"\"/api/v0alpha/vmds/updateuploadname:\001*'
  _VMDS.methods_by_name['UpdateVoicemailFlagRead']._options = None
  _VMDS.methods_by_name['UpdateVoicemailFlagRead']._serialized_options = b'\272\270\221\002\002\030\001\202\323\344\223\002.\")/api/v0alpha/vmds/updatevoicemailflagread:\001*'
  _VMDS.methods_by_name['DownloadMessage']._options = None
  _VMDS.methods_by_name['DownloadMessage']._serialized_options = b'\272\270\221\002\002\030\001\202\323\344\223\002&\"!/api/v0alpha/vmds/downloadmessage:\001*'
  _VMDS.methods_by_name['DownloadSpecifiedMessages']._options = None
  _VMDS.methods_by_name['DownloadSpecifiedMessages']._serialized_options = b'\272\270\221\002\002\030\001\202\323\344\223\0020\"+/api/v0alpha/vmds/downloadspecifiedmessages:\001*'
  _VMDS.methods_by_name['DownloadMessages']._options = None
  _VMDS.methods_by_name['DownloadMessages']._serialized_options = b'\272\270\221\002\002\030\001\202\323\344\223\002\'\"\"/api/v0alpha/vmds/downloadmessages:\001*'
  _VMDS.methods_by_name['DownloadGreetingForExtension']._options = None
  _VMDS.methods_by_name['DownloadGreetingForExtension']._serialized_options = b'\272\270\221\002\002\030\001\202\323\344\223\0023\"./api/v0alpha/vmds/downloadgreetingforextension:\001*'
  _VMDS.methods_by_name['DownloadGreeting']._options = None
  _VMDS.methods_by_name['DownloadGreeting']._serialized_options = b'\272\270\221\002\002\030\001\202\323\344\223\002\'\"\"/api/v0alpha/vmds/downloadgreeting:\001*'
  _VMDS.methods_by_name['GetUploadGreetingUrl']._options = None
  _VMDS.methods_by_name['GetUploadGreetingUrl']._serialized_options = b'\272\270\221\002\002\030\001\202\323\344\223\002+\"&/api/v0alpha/vmds/getuploadgreetingurl:\001*'
  _VMDS.methods_by_name['ProcessGreetingUpload']._options = None
  _VMDS.methods_by_name['ProcessGreetingUpload']._serialized_options = b'\272\270\221\002\002\030\001\202\323\344\223\002,\"\'/api/v0alpha/vmds/processgreetingupload:\001*'
  _VMDS.methods_by_name['UpdateGreetingForExtension']._options = None
  _VMDS.methods_by_name['UpdateGreetingForExtension']._serialized_options = b'\272\270\221\002\002\030\001\202\323\344\223\0021\",/api/v0alpha/vmds/updategreetingforextension:\001*'
  _VMDS.methods_by_name['ListAvailableGreetings']._options = None
  _VMDS.methods_by_name['ListAvailableGreetings']._serialized_options = b'\272\270\221\002\002\030\001\202\323\344\223\002-\"(/api/v0alpha/vmds/listavailablegreetings:\001*'
  ...
  _globals['_DOWNLOADSPECIFIEDMESSAGESREQ']._serialized_start=1456
  _globals['_DOWNLOADSPECIFIEDMESSAGESREQ']._serialized_end=1702
  _globals['_DOWNLOADSPECIFIEDMESSAGESREQ_MESSAGEREQ']._serialized_start=1571
  _globals['_DOWNLOADSPECIFIEDMESSAGESREQ_MESSAGEREQ']._serialized_end=1702
  _globals['_DOWNLOADSPECIFIEDMESSAGESRES']._serialized_start=1704
  _globals['_DOWNLOADSPECIFIEDMESSAGESRES']._serialized_end=1752
  _globals['_GETUPLOADGREETINGURLREQ']._serialized_start=1754
  _globals['_GETUPLOADGREETINGURLREQ']._serialized_end=1844
  _globals['_GETUPLOADGREETINGURLRES']._serialized_start=1846
  _globals['_GETUPLOADGREETINGURLRES']._serialized_end=1889
  _globals['_DOWNLOADMESSAGESREQ']._serialized_start=1891
  _globals['_DOWNLOADMESSAGESREQ']._serialized_end=1978
  _globals['_DOWNLOADMESSAGESRES']._serialized_start=1980
  _globals['_DOWNLOADMESSAGESRES']._serialized_end=2019
  _globals['_DOWNLOADGREETINGFOREXTENSIONREQ']._serialized_start=2021
  _globals['_DOWNLOADGREETINGFOREXTENSIONREQ']._serialized_end=2081
  _globals['_DOWNLOADGREETINGFOREXTENSIONRES']._serialized_start=2083
  _globals['_DOWNLOADGREETINGFOREXTENSIONRES']._serialized_end=2134
  _globals['_DOWNLOADGREETINGREQ']._serialized_start=2136
  _globals['_DOWNLOADGREETINGREQ']._serialized_end=2185
  _globals['_DOWNLOADGREETINGRES']._serialized_start=2187
  _globals['_DOWNLOADGREETINGRES']._serialized_end=2226
  _globals['_PROCESSGREETINGUPLOADREQ']._serialized_start=2228
  _globals['_PROCESSGREETINGUPLOADREQ']._serialized_end=2319
  _globals['_PROCESSGREETINGUPLOADRES']._serialized_start=2321
  _globals['_PROCESSGREETINGUPLOADRES']._serialized_end=2347
  _globals['_UPDATEGREETINGFOREXTENSIONREQ']._serialized_start=2349
  _globals['_UPDATEGREETINGFOREXTENSIONREQ']._serialized_end=2445
  _globals['_UPDATEGREETINGFOREXTENSIONRES']._serialized_start=2447
  _globals['_UPDATEGREETINGFOREXTENSIONRES']._serialized_end=2478
  _globals['_LISTAVAILABLEGREETINGSREQ']._serialized_start=2480
  _globals['_LISTAVAILABLEGREETINGSREQ']._serialized_end=2507
  _globals['_LISTAVAILABLEGREETINGSRES']._serialized_start=2510
  _globals['_LISTAVAILABLEGREETINGSRES']._serialized_end=2676
  _globals['_LISTAVAILABLEGREETINGSRES_FILEINFO']._serialized_start=2618
  _globals['_LISTAVAILABLEGREETINGSRES_FILEINFO']._serialized_end=2676
  _globals['_VMDS']._serialized_start=2679
  _globals['_VMDS']._serialized_end=5062
