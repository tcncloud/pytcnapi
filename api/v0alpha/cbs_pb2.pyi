...
class UpdateScheduledCallbackToReadyReq(_message.Message):
    ...
    is_auto_return: bool
    service_id: str
    def __init__(self, scheduled_callback_id: _Optional[str] = ..., is_auto_return: _Optional[bool] = ..., service_id: _Optional[str] = ...) -> None: ...
...
class UpdateScheduledCallbackReq(_message.Message):
    ...
    callback_details: _containers.RepeatedCompositeFieldContainer[ScheduledCallbackDetail]
    name: str
    def __init__(self, scheduled_callback_id: _Optional[str] = ..., new_status: _Optional[_Union[_cbs_pb2.ScheduledCallbackStatus, str]] = ..., start_time: _Optional[_Union[datetime.datetime, _timestamp_pb2.Timestamp, _Mapping]] = ..., end_time: _Optional[_Union[datetime.datetime, _timestamp_pb2.Timestamp, _Mapping]] = ..., phone_number: _Optional[str] = ..., caller_id: _Optional[str] = ..., skills: _Optional[_Iterable[str]] = ..., last_updated_by: _Optional[str] = ..., notes: _Optional[str] = ..., callback_details: _Optional[_Iterable[_Union[ScheduledCallbackDetail, _Mapping]]] = ..., name: _Optional[str] = ...) -> None: ...
