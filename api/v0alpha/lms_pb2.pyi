...
class ListMetrics(_message.Message):
    __slots__ = ["input_record_count", "output_record_count", "field_names", "field_types", "field_counts", "run_type", "success_message", "max_record_width", "min_record_width", "max_record_index", "min_record_index", "files", "groups", "missing_fields", "seconds_to_start", "seconds_to_process"]
