...
class HuntGroup(_message.Message):
    ...
    def __init__(self, hunt_group_sid: _Optional[int] = ..., client_sid: _Optional[int] = ..., name: _Optional[str] = ..., description: _Optional[_Union[_wrappers_pb2.StringValue, _Mapping]] = ..., modify_date: _Optional[_Union[datetime.datetime, _timestamp_pb2.Timestamp, _Mapping]] = ..., type: _Optional[_Union[_acd_pb2.HuntGroupType.Enum, str]] = ..., agent_count: _Optional[int] = ..., hunt_group_skill_agent_count: _Optional[int] = ...) -> None: ...
...
class Agent(_message.Message):
    ...
    def __init__(self, agent_sid: _Optional[int] = ..., client_sid: _Optional[int] = ..., agent_profile_sid: _Optional[int] = ..., web_login: _Optional[str] = ..., agent_id: _Optional[_Union[_wrappers_pb2.Int64Value, _Mapping]] = ..., agent_pin: _Optional[_Union[_wrappers_pb2.Int64Value, _Mapping]] = ..., add_date: _Optional[_Union[datetime.datetime, _timestamp_pb2.Timestamp, _Mapping]] = ..., modify_date: _Optional[_Union[datetime.datetime, _timestamp_pb2.Timestamp, _Mapping]] = ..., callback_number: _Optional[_Union[_wrappers_pb2.StringValue, _Mapping]] = ..., callback_extension: _Optional[_Union[_wrappers_pb2.StringValue, _Mapping]] = ..., hunt_group_sid: _Optional[_Union[_wrappers_pb2.Int64Value, _Mapping]] = ..., subscriber_username: _Optional[_Union[_wrappers_pb2.StringValue, _Mapping]] = ..., partner_agent_id: _Optional[_Union[_wrappers_pb2.StringValue, _Mapping]] = ..., last_password_change_date: _Optional[_Union[datetime.datetime, _timestamp_pb2.Timestamp, _Mapping]] = ...) -> None: ...
...
class GetClientInfoDisplayTemplateRes(_message.Message):
    ...
    def __init__(self, display_all_fields: _Optional[bool] = ..., dialed_number_settings: _Optional[_Union[_p3api_pb2.DialedNumberFieldSettings, _Mapping]] = ..., rows: _Optional[_Iterable[_Union[_p3api_pb2.ClientInfoDisplayTemplateRow, _Mapping]]] = ...) -> None: ...
...
class StatisticsData(_message.Message):
    ...
    agent_sid: int
    hunt_group_sid: int
    def __init__(self, agent_session_count: _Optional[_Union[_wrappers_pb2.Int64Value, _Mapping]] = ..., ivr_duration: _Optional[_Union[_wrappers_pb2.Int64Value, _Mapping]] = ..., agent_wait_duration: _Optional[_Union[_wrappers_pb2.Int64Value, _Mapping]] = ..., call_wait_duration: _Optional[_Union[_wrappers_pb2.Int64Value, _Mapping]] = ..., hold_duration: _Optional[_Union[_wrappers_pb2.Int64Value, _Mapping]] = ..., manual_duration: _Optional[_Union[_wrappers_pb2.Int64Value, _Mapping]] = ..., pause_duration: _Optional[_Union[_wrappers_pb2.Int64Value, _Mapping]] = ..., preview_duration: _Optional[_Union[_wrappers_pb2.Int64Value, _Mapping]] = ..., suspended_duration: _Optional[_Union[_wrappers_pb2.Int64Value, _Mapping]] = ..., talk_duration: _Optional[_Union[_wrappers_pb2.Int64Value, _Mapping]] = ..., transfer_duration: _Optional[_Union[_wrappers_pb2.Int64Value, _Mapping]] = ..., wrap_up_duration: _Optional[_Union[_wrappers_pb2.Int64Value, _Mapping]] = ..., agent_name: _Optional[str] = ..., hunt_group_name: _Optional[str] = ..., call_count: _Optional[int] = ..., web_login_time: _Optional[_Union[datetime.datetime, _timestamp_pb2.Timestamp, _Mapping]] = ..., agent_sid: _Optional[int] = ..., hunt_group_sid: _Optional[int] = ...) -> None: ...
...
class PhoneBook(_message.Message):
    ...
    def __init__(self, entry_type: _Optional[str] = ..., entry_name: _Optional[str] = ..., hunt_group_sid: _Optional[_Union[_wrappers_pb2.Int64Value, _Mapping]] = ..., phone_number: _Optional[str] = ..., phone_number_type: _Optional[_Union[_wrappers_pb2.StringValue, _Mapping]] = ..., phone_number_hidden: _Optional[bool] = ...) -> None: ...
...
class PhoneBookEntry(_message.Message):
    ...
    phone_number_hidden: bool
    def __init__(self, phone_book_sid: _Optional[int] = ..., entry_name: _Optional[str] = ..., standard: _Optional[_Union[PhoneBookStandardNumber, _Mapping]] = ..., sip_uri: _Optional[_Union[PhoneBookSIPURI, _Mapping]] = ..., phone_number_hidden: _Optional[bool] = ...) -> None: ...
...
class PhoneBookStandardNumber(_message.Message):
    ...
    white_list: bool
    def __init__(self, phone_number: _Optional[str] = ..., phone_number_types: _Optional[_Iterable[_Union[_p3api_pb2.PhoneBookPhoneNumberType, str]]] = ..., white_list: _Optional[bool] = ...) -> None: ...
...
class CreatePhoneBookEntryReq(_message.Message):
    ...
    sip_uri: PhoneBookSIPURI
    phone_number_hidden: bool
    def __init__(self, hunt_group_sid: _Optional[int] = ..., entry_name: _Optional[str] = ..., standard: _Optional[_Union[PhoneBookStandardNumber, _Mapping]] = ..., sip_uri: _Optional[_Union[PhoneBookSIPURI, _Mapping]] = ..., phone_number_hidden: _Optional[bool] = ...) -> None: ...
...
class UpdatePhoneBookEntryReq(_message.Message):
    ...
    sip_uri: PhoneBookSIPURI
    phone_number_hidden: bool
    def __init__(self, phone_book_sid: _Optional[int] = ..., hunt_group_sid: _Optional[int] = ..., entry_name: _Optional[str] = ..., standard: _Optional[_Union[PhoneBookStandardNumber, _Mapping]] = ..., sip_uri: _Optional[_Union[PhoneBookSIPURI, _Mapping]] = ..., phone_number_hidden: _Optional[bool] = ...) -> None: ...
...
class PBXExtension(_message.Message):
    ...
    email_addresses: str
    agent_access: bool
    def __init__(self, pbx_extension_sid: _Optional[int] = ..., pbx_extension: _Optional[str] = ..., join_sid: _Optional[int] = ..., join_type: _Optional[str] = ..., email_subject: _Optional[str] = ..., email_body: _Optional[str] = ..., email_addresses: _Optional[str] = ..., agent_access: _Optional[bool] = ...) -> None: ...
...
class ListPBXExtensionsRes(_message.Message):
    ...
    class AgentExtension(_message.Message):
        ...
        agent_name: str
        has_greeting: bool
        def __init__(self, pbx_extension: _Optional[str] = ..., greeting_location: _Optional[str] = ..., email: _Optional[_Union[EmailResponse, _Mapping]] = ..., agent_name: _Optional[str] = ..., has_greeting: _Optional[bool] = ...) -> None: ...
    class HuntGroupExtension(_message.Message):
        ...
        hunt_group_name: str
        has_greeting: bool
        def __init__(self, pbx_extension: _Optional[str] = ..., greeting_location: _Optional[str] = ..., email: _Optional[_Union[EmailResponse, _Mapping]] = ..., hunt_group_name: _Optional[str] = ..., has_greeting: _Optional[bool] = ...) -> None: ...
...
class DNCL(_message.Message):
    ...
    def __init__(self, country_sid: _Optional[_Union[_wrappers_pb2.Int64Value, _Mapping]] = ..., dncl_notes: _Optional[_Union[_wrappers_pb2.StringValue, _Mapping]] = ..., dncl_number: _Optional[_Union[_wrappers_pb2.StringValue, _Mapping]] = ..., expiration_date: _Optional[_Union[datetime.datetime, _timestamp_pb2.Timestamp, _Mapping]] = ...) -> None: ...
...
class HuntGroupAgentSettings(_message.Message):
    ...
    DISPLAY_INTEGRATION_DATA_MAP_FIELD_NUMBER: _ClassVar[int]
    LIMIT_INTEGRATION_DATA_MAP_FIELD_NUMBER: _ClassVar[int]
    keypad_enabled: bool
    ...
    display_integration_data_map: bool
    limit_integration_data_map: _containers.RepeatedScalarFieldContainer[str]
    def __init__(self, keypad_enabled: _Optional[bool] = ..., keypad_delimiter: _Optional[str] = ..., statistics: _Optional[_Union[AgentStatisticsSettings, _Mapping]] = ..., end_call_confirmation: _Optional[bool] = ..., pause: _Optional[_Union[PauseSettings, _Mapping]] = ..., hqm: _Optional[_Union[HoldQueueMonitorSettings, _Mapping]] = ..., manual_dial: _Optional[_Union[ManualDialSettings, _Mapping]] = ..., transfer: _Optional[_Union[TransferSettings, _Mapping]] = ..., preview_dial: _Optional[_Union[PreviewDialSettings, _Mapping]] = ..., phone_number_activity: _Optional[_Union[PhoneNumberActivitySettings, _Mapping]] = ..., dncl: _Optional[_Union[DnclSettings, _Mapping]] = ..., hold: _Optional[_Union[AgentHoldSettings, _Mapping]] = ..., manual_approval: _Optional[_Union[ManualApprovalSettings, _Mapping]] = ..., display_linkback_huntgroup: _Optional[bool] = ..., schedule_callback: _Optional[_Union[ScheduleCallBackSettings, _Mapping]] = ..., recording: _Optional[_Union[RecordingSettings, _Mapping]] = ..., display_phone_zip_metadata: _Optional[bool] = ..., phone_zip_metadata_keys: _Optional[_Iterable[str]] = ..., display_machine_deliver: _Optional[bool] = ..., allow_agent_intercom: _Optional[bool] = ..., display_data_settings: _Optional[_Union[DisplayDataSettings, _Mapping]] = ..., allow_change_hunt_group: _Optional[bool] = ..., agent_screen_recording: _Optional[bool] = ..., inbound_compliance_metadata: _Optional[_Iterable[_Union[ComplianceMetadata, _Mapping]]] = ..., notify_queued_calls: _Optional[bool] = ..., display_journey_retrieved_data: _Optional[bool] = ..., limit_journey_retrieved_data: _Optional[_Iterable[str]] = ..., initial_agent_status: _Optional[int] = ..., display_web_links: _Optional[bool] = ..., display_skills: _Optional[bool] = ..., interrupt_peering: _Optional[_Iterable[_Union[_p3api_pb2.InterruptedPeeringStatus, str]]] = ..., display_integration_data_map: _Optional[bool] = ..., limit_integration_data_map: _Optional[_Iterable[str]] = ...) -> None: ...
...
class AgentStatisticsSettings(_message.Message):
    ...
    def __init__(self, show_statistics: _Optional[bool] = ..., show_call_history: _Optional[bool] = ..., filter_call_history: _Optional[_Union[AgentStatisticsSettings.HistoryFilter, str]] = ...) -> None: ...
...
class PauseSettings(_message.Message):
    ...
    def __init__(self, allow_agent_pause: _Optional[bool] = ..., allow_agent_pause_reset: _Optional[bool] = ..., use_agent_pause_codes: _Optional[bool] = ..., default_agent_pause_code: _Optional[str] = ..., recording_pause_confirmation: _Optional[bool] = ...) -> None: ...
...
class PhoneNumberActivitySettings(_message.Message):
    ...
    def __init__(self, allow_phone_number_activity: _Optional[bool] = ..., allow_export_phone_number_activity: _Optional[bool] = ..., allow_pna_recordings_download: _Optional[bool] = ..., allow_pna_edit_responses: _Optional[bool] = ...) -> None: ...
...
class PreviewDialSettings(_message.Message):
    ...
    def __init__(self, require_confirmation: _Optional[bool] = ..., timeout_minutes: _Optional[int] = ..., allow_cancel: _Optional[bool] = ..., pause_on_cancel: _Optional[bool] = ...) -> None: ...
...
class HoldQueueMonitorSettings(_message.Message):
    ...
    def __init__(self, monitor: _Optional[bool] = ..., required_group: _Optional[int] = ..., preferred_group: _Optional[int] = ..., agent_routing: _Optional[_Union[HoldQueueMonitoringAgentRouting.Enum, str]] = ...) -> None: ...
...
class ComplianceMetadata(_message.Message):
    ...
    name: str
    required: bool
    def __init__(self, name: _Optional[str] = ..., required: _Optional[bool] = ...) -> None: ...
...
class ManualDialSettings(_message.Message):
    ...
    def __init__(self, enabled: _Optional[bool] = ..., show_outbound_phone_book: _Optional[bool] = ..., show_caller_id_phone_book: _Optional[bool] = ..., has_custom_caller_id: _Optional[bool] = ..., default_caller_id: _Optional[str] = ..., default_country_sid: _Optional[int] = ..., show_country_selector: _Optional[bool] = ..., timezone_restrictions: _Optional[bool] = ..., scrub_cell_phones: _Optional[bool] = ..., call_recording: _Optional[bool] = ..., agent_override_cell: _Optional[bool] = ..., agent_override_ccr: _Optional[bool] = ..., agent_override_dncl: _Optional[bool] = ..., agent_override_timezone: _Optional[bool] = ..., use_white_list: _Optional[bool] = ..., use_random_caller_id: _Optional[bool] = ..., random_caller_id_bucket: _Optional[int] = ..., default_caller_id_country_sid: _Optional[int] = ..., display_caller_id_country_select: _Optional[bool] = ..., use_caller_id_bucket: _Optional[bool] = ..., agent_override_natural_compliance: _Optional[bool] = ..., natural_compliance_rule_set_name: _Optional[str] = ..., compliance_metadata: _Optional[_Iterable[_Union[ComplianceMetadata, _Mapping]]] = ..., enable_metadata: _Optional[bool] = ..., use_timezone_validation_zip: _Optional[_Union[ManualDialSettings.ZipCodeValidation, str]] = ..., enable_reject_option_for_approvers: _Optional[bool] = ..., enable_sip_address: _Optional[bool] = ..., mask_manual_dial_caller_id: _Optional[bool] = ..., enable_manual_dial_data_dip: _Optional[str] = ..., manual_dial_data_dip_config: _Optional[int] = ..., manual_dial_data_dip_result_handling: _Optional[_Union[ManualDialDataDipHandling.Enum, str]] = ..., data_dip_manual_dial_integration: _Optional[_Mapping[str, str]] = ..., data_dip_manual_dial_integration_handling: _Optional[_Union[ManualDialDataDipHandling.Enum, str]] = ...) -> None: ...
...
class DnclSettings(_message.Message):
    ...
    def __init__(self, allow_dncl_add: _Optional[bool] = ..., manual_dial_auto_dncl_add: _Optional[bool] = ..., preview_dial_auto_dncl_add: _Optional[bool] = ..., agent_responses_auto_dncl_add: _Optional[bool] = ..., default_manual_dncl_expire_hours: _Optional[int] = ..., default_preview_dncl_expire_hours: _Optional[int] = ..., default_dncl_country: _Optional[int] = ..., default_outbound_dncl_expire_hours: _Optional[int] = ..., default_inbound_dncl_expire_hours: _Optional[int] = ..., hunt_group_compliance_scrub_lists: _Optional[_Iterable[str]] = ..., scrub_lists_auto_add_options: _Optional[_Iterable[_Union[ScrubListsAutoAdd, _Mapping]]] = ..., display_dncl_options_in_wrapup: _Optional[bool] = ..., allow_dncl_remove: _Optional[bool] = ..., hunt_group_compliance_scrub_lists_removal_allowed: _Optional[_Iterable[str]] = ..., scrub_lists_expiration_limits: _Optional[_Union[ScrubListsExpirationLimits, _Mapping]] = ...) -> None: ...
...
class TransferSettings(_message.Message):
    ...
    compliance_metadata: _containers.RepeatedCompositeFieldContainer[ComplianceMetadata]
    call_whitelist: bool
    def __init__(self, allowed: _Optional[bool] = ..., show_filtering: _Optional[bool] = ..., requeue_type: _Optional[_Union[RequeueTransferQueueConfigType.Enum, str]] = ..., type: _Optional[_Iterable[_Union[TransferSettingsType.Enum, str]]] = ..., default_country_sid: _Optional[int] = ..., show_country_selector: _Optional[bool] = ..., has_custom_transfer_number: _Optional[bool] = ..., default_transfer_number: _Optional[str] = ..., has_custom_caller_id: _Optional[bool] = ..., default_caller_id: _Optional[str] = ..., show_transfers_phone_book: _Optional[bool] = ..., show_caller_id_phone_book: _Optional[bool] = ..., hand_off_type: _Optional[_Iterable[_Union[TransferSettingsHandOffType.Enum, str]]] = ..., recording_status: _Optional[_Union[RecordingStatus.Enum, str]] = ..., default_caller_id_country_sid: _Optional[int] = ..., show_caller_id_country_selector: _Optional[bool] = ..., start_record_transfer_targets: _Optional[_Iterable[str]] = ..., stop_record_transfer_targets: _Optional[_Iterable[str]] = ..., default_filtering_include_all_online_agents: _Optional[bool] = ..., requeue_type_custom_value: _Optional[str] = ..., agent_transfer_hunt_group_filter: _Optional[bool] = ..., agent_transfer_recording_status: _Optional[_Union[RecordingStatus.Enum, str]] = ..., requeue_transfer_recording_status: _Optional[_Union[RecordingStatus.Enum, str]] = ..., open_transfer_recording_status: _Optional[_Union[RecordingStatus.Enum, str]] = ..., natural_compliance_override: _Optional[bool] = ..., transfer_natural_compliance_rule_set_name: _Optional[str] = ..., compliance_metadata: _Optional[_Iterable[_Union[ComplianceMetadata, _Mapping]]] = ..., call_whitelist: _Optional[bool] = ...) -> None: ...
...
class RecordingSettings(_message.Message):
    ...
    def __init__(self, display_indicator: _Optional[bool] = ..., enable_pause: _Optional[bool] = ..., enable_delay: _Optional[bool] = ..., delay: _Optional[int] = ..., pause_recording_on_hold: _Optional[bool] = ...) -> None: ...
...
class DisplayDataSettings(_message.Message):
    ...
    def __init__(self, display_data_dip: _Optional[_Union[DisplayDataSettings.DisplayDataDip, str]] = ..., display_data_dip_keys: _Optional[_Iterable[str]] = ..., display_data_collect: _Optional[bool] = ..., display_ivr_navigation: _Optional[bool] = ..., display_sip_header_data: _Optional[bool] = ...) -> None: ...
...
class AgentHoldSettings(_message.Message):
    ...
    def __init__(self, allowed: _Optional[_Union[AllowedHoldType.Enum, str]] = ..., auto_pause_on_multi_hold: _Optional[bool] = ...) -> None: ...
...
class ManualApprovalSettings(_message.Message):
    ...
    def __init__(self, allowed: _Optional[bool] = ..., confirm: _Optional[bool] = ..., sms_allowed: _Optional[bool] = ..., sms_number_confirmation: _Optional[bool] = ..., disable_reject_option_for_approvers: _Optional[bool] = ...) -> None: ...
...
class ListHuntGroupWebLinksReq(_message.Message):
    ...
    task_sid: int
    def __init__(self, hunt_group_sid: _Optional[int] = ..., call_sid: _Optional[int] = ..., call_type: _Optional[_Union[_acd_pb2.CallType.Enum, str]] = ..., service_id: _Optional[str] = ..., scheduled_callback_id: _Optional[str] = ..., session_sid: _Optional[int] = ..., isInitialPreview: _Optional[bool] = ..., task_sid: _Optional[int] = ...) -> None: ...
...
class WebLink(_message.Message):
    ...
    def __init__(self, display_name: _Optional[str] = ..., description: _Optional[str] = ..., link_url: _Optional[str] = ..., is_js_link: _Optional[bool] = ..., tooltip_missing_fields: _Optional[_Iterable[str]] = ..., hunt_group_parameter_sid: _Optional[int] = ...) -> None: ...
...
class GetCampaignCompletionStatusRes(_message.Message):
    ...
    total_tasks: int
    total_tasks_completed: int
    def __init__(self, broadcasts_exist: _Optional[bool] = ..., percent_complete: _Optional[int] = ..., completion_status: _Optional[_Mapping[int, GetCampaignCompletionStatusRes.TaskGroupCompletionStatus]] = ..., total_tasks: _Optional[int] = ..., total_tasks_completed: _Optional[int] = ...) -> None: ...
...
class AgentCallLog(_message.Message):
    ...
    def __init__(self, agent_call_log_sid: _Optional[int] = ..., call_sid: _Optional[_Union[_wrappers_pb2.Int64Value, _Mapping]] = ..., call_type: _Optional[_Union[_acd_pb2.CallType.Enum, str]] = ..., action_date: _Optional[_Union[datetime.datetime, _timestamp_pb2.Timestamp, _Mapping]] = ..., action_key: _Optional[_Union[_wrappers_pb2.StringValue, _Mapping]] = ..., action_value: _Optional[_Union[_wrappers_pb2.StringValue, _Mapping]] = ...) -> None: ...
...
class ListWhiteListPhoneBooksReq(_message.Message):
    ...
    def __init__(self, hunt_group_sid: _Optional[int] = ..., include_null_phone_number_types: _Optional[bool] = ..., order_bys: _Optional[_Iterable[_Union[_p3api_pb2.ListPhoneBookOrderBy.Enum, str]]] = ...) -> None: ...
...
class CancelPreviewDialCallReq(_message.Message):
    ...
    def __init__(self, call: _Optional[_Union[_call_pb2.SimpleCallData, _Mapping]] = ..., agent_session_sid: _Optional[int] = ..., report_scrub_override: _Optional[bool] = ...) -> None: ...
...
class DownloadCallRecordingsReq(_message.Message):
    ...
    start_date: _timestamp_pb2.Timestamp
    def __init__(self, call_params: _Optional[_Iterable[_Union[DownloadCallRecordingsReq.CallParams, _Mapping]]] = ..., html_file_name: _Optional[str] = ..., html_file_content: _Optional[str] = ..., group_sid: _Optional[_Union[_wrappers_pb2.Int64Value, _Mapping]] = ..., start_date: _Optional[_Union[datetime.datetime, _timestamp_pb2.Timestamp, _Mapping]] = ...) -> None: ...
...
class ScheduleCallBackSettings(_message.Message):
    ...
    def __init__(self, allow_callback_scheduling: _Optional[bool] = ..., allow_scheduled_callback_calling: _Optional[bool] = ..., allow_automatic_callback_retrieval_mode: _Optional[bool] = ..., allow_default_callback_routing: _Optional[bool] = ..., callbacks_retrieval_mode_settings: _Optional[str] = ..., default_callback_routing_settings: _Optional[str] = ..., callbacks_service_id: _Optional[str] = ..., has_custom_caller_id: _Optional[bool] = ..., default_caller_id: _Optional[str] = ..., allow_scheduled_callback_calendar: _Optional[bool] = ...) -> None: ...
...
class UpdateAgentAssignedHuntGroupReq(_message.Message):
    ...
    skills: _containers.ScalarMap[str, int]
    replace_skills: bool
    def __init__(self, hunt_group_sid: _Optional[int] = ..., skills: _Optional[_Mapping[str, int]] = ..., replace_skills: _Optional[bool] = ...) -> None: ...
...
class GetOrgAgentSettingsRes(_message.Message):
    ...
    def __init__(self, default_time_zone: _Optional[str] = ..., default_softphone_volume_in: _Optional[int] = ..., default_softphone_volume_out: _Optional[int] = ..., linkback_recording: _Optional[bool] = ...) -> None: ...
...
class ContactFieldDataRow(_message.Message):
    ...
    field_value: str
    is_phone: bool
    def __init__(self, field_label: _Optional[str] = ..., field_value: _Optional[str] = ..., is_phone: _Optional[bool] = ...) -> None: ...
...
class HuntGroupScript(_message.Message):
    ...
    def __init__(self, name: _Optional[str] = ..., description: _Optional[str] = ..., auto_script_progression: _Optional[bool] = ..., script_category: _Optional[str] = ..., act: _Optional[_Iterable[_Union[Act, _Mapping]]] = ...) -> None: ...
...
class Disposition(_message.Message):
    ...
    def __init__(self, required: _Optional[bool] = ..., order: _Optional[int] = ..., type: _Optional[str] = ..., header: _Optional[str] = ..., prompt: _Optional[str] = ..., defaultValue: _Optional[str] = ..., response_options: _Optional[_Iterable[str]] = ..., bypass_auto_script_progression: _Optional[bool] = ...) -> None: ...
...
class ContactFieldDescription(_message.Message):
    ...
    def __init__(self, contact_field_description_sid: _Optional[int] = ..., field_name: _Optional[str] = ..., is_phone: _Optional[bool] = ..., display_format_string: _Optional[_Union[_wrappers_pb2.StringValue, _Mapping]] = ...) -> None: ...
...
class ContactGroup(_message.Message):
    ...
    def __init__(self, contact_group_sid: _Optional[int] = ..., name: _Optional[_Union[_wrappers_pb2.StringValue, _Mapping]] = ..., country_sid: _Optional[int] = ..., last_updated: _Optional[_Union[datetime.datetime, _timestamp_pb2.Timestamp, _Mapping]] = ..., sha_digest: _Optional[_Union[_wrappers_pb2.StringValue, _Mapping]] = ...) -> None: ...
...
class CreateContactFieldDescriptionReq(_message.Message):
    ...
    is_phone: bool
    display_format_string: _wrappers_pb2.StringValue
    def __init__(self, field_name: _Optional[str] = ..., is_phone: _Optional[bool] = ..., display_format_string: _Optional[_Union[_wrappers_pb2.StringValue, _Mapping]] = ...) -> None: ...
...
class ListOutboundBroadcastTemplateDataRes(_message.Message):
    ...
    class Data(_message.Message):
        ...
        modify_date: _timestamp_pb2.Timestamp
        def __init__(self, template_number: _Optional[int] = ..., template_name: _Optional[str] = ..., template_type: _Optional[_Union[_broadcasts_pb2.TemplateType.Enum, str]] = ..., modify_date: _Optional[_Union[datetime.datetime, _timestamp_pb2.Timestamp, _Mapping]] = ...) -> None: ...
...
class Extension(_message.Message):
    ...
    class Agent(_message.Message):
        ...
        user_id: str
        archived: bool
        def __init__(self, first_name: _Optional[str] = ..., last_name: _Optional[str] = ..., user_id: _Optional[str] = ..., archived: _Optional[bool] = ...) -> None: ...
    class HuntGroup(_message.Message):
        ...
        hunt_group_name: str
        archived: bool
        def __init__(self, hunt_group_sid: _Optional[int] = ..., hunt_group_name: _Optional[str] = ..., archived: _Optional[bool] = ...) -> None: ...
    class Email(_message.Message):
        ...
        addresses: _containers.RepeatedScalarFieldContainer[str]
        attach_vm: bool
        def __init__(self, subject: _Optional[str] = ..., body: _Optional[str] = ..., addresses: _Optional[_Iterable[str]] = ..., attach_vm: _Optional[bool] = ...) -> None: ...
    PBX_EXTENSION_SID_FIELD_NUMBER: _ClassVar[int]
    ...
    total_messages: int
    def __init__(self, pbx_extension_sid: _Optional[int] = ..., extension_number: _Optional[str] = ..., agent: _Optional[_Union[Extension.Agent, _Mapping]] = ..., hunt_group: _Optional[_Union[Extension.HuntGroup, _Mapping]] = ..., agent_access: _Optional[bool] = ..., email: _Optional[_Union[Extension.Email, _Mapping]] = ..., greeting: _Optional[str] = ..., has_greeting: _Optional[bool] = ..., unheard_messages: _Optional[int] = ..., total_messages: _Optional[int] = ...) -> None: ...
