...
class ManualDialStartReq(_message.Message):
    __slots__ = ("simple_call_data", "hunt_group_sid", "agent_session_sid", "bucketId", "bucketRegionData")
    SIMPLE_CALL_DATA_FIELD_NUMBER: _ClassVar[int]
    HUNT_GROUP_SID_FIELD_NUMBER: _ClassVar[int]
    AGENT_SESSION_SID_FIELD_NUMBER: _ClassVar[int]
    BUCKETID_FIELD_NUMBER: _ClassVar[int]
    BUCKETREGIONDATA_FIELD_NUMBER: _ClassVar[int]
    simple_call_data: _call_pb2.SimpleCallData
    hunt_group_sid: int
    agent_session_sid: int
    bucketId: int
    bucketRegionData: str
    def __init__(self, simple_call_data: _Optional[_Union[_call_pb2.SimpleCallData, _Mapping]] = ..., hunt_group_sid: _Optional[int] = ..., agent_session_sid: _Optional[int] = ..., bucketId: _Optional[int] = ..., bucketRegionData: _Optional[str] = ...) -> None: ...
