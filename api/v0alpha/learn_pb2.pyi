...
class ExistRes(_message.Message):
    ...
    exist: bool
    def __init__(self, exist: _Optional[bool] = ...) -> None: ...
...
class ContentRes(_message.Message):
    ...
    def __init__(self, content: _Optional[str] = ..., last_edited_timestamp: _Optional[_Union[datetime.datetime, _timestamp_pb2.Timestamp, _Mapping]] = ..., images: _Optional[_Iterable[_Union[LearnImage, _Mapping]]] = ..., title: _Optional[str] = ..., total_view_count: _Optional[int] = ..., last_edited_user: _Optional[str] = ...) -> None: ...
...
class LearnStandaloneDetails(_message.Message):
    ...
    last_edited_timestamp: _timestamp_pb2.Timestamp
    title: str
    def __init__(self, name: _Optional[str] = ..., content: _Optional[str] = ..., last_edited_timestamp: _Optional[_Union[datetime.datetime, _timestamp_pb2.Timestamp, _Mapping]] = ..., title: _Optional[str] = ...) -> None: ...
...
class VersionDetails(_message.Message):
    ...
    status: str
    def __init__(self, version: _Optional[str] = ..., version_name: _Optional[str] = ..., date_created: _Optional[_Union[datetime.datetime, _timestamp_pb2.Timestamp, _Mapping]] = ..., date_published: _Optional[_Union[datetime.datetime, _timestamp_pb2.Timestamp, _Mapping]] = ..., status: _Optional[str] = ...) -> None: ...
