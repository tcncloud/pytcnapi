...
if _descriptor._USE_C_DESCRIPTORS == False:
  ...
  _ASM.methods_by_name['StreamAgentState']._serialized_options = b'\272\270\221\002\005\n\003\010\254\002\202\323\344\223\002+\"&/api/v1alpha1/asm/asm/streamagentstate:\001*'
  _ASM.methods_by_name['ManagerStreamAgentState']._options = None
  _ASM.methods_by_name['ManagerStreamAgentState']._serialized_options = b'\272\270\221\002\005\n\003\010\220\003\202\323\344\223\0022\"-/api/v1alpha1/asm/asm/managerstreamagentstate:\001*'
  _ASM.methods_by_name['PushEvents']._options = None
  _ASM.methods_by_name['PushEvents']._serialized_options = b'\272\270\221\002\005\n\003\010\254\002\202\323\344\223\002%\" /api/v1alpha1/asm/asm/pushevents:\001*'
  _ASM.methods_by_name['CreateSession']._options = None
  _ASM.methods_by_name['CreateSession']._serialized_options = b'\272\270\221\002\002\030\001\202\323\344\223\002(\"#/api/v1alpha1/asm/asm/createsession:\001*'
  _ASM.methods_by_name['EndSession']._options = None
  _ASM.methods_by_name['EndSession']._serialized_options = b'\272\270\221\002\002\030\001\202\323\344\223\002%\" /api/v1alpha1/asm/asm/endsession:\001*'
  _ASM.methods_by_name['GetCurrentSession']._options = None
  _ASM.methods_by_name['GetCurrentSession']._serialized_options = b'\272\270\221\002\002\030\001\202\323\344\223\002,\"\'/api/v1alpha1/asm/asm/getcurrentsession:\001*'
  _ASM.methods_by_name['EnableVoice']._options = None
  _ASM.methods_by_name['EnableVoice']._serialized_options = b'\272\270\221\002\002\030\001\202\323\344\223\002&\"!/api/v1alpha1/asm/asm/enablevoice:\001*'
  _ASM.methods_by_name['DisableVoice']._options = None
  _ASM.methods_by_name['DisableVoice']._serialized_options = b'\272\270\221\002\002\030\001\202\323\344\223\002\'\"\"/api/v1alpha1/asm/asm/disablevoice:\001*'
  _ASM.methods_by_name['ListConversations']._options = None
  _ASM.methods_by_name['ListConversations']._serialized_options = b'\272\270\221\002\005\n\003\010\254\002\202\323\344\223\002,\"\'/api/v1alpha1/asm/asm/listconversations:\001*'
  _ASM.methods_by_name['AssignNewConversation']._options = None
  _ASM.methods_by_name['AssignNewConversation']._serialized_options = b'\272\270\221\002\005\n\003\010\254\002\202\323\344\223\0020\"+/api/v1alpha1/asm/asm/assignnewconversation:\001*'
  _ASM.methods_by_name['ListAgents']._options = None
  _ASM.methods_by_name['ListAgents']._serialized_options = b'\272\270\221\002\005\n\003\010\260\t\202\323\344\223\002%\" /api/v1alpha1/asm/asm/listagents:\001*'
  _ASM.methods_by_name['SetConversationCollectedData']._options = None
  _ASM.methods_by_name['SetConversationCollectedData']._serialized_options = b'\272\270\221\002\010\n\006\010\254\002\010\260\t\202\323\344\223\0027\"2/api/v1alpha1/asm/asm/setconversationcollecteddata:\001*'
  _ASM.methods_by_name['GetQueuesDetails']._options = None
  _ASM.methods_by_name['GetQueuesDetails']._serialized_options = b'\272\270\221\002\005\n\003\010\254\002\202\323\344\223\002+\"&/api/v1alpha1/asm/asm/getqueuesdetails:\001*'
  _globals['_ASM']._serialized_start=224
  _globals['_ASM']._serialized_end=2244
