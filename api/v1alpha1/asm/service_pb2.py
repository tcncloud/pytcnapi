...
if _descriptor._USE_C_DESCRIPTORS == False:
  ...
  _CREATESESSIONREQ_SKILLSENTRY._options = None
  _CREATESESSIONREQ_SKILLSENTRY._serialized_options = b'8\001'
  _SWITCHSUBSESSIONREQ_SKILLSENTRY._options = None
  _SWITCHSUBSESSIONREQ_SKILLSENTRY._serialized_options = b'8\001'
  _CONVERSATION.fields_by_name['conversation_sid']._options = None
  _CONVERSATION.fields_by_name['conversation_sid']._serialized_options = b'0\001'
  _CONVERSATIONSKILLS_SKILLSENTRY._options = None
  _CONVERSATIONSKILLS_SKILLSENTRY._serialized_options = b'8\001'
  _ASSIGNNEWCONVERSATIONREQ_SKILLSENTRY._options = None
  _ASSIGNNEWCONVERSATIONREQ_SKILLSENTRY._serialized_options = b'8\001'
  _SETCONVERSATIONCOLLECTEDDATAREQ_COLLECTEDDATAENTRY._options = None
  _SETCONVERSATIONCOLLECTEDDATAREQ_COLLECTEDDATAENTRY._serialized_options = b'8\001'
  _SETCONVERSATIONCOLLECTEDDATAREQ.fields_by_name['conversation_sid']._options = None
  _SETCONVERSATIONCOLLECTEDDATAREQ.fields_by_name['conversation_sid']._serialized_options = b'0\001'
  _GETQUEUESDETAILSREQ_SKILLSENTRY._options = None
  _GETQUEUESDETAILSREQ_SKILLSENTRY._serialized_options = b'8\001'
  _ENABLEVOICEREQ_SKILLSENTRY._options = None
  _ENABLEVOICEREQ_SKILLSENTRY._serialized_options = b'8\001'
  _DISABLEVOICEREQ_SKILLSENTRY._options = None
  _DISABLEVOICEREQ_SKILLSENTRY._serialized_options = b'8\001'
  _ASMAPI.methods_by_name['CreateSession']._options = None
  _ASMAPI.methods_by_name['CreateSession']._serialized_options = b'\202\323\344\223\002+\"&/api/v1alpha1/asm/asmapi/createsession:\001*'
  _ASMAPI.methods_by_name['GetStatus']._options = None
  _ASMAPI.methods_by_name['GetStatus']._serialized_options = b'\202\323\344\223\002\'\"\"/api/v1alpha1/asm/asmapi/getstatus:\001*'
  _ASMAPI.methods_by_name['EndSession']._options = None
  _ASMAPI.methods_by_name['EndSession']._serialized_options = b'\202\323\344\223\002(\"#/api/v1alpha1/asm/asmapi/endsession:\001*'
  _ASMAPI.methods_by_name['GetCurrentSession']._options = None
  _ASMAPI.methods_by_name['GetCurrentSession']._serialized_options = b'\202\323\344\223\002/\"*/api/v1alpha1/asm/asmapi/getcurrentsession:\001*'
  _ASMAPI.methods_by_name['SwitchSubsession']._options = None
  _ASMAPI.methods_by_name['SwitchSubsession']._serialized_options = b'\202\323\344\223\002.\")/api/v1alpha1/asm/asmapi/switchsubsession:\001*'
  _ASMAPI.methods_by_name['ListConversations']._options = None
  _ASMAPI.methods_by_name['ListConversations']._serialized_options = b'\202\323\344\223\002/\"*/api/v1alpha1/asm/asmapi/listconversations:\001*'
  _ASMAPI.methods_by_name['AssignNewConversation']._options = None
  _ASMAPI.methods_by_name['AssignNewConversation']._serialized_options = b'\202\323\344\223\0023\"./api/v1alpha1/asm/asmapi/assignnewconversation:\001*'
  _ASMAPI.methods_by_name['ListAgents']._options = None
  _ASMAPI.methods_by_name['ListAgents']._serialized_options = b'\202\323\344\223\002(\"#/api/v1alpha1/asm/asmapi/listagents:\001*'
  _ASMAPI.methods_by_name['SetConversationCollectedData']._options = None
  _ASMAPI.methods_by_name['SetConversationCollectedData']._serialized_options = b'\202\323\344\223\002:\"5/api/v1alpha1/asm/asmapi/setconversationcollecteddata:\001*'
  _ASMAPI.methods_by_name['GetQueuesDetails']._options = None
  _ASMAPI.methods_by_name['GetQueuesDetails']._serialized_options = b'\202\323\344\223\002.\")/api/v1alpha1/asm/asmapi/getqueuesdetails:\001*'
  _globals['_CREATESESSIONREQ']._serialized_start=281
  _globals['_CREATESESSIONREQ']._serialized_end=541
  _globals['_CREATESESSIONREQ_SKILLSENTRY']._serialized_start=484
  _globals['_CREATESESSIONREQ_SKILLSENTRY']._serialized_end=541
  _globals['_CREATESESSIONRES']._serialized_start=544
  _globals['_CREATESESSIONRES']._serialized_end=730
  _globals['_VOICEREGISTRATION']._serialized_start=733
  _globals['_VOICEREGISTRATION']._serialized_end=961
  _globals['_STREAMAGENTSTATEREQ']._serialized_start=963
  _globals['_STREAMAGENTSTATEREQ']._serialized_end=1055
  _globals['_MANAGERSTREAMAGENTSTATEREQ']._serialized_start=1057
  _globals['_MANAGERSTREAMAGENTSTATEREQ']._serialized_end=1085
  _globals['_GETSTATUSREQ']._serialized_start=1088
  _globals['_GETSTATUSREQ']._serialized_end=1471
  _globals['_GETSTATUSRES']._serialized_start=1473
  _globals['_GETSTATUSRES']._serialized_end=1553
  _globals['_VOICESTATUS']._serialized_start=1556
  _globals['_VOICESTATUS']._serialized_end=2437
  _globals['_QUEUEDCALLS']._serialized_start=2440
  _globals['_QUEUEDCALLS']._serialized_end=3141
  _globals['_QUEUEDCALLS_QUEUEDCALLDATA']._serialized_start=2703
  _globals['_QUEUEDCALLS_QUEUEDCALLDATA']._serialized_end=3141
  _globals['_ENDSESSIONREQ']._serialized_start=3143
  _globals['_ENDSESSIONREQ']._serialized_end=3222
  _globals['_ENDSESSIONRES']._serialized_start=3224
  _globals['_ENDSESSIONRES']._serialized_end=3239
  _globals['_GETCURRENTSESSIONREQ']._serialized_start=3241
  _globals['_GETCURRENTSESSIONREQ']._serialized_end=3263
  _globals['_ASMSESSION']._serialized_start=3266
  _globals['_ASMSESSION']._serialized_end=3527
  _globals['_VOICESESSION']._serialized_start=3530
  _globals['_VOICESESSION']._serialized_end=3736
  _globals['_SWITCHSUBSESSIONREQ']._serialized_start=3739
  _globals['_SWITCHSUBSESSIONREQ']._serialized_end=4039
  _globals['_SWITCHSUBSESSIONREQ_SKILLSENTRY']._serialized_start=484
  _globals['_SWITCHSUBSESSIONREQ_SKILLSENTRY']._serialized_end=541
  _globals['_SWITCHSUBSESSIONRES']._serialized_start=4042
  _globals['_SWITCHSUBSESSIONRES']._serialized_end=4191
  _globals['_CONVERSATION']._serialized_start=4194
  _globals['_CONVERSATION']._serialized_end=5304
  _globals['_CONVERSATIONSKILLS']._serialized_start=5307
  _globals['_CONVERSATIONSKILLS']._serialized_end=5460
  _globals['_CONVERSATIONSKILLS_SKILLSENTRY']._serialized_start=5403
  _globals['_CONVERSATIONSKILLS_SKILLSENTRY']._serialized_end=5460
  _globals['_ASSIGNNEWCONVERSATIONREQ']._serialized_start=5463
  _globals['_ASSIGNNEWCONVERSATIONREQ']._serialized_end=5731
  _globals['_ASSIGNNEWCONVERSATIONREQ_SKILLSENTRY']._serialized_start=484
  _globals['_ASSIGNNEWCONVERSATIONREQ_SKILLSENTRY']._serialized_end=541
  _globals['_ASSIGNNEWCONVERSATIONRES']._serialized_start=5734
  _globals['_ASSIGNNEWCONVERSATIONRES']._serialized_end=5863
  _globals['_LISTAGENTSREQ']._serialized_start=5865
  _globals['_LISTAGENTSREQ']._serialized_end=5880
  _globals['_LISTAGENTSRES']._serialized_start=5882
  _globals['_LISTAGENTSRES']._serialized_end=5954
  _globals['_SETCONVERSATIONCOLLECTEDDATAREQ']._serialized_start=5957
  _globals['_SETCONVERSATIONCOLLECTEDDATAREQ']._serialized_end=6273
  _globals['_SETCONVERSATIONCOLLECTEDDATAREQ_COLLECTEDDATAENTRY']._serialized_start=6209
  _globals['_SETCONVERSATIONCOLLECTEDDATAREQ_COLLECTEDDATAENTRY']._serialized_end=6273
  _globals['_SETCONVERSATIONCOLLECTEDDATARES']._serialized_start=6275
  _globals['_SETCONVERSATIONCOLLECTEDDATARES']._serialized_end=6308
  _globals['_LISTCONVERSATIONSREQ']._serialized_start=6311
  _globals['_LISTCONVERSATIONSREQ']._serialized_end=6665
  _globals['_LISTCONVERSATIONSRES']._serialized_start=6668
  _globals['_LISTCONVERSATIONSRES']._serialized_end=6799
  _globals['_GETQUEUESDETAILSREQ']._serialized_start=6802
  _globals['_GETQUEUESDETAILSREQ']._serialized_end=7060
  _globals['_GETQUEUESDETAILSREQ_SKILLSENTRY']._serialized_start=484
  _globals['_GETQUEUESDETAILSREQ_SKILLSENTRY']._serialized_end=541
  _globals['_PUSHEVENTSREQ']._serialized_start=7062
  _globals['_PUSHEVENTSREQ']._serialized_end=7164
  _globals['_PUSHEVENTSRES']._serialized_start=7166
  _globals['_PUSHEVENTSRES']._serialized_end=7181
  _globals['_ENABLEVOICEREQ']._serialized_start=7184
  _globals['_ENABLEVOICEREQ']._serialized_end=7407
  _globals['_ENABLEVOICEREQ_SKILLSENTRY']._serialized_start=484
  _globals['_ENABLEVOICEREQ_SKILLSENTRY']._serialized_end=541
  _globals['_ENABLEVOICERES']._serialized_start=7410
  _globals['_ENABLEVOICERES']._serialized_end=7554
  _globals['_DISABLEVOICEREQ']._serialized_start=7557
  _globals['_DISABLEVOICEREQ']._serialized_end=7782
  _globals['_DISABLEVOICEREQ_SKILLSENTRY']._serialized_start=484
  _globals['_DISABLEVOICEREQ_SKILLSENTRY']._serialized_end=541
  _globals['_DISABLEVOICERES']._serialized_start=7784
  _globals['_DISABLEVOICERES']._serialized_end=7801
  _globals['_ASMAPI']._serialized_start=7804
  _globals['_ASMAPI']._serialized_end=9312
