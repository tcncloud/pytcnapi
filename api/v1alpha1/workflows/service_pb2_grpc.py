...
class WorkflowsServiceStub(object):
    ...
    def __init__(self, channel):
        ...
        self.ListFlowDefinitions = channel.unary_unary(
                '/api.v1alpha1.workflows.WorkflowsService/ListFlowDefinitions',
        ...
        self.SaveFlowDefinition = channel.unary_unary(
                '/api.v1alpha1.workflows.WorkflowsService/SaveFlowDefinition',
        ...
        self.GetFlowDefinition = channel.unary_unary(
                '/api.v1alpha1.workflows.WorkflowsService/GetFlowDefinition',
        ...
        self.DeleteFlowDefinition = channel.unary_unary(
                '/api.v1alpha1.workflows.WorkflowsService/DeleteFlowDefinition',
...
class WorkflowsService(object):
    ...
    def ListFlowDefinitions(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/api.v1alpha1.workflows.WorkflowsService/ListFlowDefinitions',
    ...
    def SaveFlowDefinition(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/api.v1alpha1.workflows.WorkflowsService/SaveFlowDefinition',
    ...
    def GetFlowDefinition(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/api.v1alpha1.workflows.WorkflowsService/GetFlowDefinition',
    ...
    def DeleteFlowDefinition(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/api.v1alpha1.workflows.WorkflowsService/DeleteFlowDefinition',
