...
if not _descriptor._USE_C_DESCRIPTORS:
  ...
  _globals['_PARSEHINTS'].fields_by_name['parse_opts']._loaded_options = None
  _globals['_PARSEHINTS'].fields_by_name['parse_opts']._serialized_options = b'\030\001'
  ...
  _globals['_FILETEMPLATE']._serialized_end=731
