...
class SchemaField(_message.Message):
    __slots__ = ("name", "column_type", "is_primary_key", "is_low_cardinality")
    ...
    def __init__(self, name: _Optional[str] = ..., column_type: _Optional[_Union[SchemaType, str]] = ..., is_primary_key: bool = ..., is_low_cardinality: bool = ...) -> None: ...

class Schema(_message.Message):
    __slots__ = ("name", "datasource_type", "fields")
    NAME_FIELD_NUMBER: _ClassVar[int]
    ...
    def __init__(self, name: _Optional[str] = ..., datasource_type: _Optional[_Union[DatasourceType, str]] = ..., fields: _Optional[_Iterable[_Union[SchemaField, _Mapping]]] = ...) -> None: ...
