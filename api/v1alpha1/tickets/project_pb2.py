...
if _descriptor._USE_C_DESCRIPTORS == False:
  ...
  _ENABLEPROJECTREQ.fields_by_name['project_sid']._options = None
  _ENABLEPROJECTREQ.fields_by_name['project_sid']._serialized_options = b'0\001'
  _LISTTICKETAUDITLOGREQ.fields_by_name['ticket_sid']._options = None
  _LISTTICKETAUDITLOGREQ.fields_by_name['ticket_sid']._serialized_options = b'0\001'
