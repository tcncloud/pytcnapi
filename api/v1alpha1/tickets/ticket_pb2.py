...
if not _descriptor._USE_C_DESCRIPTORS:
  ...
  _globals['_CREATECUSTOMFIELDREQUEST'].fields_by_name['project_id']._loaded_options = None
  _globals['_CREATECUSTOMFIELDREQUEST'].fields_by_name['project_id']._serialized_options = b'0\001'
  _globals['_CREATECUSTOMFIELDRESPONSE'].fields_by_name['project_id']._loaded_options = None
  _globals['_CREATECUSTOMFIELDRESPONSE'].fields_by_name['project_id']._serialized_options = b'0\001'
  _globals['_EDITCUSTOMFIELDREQUEST'].fields_by_name['project_id']._loaded_options = None
  _globals['_EDITCUSTOMFIELDREQUEST'].fields_by_name['project_id']._serialized_options = b'0\001'
  _globals['_EDITCUSTOMFIELDRESPONSE'].fields_by_name['project_id']._loaded_options = None
  _globals['_EDITCUSTOMFIELDRESPONSE'].fields_by_name['project_id']._serialized_options = b'0\001'
  _globals['_LISTCUSTOMFIELDSREQUEST'].fields_by_name['project_id']._loaded_options = None
  _globals['_LISTCUSTOMFIELDSREQUEST'].fields_by_name['project_id']._serialized_options = b'0\001'
  _globals['_LISTCUSTOMFIELDSRESPONSE'].fields_by_name['project_id']._loaded_options = None
  _globals['_LISTCUSTOMFIELDSRESPONSE'].fields_by_name['project_id']._serialized_options = b'0\001'
  _globals['_ACTIONTYPES']._serialized_start=8127
  _globals['_ACTIONTYPES']._serialized_end=8190
  _globals['_SLACONDITIONS']._serialized_start=8192
  _globals['_SLACONDITIONS']._serialized_end=8243
  ...
  _globals['_CREATECUSTOMFIELDREQUEST']._serialized_start=7118
  _globals['_CREATECUSTOMFIELDREQUEST']._serialized_end=7273
  _globals['_CREATECUSTOMFIELDRESPONSE']._serialized_start=7276
  _globals['_CREATECUSTOMFIELDRESPONSE']._serialized_end=7432
  _globals['_EDITCUSTOMFIELDREQUEST']._serialized_start=7435
  _globals['_EDITCUSTOMFIELDREQUEST']._serialized_end=7584
  _globals['_EDITCUSTOMFIELDRESPONSE']._serialized_start=7587
  _globals['_EDITCUSTOMFIELDRESPONSE']._serialized_end=7754
  _globals['_LISTCUSTOMFIELDSREQUEST']._serialized_start=7756
  _globals['_LISTCUSTOMFIELDSREQUEST']._serialized_end=7849
  _globals['_LISTCUSTOMFIELDSRESPONSE']._serialized_start=7852
  _globals['_LISTCUSTOMFIELDSRESPONSE']._serialized_end=8009
  _globals['_ENTITYREF']._serialized_start=8011
  _globals['_ENTITYREF']._serialized_end=8125
