...
class ListCategoriesByOrgIdRequest(_message.Message):
    __slots__ = ("org_id", "author_ids", "skill_profiles", "call_types", "category_type")
    class CategoryType(int, metaclass=_enum_type_wrapper.EnumTypeWrapper):
        __slots__ = ()
    ...
    def __init__(self, org_id: _Optional[str] = ..., author_ids: _Optional[_Iterable[str]] = ..., skill_profiles: _Optional[_Iterable[int]] = ..., call_types: _Optional[_Iterable[_Union[_acd_pb2.CallType.Enum, str]]] = ..., category_type: _Optional[_Union[ListCategoriesByOrgIdRequest.CategoryType, str]] = ...) -> None: ...
