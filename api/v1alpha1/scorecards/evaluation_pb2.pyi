...
class ListEvaluationsRequest(_message.Message):
    __slots__ = ("scorer_id", "completed_at", "category_ids", "agent_user_ids", "scorecard_ids", "return_fields", "include_deleted")
