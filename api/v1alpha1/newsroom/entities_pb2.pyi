...
class NewsArticleDetails(_message.Message):
    ...
    author: str
    image_reference_id: str
    def __init__(self, new_article_sid: _Optional[int] = ..., title: _Optional[str] = ..., content: _Optional[str] = ..., status: _Optional[_Union[_newsroom_pb2.ArticleStatus, str]] = ..., date_created: _Optional[_Union[datetime.datetime, _timestamp_pb2.Timestamp, _Mapping]] = ..., last_edited: _Optional[_Union[datetime.datetime, _timestamp_pb2.Timestamp, _Mapping]] = ..., author: _Optional[str] = ..., image_reference_id: _Optional[str] = ...) -> None: ...
...
class PublishedArticleDetails(_message.Message):
    ...
    def __init__(self, published_article_sid: _Optional[int] = ..., news_article_details: _Optional[_Union[NewsArticleDetails, _Mapping]] = ..., date_published: _Optional[_Union[datetime.datetime, _timestamp_pb2.Timestamp, _Mapping]] = ..., display_to_user: _Optional[bool] = ..., always_display: _Optional[bool] = ..., is_client_article: _Optional[bool] = ...) -> None: ...
...
class UserActivity(_message.Message):
    ...
    def __init__(self, user_activity_log_sid: _Optional[int] = ..., date_created: _Optional[_Union[datetime.datetime, _timestamp_pb2.Timestamp, _Mapping]] = ..., user_activity_details: _Optional[_Union[UserActivity.UserActivityDetails, _Mapping]] = ...) -> None: ...
...
class CreatePublishedArticleRequest(_message.Message):
    ...
    display_to_user: bool
    article_link: str
    def __init__(self, new_article_sid: _Optional[int] = ..., display_to_user: _Optional[bool] = ..., article_link: _Optional[str] = ...) -> None: ...
...
class UserActivityRequest(_message.Message):
    ...
    force: bool
    published_client_article_sid: int
    def __init__(self, published_article_sid: _Optional[int] = ..., force: _Optional[bool] = ..., published_client_article_sid: _Optional[int] = ...) -> None: ...
...
class CreatePublishedClientArticleRequest(_message.Message):
    ...
    article_link: str
    always_show: bool
    def __init__(self, new_article_sid: _Optional[int] = ..., display_to_user: _Optional[bool] = ..., article_link: _Optional[str] = ..., always_show: _Optional[bool] = ...) -> None: ...
