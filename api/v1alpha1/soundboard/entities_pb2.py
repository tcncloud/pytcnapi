...
if not _descriptor._USE_C_DESCRIPTORS:
  ...
  _globals['_SOUNDBOARDDETAILS'].fields_by_name['soundboard_id']._loaded_options = None
  _globals['_SOUNDBOARDDETAILS'].fields_by_name['soundboard_id']._serialized_options = b'0\001'
  _globals['_GETSOUNDBOARDFILEREQ'].fields_by_name['soundboard_id']._loaded_options = None
  _globals['_GETSOUNDBOARDFILEREQ'].fields_by_name['soundboard_id']._serialized_options = b'0\001'
  _globals['_GETSOUNDBOARDREQ'].fields_by_name['soundboard_id']._loaded_options = None
  _globals['_GETSOUNDBOARDREQ'].fields_by_name['soundboard_id']._serialized_options = b'0\001'
  _globals['_CREATESOUNDBOARDRES'].fields_by_name['soundboard_id']._loaded_options = None
  _globals['_CREATESOUNDBOARDRES'].fields_by_name['soundboard_id']._serialized_options = b'0\001'
  _globals['_UPDATESOUNDBOARDRES'].fields_by_name['soundboard_id']._loaded_options = None
  _globals['_UPDATESOUNDBOARDRES'].fields_by_name['soundboard_id']._serialized_options = b'0\001'
  _globals['_DELETESOUNDBOARDREQ'].fields_by_name['soundboard_id']._loaded_options = None
