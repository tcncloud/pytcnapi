...
class FilterSnapshot(_message.Message):
    ...
    version: int
    def __init__(self, filter_snapshot_sid: _Optional[int] = ..., filter_sid: _Optional[int] = ..., name: _Optional[str] = ..., search_request: _Optional[_Union[_transcript_pb2.SearchRequest, _Mapping]] = ..., create_time: _Optional[_Union[datetime.datetime, _timestamp_pb2.Timestamp, _Mapping]] = ..., version: _Optional[int] = ...) -> None: ...
