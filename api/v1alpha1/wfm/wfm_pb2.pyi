...
class BuildDraftScheduleRes(_message.Message):
    __slots__ = ["draft_schedule", "diagnostics", "scheduling_resulting_metric"]
    DRAFT_SCHEDULE_FIELD_NUMBER: _ClassVar[int]
    DIAGNOSTICS_FIELD_NUMBER: _ClassVar[int]
    SCHEDULING_RESULTING_METRIC_FIELD_NUMBER: _ClassVar[int]
    draft_schedule: DraftSchedule
    diagnostics: _containers.RepeatedCompositeFieldContainer[Diagnostic]
    scheduling_resulting_metric: _wfm_pb2.SchedulingResultMetric
    def __init__(self, draft_schedule: _Optional[_Union[DraftSchedule, _Mapping]] = ..., diagnostics: _Optional[_Iterable[_Union[Diagnostic, _Mapping]]] = ..., scheduling_resulting_metric: _Optional[_Union[_wfm_pb2.SchedulingResultMetric, _Mapping]] = ...) -> None: ...
