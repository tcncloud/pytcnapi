...
class AuthenticationPreferences(_message.Message):
    ...
    def __init__(self, authorization_via_ip: _Optional[bool] = ..., allowed_ips: _Optional[_Iterable[str]] = ..., agent_api_key: _Optional[str] = ..., user_authorization_via_ip: _Optional[bool] = ...) -> None: ...
