...
if _descriptor._USE_C_DESCRIPTORS == False:
  ...
  _globals['_SKILLSSERVICE'].methods_by_name['CreateSkillGroup']._options = None
  ...
  _globals['_SKILLSSERVICE'].methods_by_name['ListSkillGroups']._options = None
  _globals['_SKILLSSERVICE'].methods_by_name['ListSkillGroups']._serialized_options = b'\272\270\221\002\004\n\002\010e\202\323\344\223\002)\"$/api/v1alpha1/skills/listskillgroups:\001*'
  _globals['_SKILLSSERVICE'].methods_by_name['UpdateSkillGroup']._options = None
  ...
  _globals['_SKILLSSERVICE'].methods_by_name['GetSkillGroup']._options = None
  ...
  _globals['_SKILLSSERVICE'].methods_by_name['DeleteSkillGroup']._options = None
  ...
  _globals['_SKILLSSERVICE'].methods_by_name['AssignSkillGroups']._options = None
  _globals['_SKILLSSERVICE'].methods_by_name['AssignSkillGroups']._serialized_options = b'\272\270\221\002\004\n\002\010d\202\323\344\223\002+\"&/api/v1alpha1/skills/assignskillgroups:\001*'
  _globals['_SKILLSSERVICE'].methods_by_name['AssignUsers']._options = None
  _globals['_SKILLSSERVICE'].methods_by_name['AssignUsers']._serialized_options = b'\272\270\221\002\004\n\002\010d\202\323\344\223\002%\" /api/v1alpha1/skills/assignusers:\001*'
  _globals['_SKILLSSERVICE'].methods_by_name['RevokeSkillGroups']._options = None
  _globals['_SKILLSSERVICE'].methods_by_name['RevokeSkillGroups']._serialized_options = b'\272\270\221\002\004\n\002\010d\202\323\344\223\002+\"&/api/v1alpha1/skills/revokeskillgroups:\001*'
  _globals['_SKILLSSERVICE'].methods_by_name['GetUserSkillGroups']._options = None
  ...
  _globals['_SKILLSSERVICE'].methods_by_name['GetUserSkills']._options = None
  ...
  _globals['_SKILLSSERVICE'].methods_by_name['GetSkillGroupMembers']._options = None
  ...
  _globals['_SKILLSSERVICE'].methods_by_name['ListSkillGroupsMembers']._options = None
  ...
  _globals['_SKILLSSERVICE']._serialized_end=2357
