...
class SkillsServiceStub(object):
    ...
    def __init__(self, channel):
        ...
        self.AssignUsers = channel.unary_unary(
                '/api.v1alpha1.org.skills.SkillsService/AssignUsers',
                request_serializer=api_dot_v1alpha1_dot_org_dot_skills_dot_entities__pb2.AssignUsersRequest.SerializeToString,
                response_deserializer=api_dot_v1alpha1_dot_org_dot_skills_dot_entities__pb2.AssignUsersResponse.FromString,
                )
...
class SkillsServiceServicer(object):
    ...
    def AssignUsers(self, request, context):
...
def add_SkillsServiceServicer_to_server(servicer, server):
    rpc_method_handlers = {
            ...
            'AssignUsers': grpc.unary_unary_rpc_method_handler(
                    servicer.AssignUsers,
                    request_deserializer=api_dot_v1alpha1_dot_org_dot_skills_dot_entities__pb2.AssignUsersRequest.FromString,
                    response_serializer=api_dot_v1alpha1_dot_org_dot_skills_dot_entities__pb2.AssignUsersResponse.SerializeToString,
            ),
...
class SkillsService(object):
    ...
    def AssignUsers(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/api.v1alpha1.org.skills.SkillsService/AssignUsers',
            api_dot_v1alpha1_dot_org_dot_skills_dot_entities__pb2.AssignUsersRequest.SerializeToString,
            api_dot_v1alpha1_dot_org_dot_skills_dot_entities__pb2.AssignUsersResponse.FromString,
            options, channel_credentials,
            insecure, call_credentials, compression, wait_for_ready, timeout, metadata)
