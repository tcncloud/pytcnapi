...
class CreateUserRequest(_message.Message):
    __slots__ = ("org_id", "first_name", "last_name", "email", "user_name", "password", "permission_group_ids", "partner_agent_id", "p3_permission_group_id", "linkback_numbers", "caller_ids", "default_app", "user_caller_id", "agent_profile_group_id", "label_ids", "time_zone_override", "hunt_group_sid", "locale_preferences_override", "password_reset_required", "play_notification_sounds")
    ...
    PLAY_NOTIFICATION_SOUNDS_FIELD_NUMBER: _ClassVar[int]
    org_id: str
    first_name: str
    last_name: str
    email: str
...
class GetMyUserResponse(_message.Message):
    ...
    account_owner: bool
    email_verified: bool
    def __init__(self, user_id: _Optional[str] = ..., org_id: _Optional[str] = ..., username: _Optional[str] = ..., delegated: _Optional[bool] = ..., org_name: _Optional[str] = ..., hunt_group: _Optional[_Union[GetMyUserResponse.HuntGroup, _Mapping]] = ..., labels: _Optional[_Iterable[_Union[_labels_pb2.Label, _Mapping]]] = ..., skills: _Optional[_Iterable[_Union[_user_pb2.Skill, _Mapping]]] = ..., permission_groups: _Optional[_Iterable[_Union[_permissions_pb2.PermissionGroup, _Mapping]]] = ..., p3_permission_group: _Optional[_Union[_permissions_pb2.P3PermissionGroup, _Mapping]] = ..., agent_profile_group: _Optional[_Union[GetMyUserResponse.AgentProfileGroup, _Mapping]] = ..., trusts: _Optional[_Iterable[_Union[_trusts_pb2.Trust, _Mapping]]] = ..., account_owner: _Optional[bool] = ..., email_verified: _Optional[bool] = ...) -> None: ...
...
class GetUserResponse(_message.Message):
    ...
    play_notification_sounds: bool
    def __init__(self, user_id: _Optional[str] = ..., org_id: _Optional[str] = ..., delegated: _Optional[bool] = ..., time_zone_override: _Optional[_Union[_org_pb2.TimeZoneWrapper, _Mapping]] = ..., hunt_group: _Optional[_Union[GetUserResponse.HuntGroup, _Mapping]] = ..., labels: _Optional[_Iterable[_Union[_labels_pb2.Label, _Mapping]]] = ..., skills: _Optional[_Iterable[_Union[_user_pb2.Skill, _Mapping]]] = ..., permission_groups: _Optional[_Iterable[_Union[_permissions_pb2.PermissionGroup, _Mapping]]] = ..., p3_permission_group: _Optional[_Union[_permissions_pb2.P3PermissionGroup, _Mapping]] = ..., agent_profile_group: _Optional[_Union[GetUserResponse.AgentProfileGroup, _Mapping]] = ..., org_name: _Optional[str] = ..., first_name: _Optional[str] = ..., username: _Optional[str] = ..., last_name: _Optional[str] = ..., login_disabled: _Optional[bool] = ..., partner_agent_id: _Optional[str] = ..., user_caller_id: _Optional[str] = ..., linkback_numbers: _Optional[_Iterable[str]] = ..., caller_ids: _Optional[_Iterable[str]] = ..., default_app: _Optional[_Union[_org_pb2.OperatorApplications, str]] = ..., login_sid: _Optional[int] = ..., agent_sid: _Optional[int] = ..., trusts: _Optional[_Iterable[_Union[_trusts_pb2.Trust, _Mapping]]] = ..., email: _Optional[str] = ..., default_region: _Optional[str] = ..., created_at: _Optional[_Union[datetime.datetime, _timestamp_pb2.Timestamp, _Mapping]] = ..., last_updated: _Optional[_Union[datetime.datetime, _timestamp_pb2.Timestamp, _Mapping]] = ..., password_reset_required: _Optional[bool] = ..., account_owner: _Optional[bool] = ..., email_verified: _Optional[bool] = ..., locale_preferences_override: _Optional[_Union[_org_preferences_pb2.LocalePreferences, _Mapping]] = ..., password_reset_date: _Optional[_Union[datetime.datetime, _timestamp_pb2.Timestamp, _Mapping]] = ..., play_notification_sounds: _Optional[bool] = ...) -> None: ...
...
class GetUserByOrgIdResponse(_message.Message):
    __slots__ = ("user_id", "org_id", "username", "delegated", "org_name", "hunt_group", "labels", "skills", "permission_groups", "p3_permission_group", "agent_profile_group", "trusts", "account_owner", "email_verified", "locale_preferences_override", "play_notification_sounds")
    class HuntGroup(_message.Message):
        __slots__ = ("hunt_group_sid", "hunt_group_name")
        HUNT_GROUP_SID_FIELD_NUMBER: _ClassVar[int]
        HUNT_GROUP_NAME_FIELD_NUMBER: _ClassVar[int]
    ...
    locale_preferences_override: _org_preferences_pb2.LocalePreferences
    play_notification_sounds: bool
    def __init__(self, user_id: _Optional[str] = ..., org_id: _Optional[str] = ..., username: _Optional[str] = ..., delegated: _Optional[bool] = ..., org_name: _Optional[str] = ..., hunt_group: _Optional[_Union[GetUserByOrgIdResponse.HuntGroup, _Mapping]] = ..., labels: _Optional[_Iterable[_Union[_labels_pb2.Label, _Mapping]]] = ..., skills: _Optional[_Iterable[_Union[_user_pb2.Skill, _Mapping]]] = ..., permission_groups: _Optional[_Iterable[_Union[_permissions_pb2.PermissionGroup, _Mapping]]] = ..., p3_permission_group: _Optional[_Union[_permissions_pb2.P3PermissionGroup, _Mapping]] = ..., agent_profile_group: _Optional[_Union[GetUserByOrgIdResponse.AgentProfileGroup, _Mapping]] = ..., trusts: _Optional[_Iterable[_Union[_trusts_pb2.Trust, _Mapping]]] = ..., account_owner: _Optional[bool] = ..., email_verified: _Optional[bool] = ..., locale_preferences_override: _Optional[_Union[_org_preferences_pb2.LocalePreferences, _Mapping]] = ..., play_notification_sounds: _Optional[bool] = ...) -> None: ...
...
class ListAgentsResponse(_message.Message):
    ...
    class AgentDetails(_message.Message):
        ...
        def __init__(self, user_id: _Optional[str] = ..., org_id: _Optional[str] = ..., first_name: _Optional[str] = ..., last_name: _Optional[str] = ..., username: _Optional[str] = ..., skills: _Optional[_Iterable[_Union[_user_pb2.Skill, _Mapping]]] = ..., login_disabled: _Optional[bool] = ..., hunt_group: _Optional[_Union[ListAgentsResponse.AgentDetails.HuntGroup, _Mapping]] = ..., labels: _Optional[_Iterable[_Union[_labels_pb2.Label, _Mapping]]] = ..., delegated: _Optional[bool] = ..., trust_ids: _Optional[_Iterable[str]] = ..., permission_groups: _Optional[_Iterable[_Union[_permissions_pb2.PermissionGroup, _Mapping]]] = ..., agent_sid: _Optional[int] = ..., name: _Optional[str] = ..., partner_agent_id: _Optional[str] = ..., user_caller_id: _Optional[str] = ..., created: _Optional[_Union[datetime.datetime, _timestamp_pb2.Timestamp, _Mapping]] = ..., last_updated: _Optional[_Union[datetime.datetime, _timestamp_pb2.Timestamp, _Mapping]] = ..., agent_profile_group: _Optional[_Union[ListAgentsResponse.AgentDetails.AgentProfileGroup, _Mapping]] = ..., agent: _Optional[bool] = ..., time_zone_override: _Optional[_Union[_org_pb2.TimeZoneWrapper, _Mapping]] = ..., email: _Optional[str] = ..., email_verified: _Optional[bool] = ..., mfa_info: _Optional[_Union[_user_pb2.MfaInfo, _Mapping]] = ...) -> None: ...
...
class ListPublicUsersRequest(_message.Message):
    ...
    def __init__(self, agent_filter: _Optional[bool] = ..., archived_filter: _Optional[_Union[_user_pb2_1.UserArchivedStateFilter, str]] = ...) -> None: ...
...
class ListUsersResponse(_message.Message):
    ...
    class UserDetails(_message.Message):
        ...
        mfa_info: _user_pb2.MfaInfo
        email_verified: bool
        def __init__(self, user_id: _Optional[str] = ..., org_id: _Optional[str] = ..., first_name: _Optional[str] = ..., last_name: _Optional[str] = ..., username: _Optional[str] = ..., login_disabled: _Optional[bool] = ..., permission_group_ids: _Optional[_Iterable[str]] = ..., labels: _Optional[_Iterable[_Union[_labels_pb2.Label, _Mapping]]] = ..., account_owner: _Optional[bool] = ..., agent: _Optional[bool] = ..., trust_ids: _Optional[_Iterable[str]] = ..., mfa_info: _Optional[_Union[_user_pb2.MfaInfo, _Mapping]] = ..., email_verified: _Optional[bool] = ...) -> None: ...
    USERS_FIELD_NUMBER: _ClassVar[int]
...
class ListUsersByRegionRequest(_message.Message):
    ...
    agent: bool
    archived_filter: _user_pb2_1.UserArchivedStateFilter
    def __init__(self, region_id: _Optional[str] = ..., agent: _Optional[bool] = ..., archived_filter: _Optional[_Union[_user_pb2_1.UserArchivedStateFilter, str]] = ...) -> None: ...
...
class UpdateMyUserRequest(_message.Message):
    __slots__ = ("linkback_numbers", "caller_ids", "time_zone_override", "default_app", "locale_preferences_override", "play_notification_sounds", "field_mask")
    LINKBACK_NUMBERS_FIELD_NUMBER: _ClassVar[int]
    CALLER_IDS_FIELD_NUMBER: _ClassVar[int]
    TIME_ZONE_OVERRIDE_FIELD_NUMBER: _ClassVar[int]
    DEFAULT_APP_FIELD_NUMBER: _ClassVar[int]
    ...
    def __init__(self, linkback_numbers: _Optional[_Iterable[str]] = ..., caller_ids: _Optional[_Iterable[str]] = ..., time_zone_override: _Optional[_Union[_org_pb2.TimeZoneWrapper, _Mapping]] = ..., default_app: _Optional[_Union[_org_pb2.OperatorApplications, str]] = ..., locale_preferences_override: _Optional[_Union[_org_preferences_pb2.LocalePreferences, _Mapping]] = ..., play_notification_sounds: _Optional[bool] = ..., field_mask: _Optional[_Iterable[str]] = ...) -> None: ...
...
class UpdateUserRequest(_message.Message):
    __slots__ = ("user_id", "first_name", "last_name", "partner_agent_id", "time_zone_override", "linkback_numbers", "caller_ids", "default_app", "password_reset_required", "agent_profile_group_id", "username", "email", "user_caller_id", "label_ids", "locale_preferences_override", "play_notification_sounds", "field_mask")
    USER_ID_FIELD_NUMBER: _ClassVar[int]
    FIRST_NAME_FIELD_NUMBER: _ClassVar[int]
    LAST_NAME_FIELD_NUMBER: _ClassVar[int]
    PARTNER_AGENT_ID_FIELD_NUMBER: _ClassVar[int]
    ...
    play_notification_sounds: bool
    field_mask: _containers.RepeatedScalarFieldContainer[str]
    def __init__(self, user_id: _Optional[str] = ..., first_name: _Optional[str] = ..., last_name: _Optional[str] = ..., partner_agent_id: _Optional[str] = ..., time_zone_override: _Optional[_Union[_org_pb2.TimeZoneWrapper, _Mapping]] = ..., linkback_numbers: _Optional[_Iterable[str]] = ..., caller_ids: _Optional[_Iterable[str]] = ..., default_app: _Optional[_Union[_org_pb2.OperatorApplications, str]] = ..., password_reset_required: _Optional[bool] = ..., agent_profile_group_id: _Optional[str] = ..., username: _Optional[str] = ..., email: _Optional[str] = ..., user_caller_id: _Optional[str] = ..., label_ids: _Optional[_Iterable[str]] = ..., locale_preferences_override: _Optional[_Union[_org_preferences_pb2.LocalePreferences, _Mapping]] = ..., play_notification_sounds: _Optional[bool] = ..., field_mask: _Optional[_Iterable[str]] = ...) -> None: ...
...
class UpdateUserDisabledRequest(_message.Message):
    ...
    user_id: str
    login_disabled: bool
    def __init__(self, user_id: _Optional[str] = ..., login_disabled: _Optional[bool] = ...) -> None: ...
...
class UpdateUserDisabledByOrgIdRequest(_message.Message):
    ...
    org_id: str
    login_disabled: bool
    def __init__(self, user_id: _Optional[str] = ..., org_id: _Optional[str] = ..., login_disabled: _Optional[bool] = ...) -> None: ...
...
class CreatePasswordResetLinkRequest(_message.Message):
    ...
    def __init__(self, user_id: _Optional[str] = ..., expiration: _Optional[_Union[datetime.datetime, _timestamp_pb2.Timestamp, _Mapping]] = ...) -> None: ...
...
class GetUserEmailVerifiedResponse(_message.Message):
    ...
    EMAIL_VERIFIED_FIELD_NUMBER: _ClassVar[int]
    email_verified: bool
    def __init__(self, email_verified: _Optional[bool] = ...) -> None: ...
...
class GetUserSessionDataResponse(_message.Message):
    __slots__ = ("user", "org_name", "p3_permissions", "permission_groups", "labels", "org_allowed_mfa", "locale_preferences", "billing_id")
    class User(_message.Message):
        __slots__ = ("user_id", "org_id", "username", "p3_permission_group_id", "partner_agent_id", "region_sid_map", "default_region", "api_key", "email", "login_disabled", "caller_ids", "linkback_numbers", "auth_user_id", "first_name", "last_name", "created", "last_updated", "password_reset_required", "connection_id", "time_zone_override", "permission_group_ids", "trust_ids", "default_application", "user_caller_id", "agent_profile_group_id", "agent", "account_owner", "mfa_timestamp", "password_reset_date", "locale_preferences_override", "access_token_expiration", "play_notification_sounds")
        ...
        PASSWORD_RESET_DATE_FIELD_NUMBER: _ClassVar[int]
        LOCALE_PREFERENCES_OVERRIDE_FIELD_NUMBER: _ClassVar[int]
        ACCESS_TOKEN_EXPIRATION_FIELD_NUMBER: _ClassVar[int]
        PLAY_NOTIFICATION_SOUNDS_FIELD_NUMBER: _ClassVar[int]
        user_id: str
        org_id: str
        username: str
        ...
        password_reset_date: _timestamp_pb2.Timestamp
        locale_preferences_override: _org_preferences_pb2.LocalePreferences
        access_token_expiration: _timestamp_pb2.Timestamp
        play_notification_sounds: bool
        def __init__(self, user_id: _Optional[str] = ..., org_id: _Optional[str] = ..., username: _Optional[str] = ..., p3_permission_group_id: _Optional[str] = ..., partner_agent_id: _Optional[str] = ..., region_sid_map: _Optional[_Mapping[str, GetUserSessionDataResponse.User.RegionSids]] = ..., default_region: _Optional[str] = ..., api_key: _Optional[str] = ..., email: _Optional[str] = ..., login_disabled: _Optional[bool] = ..., caller_ids: _Optional[_Iterable[str]] = ..., linkback_numbers: _Optional[_Iterable[str]] = ..., auth_user_id: _Optional[str] = ..., first_name: _Optional[str] = ..., last_name: _Optional[str] = ..., created: _Optional[_Union[datetime.datetime, _timestamp_pb2.Timestamp, _Mapping]] = ..., last_updated: _Optional[_Union[datetime.datetime, _timestamp_pb2.Timestamp, _Mapping]] = ..., password_reset_required: _Optional[bool] = ..., connection_id: _Optional[_Union[_wrappers_pb2.StringValue, _Mapping]] = ..., time_zone_override: _Optional[_Union[_org_pb2.TimeZoneWrapper, _Mapping]] = ..., permission_group_ids: _Optional[_Iterable[str]] = ..., trust_ids: _Optional[_Iterable[str]] = ..., default_application: _Optional[_Union[_org_pb2.OperatorApplications, str]] = ..., user_caller_id: _Optional[str] = ..., agent_profile_group_id: _Optional[str] = ..., agent: _Optional[bool] = ..., account_owner: _Optional[bool] = ..., mfa_timestamp: _Optional[_Union[datetime.datetime, _timestamp_pb2.Timestamp, _Mapping]] = ..., password_reset_date: _Optional[_Union[datetime.datetime, _timestamp_pb2.Timestamp, _Mapping]] = ..., locale_preferences_override: _Optional[_Union[_org_preferences_pb2.LocalePreferences, _Mapping]] = ..., access_token_expiration: _Optional[_Union[datetime.datetime, _timestamp_pb2.Timestamp, _Mapping]] = ..., play_notification_sounds: _Optional[bool] = ...) -> None: ...
    ...
    billing_id: str
    def __init__(self, user: _Optional[_Union[GetUserSessionDataResponse.User, _Mapping]] = ..., org_name: _Optional[str] = ..., p3_permissions: _Optional[_Iterable[_Union[_perms_pb2.Permission, str]]] = ..., permission_groups: _Optional[_Iterable[_Union[_permissions_pb2.PermissionGroup, _Mapping]]] = ..., labels: _Optional[_Iterable[_Union[_labels_pb2.Label, _Mapping]]] = ..., org_allowed_mfa: _Optional[bool] = ..., locale_preferences: _Optional[_Union[_org_preferences_pb2.LocalePreferences, _Mapping]] = ..., billing_id: _Optional[str] = ...) -> None: ...
...
class GetMyAllowedMfaMethodsResponse(_message.Message):
    ...
    duo_enabled: bool
    totp_enabled: bool
    def __init__(self, mfa_enabled: _Optional[bool] = ..., email_enabled: _Optional[bool] = ..., duo_enabled: _Optional[bool] = ..., totp_enabled: _Optional[bool] = ...) -> None: ...
...
class AddGroupedUserIPRestrictionsRequest(_message.Message):
    ...
    def __init__(self, user_ids: _Optional[_Iterable[str]] = ..., ips: _Optional[_Iterable[str]] = ...) -> None: ...
