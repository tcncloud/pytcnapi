...
class DeliveryApiStub(object):
    ...
    def __init__(self, channel):
        ...
        self.TriggerDemoOutboundDelivery = channel.unary_unary(
                '/api.v1alpha1.delivery.DeliveryApi/TriggerDemoOutboundDelivery',
                request_serializer=api_dot_v1alpha1_dot_delivery_dot_service__pb2.TriggerDemoOutboundDeliveryReq.SerializeToString,
                response_deserializer=api_dot_v1alpha1_dot_delivery_dot_service__pb2.TriggerDemoOutboundDeliveryRes.FromString,
                )
...
class DeliveryApiServicer(object):
    ...
    def TriggerDemoOutboundDelivery(self, request, context):
        """Missing associated documentation comment in .proto file."""
        context.set_code(grpc.StatusCode.UNIMPLEMENTED)
        context.set_details('Method not implemented!')
        raise NotImplementedError('Method not implemented!')
...
def add_DeliveryApiServicer_to_server(servicer, server):
    rpc_method_handlers = {
            ...
            'TriggerDemoOutboundDelivery': grpc.unary_unary_rpc_method_handler(
                    servicer.TriggerDemoOutboundDelivery,
                    request_deserializer=api_dot_v1alpha1_dot_delivery_dot_service__pb2.TriggerDemoOutboundDeliveryReq.FromString,
                    response_serializer=api_dot_v1alpha1_dot_delivery_dot_service__pb2.TriggerDemoOutboundDeliveryRes.SerializeToString,
            ),
    }
...
class DeliveryApi(object):
    ...
    @staticmethod
    def TriggerDemoOutboundDelivery(request,
            target,
            options=(),
            channel_credentials=None,
            call_credentials=None,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/api.v1alpha1.delivery.DeliveryApi/TriggerDemoOutboundDelivery',
            api_dot_v1alpha1_dot_delivery_dot_service__pb2.TriggerDemoOutboundDeliveryReq.SerializeToString,
            api_dot_v1alpha1_dot_delivery_dot_service__pb2.TriggerDemoOutboundDeliveryRes.FromString,
            options, channel_credentials,
            insecure, call_credentials, compression, wait_for_ready, timeout, metadata)
