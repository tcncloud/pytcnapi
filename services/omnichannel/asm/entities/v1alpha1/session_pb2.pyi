...
class AsmUserDetails(_message.Message):
    __slots__ = ("user_id", "name", "agent_sid", "agent_status", "agent_profile_group_name", "current_conversation_sid", "average_customer_wait_time_seconds", "average_time_to_respond_seconds", "last_event_time", "skills", "asm_session_sid", "events", "login_tome")
    ...
    LOGIN_TOME_FIELD_NUMBER: _ClassVar[int]
    user_id: str
    name: str
    agent_sid: int
