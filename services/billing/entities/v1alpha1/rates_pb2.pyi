...
class RateDefinition(_message.Message):
    __slots__ = ["rate_definition_id", "rate_definition_group_id", "config", "create_time", "update_time", "delete_time"]
    ...
    def __init__(self, rate_definition_id: _Optional[str] = ..., rate_definition_group_id: _Optional[str] = ..., config: _Optional[_Union[RateDefinitionConfig, _Mapping]] = ..., create_time: _Optional[_Union[_timestamp_pb2.Timestamp, _Mapping]] = ..., update_time: _Optional[_Union[_timestamp_pb2.Timestamp, _Mapping]] = ..., delete_time: _Optional[_Union[_timestamp_pb2.Timestamp, _Mapping]] = ...) -> None: ...
