...
class RateDefinition(_message.Message):
    __slots__ = ("rate_definition_id", "rate_definition_feature_id", "rate_definition_group_id", "event_type", "config_type", "matching_rule", "matching_config", "config", "create_time", "update_time", "delete_time", "MatchingSha")
    ...
    MATCHINGSHA_FIELD_NUMBER: _ClassVar[int]
