...
class Invoice(_message.Message):
    __slots__ = ["invoice_id", "org_id", "billing_cycle", "create_time", "update_time", "delete_time", "items", "url"]
...
class InvoiceItem(_message.Message):
    ...
    create_time: _timestamp_pb2.Timestamp
    update_time: _timestamp_pb2.Timestamp
    def __init__(self, invoice_item_id: _Optional[str] = ..., invoice_id: _Optional[str] = ..., product: _Optional[_Union[_product_pb2.Product, str]] = ..., price: _Optional[float] = ..., create_time: _Optional[_Union[_timestamp_pb2.Timestamp, _Mapping]] = ..., update_time: _Optional[_Union[_timestamp_pb2.Timestamp, _Mapping]] = ...) -> None: ...
