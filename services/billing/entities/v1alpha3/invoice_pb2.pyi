...
class InvoiceRow(_message.Message):
    __slots__ = ("client_id", "product_id", "description", "date", "columns", "rated_amount")
    ...
    def __init__(self, client_id: _Optional[str] = ..., product_id: _Optional[str] = ..., description: _Optional[str] = ..., date: _Optional[_Union[_timestamp_pb2.Timestamp, _Mapping]] = ..., columns: _Optional[_Iterable[_Union[InvoiceColumn, _Mapping]]] = ..., rated_amount: _Optional[_Union[_decimal_pb2.Decimal, _Mapping]] = ...) -> None: ...
