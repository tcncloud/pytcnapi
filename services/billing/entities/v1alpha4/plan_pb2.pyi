...
class BillingPlan(_message.Message):
    __slots__ = ("billing_plan_id", "title", "type", "is_draft", "start_time", "create_time", "update_time", "delete_time", "user_id", "org_id")
