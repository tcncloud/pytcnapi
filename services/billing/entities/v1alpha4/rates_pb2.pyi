...
class MatchingRule(_message.Message):
    ...
    def __init__(self, matching_rule_id: _Optional[str] = ..., config: _Optional[_Union[_products_pb2.ProductConfig, _Mapping]] = ..., create_time: _Optional[_Union[datetime.datetime, _timestamp_pb2.Timestamp, _Mapping]] = ..., delete_time: _Optional[_Union[datetime.datetime, _timestamp_pb2.Timestamp, _Mapping]] = ..., update_time: _Optional[_Union[datetime.datetime, _timestamp_pb2.Timestamp, _Mapping]] = ..., rule_config: _Optional[_Union[_matching_pb2.MatchingConfig, _Mapping]] = ..., country_code_prefix: _Optional[_Union[_matching_pb2.CountryCodePrefix, _Mapping]] = ...) -> None: ...
