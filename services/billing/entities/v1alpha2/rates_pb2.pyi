...
class RateDefinition(_message.Message):
    __slots__ = ("rate_definition_id", "event_type", "config_type", "matching_rule", "matching_config", "matching_sha", "create_time", "update_time", "delete_time", "effective_time", "config", "group_id")
