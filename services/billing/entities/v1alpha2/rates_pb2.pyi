...
class RateDefinitionConfigType(int, metaclass=_enum_type_wrapper.EnumTypeWrapper):
    ...
    RATE_DEFINITION_CONFIG_TYPE_OMNI_AGENT_MESSAGE_CHAT_SIZE_TOTAL: _ClassVar[RateDefinitionConfigType]
    ...
    RATE_DEFINITION_CONFIG_TYPE_OMNI_AGENT_MESSAGE_EMAIL_SIZE_TOTAL: _ClassVar[RateDefinitionConfigType]
    ...
    RATE_DEFINITION_CONFIG_TYPE_OMNI_AGENT_MESSAGE_SMS_SIZE_TOTAL: _ClassVar[RateDefinitionConfigType]
    ...
    RATE_DEFINITION_CONFIG_TYPE_OMNI_MANAGER_MESSAGE_CHAT_SIZE_TOTAL: _ClassVar[RateDefinitionConfigType]
    ...
    RATE_DEFINITION_CONFIG_TYPE_OMNI_MANAGER_MESSAGE_EMAIL_SIZE_TOTAL: _ClassVar[RateDefinitionConfigType]
    ...
    RATE_DEFINITION_CONFIG_TYPE_OMNI_MANAGER_MESSAGE_SMS_SIZE_TOTAL: _ClassVar[RateDefinitionConfigType]
    ...
    RATE_DEFINITION_CONFIG_TYPE_OMNI_SYSTEM_MESSAGE_CHAT_SIZE_TOTAL: _ClassVar[RateDefinitionConfigType]
    ...
    RATE_DEFINITION_CONFIG_TYPE_OMNI_SYSTEM_MESSAGE_EMAIL_SIZE_TOTAL: _ClassVar[RateDefinitionConfigType]
    ...
    RATE_DEFINITION_CONFIG_TYPE_OMNI_SYSTEM_MESSAGE_SMS_SIZE_TOTAL: _ClassVar[RateDefinitionConfigType]
    ...
    RATE_DEFINITION_CONFIG_TYPE_OMNI_CUSTOMER_MESSAGE_CHAT_SIZE_TOTAL: _ClassVar[RateDefinitionConfigType]
    ...
    RATE_DEFINITION_CONFIG_TYPE_OMNI_CUSTOMER_MESSAGE_EMAIL_SIZE_TOTAL: _ClassVar[RateDefinitionConfigType]
    ...
    RATE_DEFINITION_CONFIG_TYPE_OMNI_CUSTOMER_MESSAGE_SMS_SIZE_TOTAL: _ClassVar[RateDefinitionConfigType]
...
RATE_DEFINITION_CONFIG_TYPE_OMNI_AGENT_MESSAGE_CHAT_SIZE_TOTAL: RateDefinitionConfigType
...
RATE_DEFINITION_CONFIG_TYPE_OMNI_AGENT_MESSAGE_EMAIL_SIZE_TOTAL: RateDefinitionConfigType
...
RATE_DEFINITION_CONFIG_TYPE_OMNI_AGENT_MESSAGE_SMS_SIZE_TOTAL: RateDefinitionConfigType
...
RATE_DEFINITION_CONFIG_TYPE_OMNI_MANAGER_MESSAGE_CHAT_SIZE_TOTAL: RateDefinitionConfigType
...
RATE_DEFINITION_CONFIG_TYPE_OMNI_MANAGER_MESSAGE_EMAIL_SIZE_TOTAL: RateDefinitionConfigType
...
RATE_DEFINITION_CONFIG_TYPE_OMNI_MANAGER_MESSAGE_SMS_SIZE_TOTAL: RateDefinitionConfigType
...
RATE_DEFINITION_CONFIG_TYPE_OMNI_SYSTEM_MESSAGE_CHAT_SIZE_TOTAL: RateDefinitionConfigType
...
RATE_DEFINITION_CONFIG_TYPE_OMNI_SYSTEM_MESSAGE_EMAIL_SIZE_TOTAL: RateDefinitionConfigType
...
RATE_DEFINITION_CONFIG_TYPE_OMNI_SYSTEM_MESSAGE_SMS_SIZE_TOTAL: RateDefinitionConfigType
...
RATE_DEFINITION_CONFIG_TYPE_OMNI_CUSTOMER_MESSAGE_CHAT_SIZE_TOTAL: RateDefinitionConfigType
...
RATE_DEFINITION_CONFIG_TYPE_OMNI_CUSTOMER_MESSAGE_EMAIL_SIZE_TOTAL: RateDefinitionConfigType
...
RATE_DEFINITION_CONFIG_TYPE_OMNI_CUSTOMER_MESSAGE_SMS_SIZE_TOTAL: RateDefinitionConfigType
...
class RateSnapshot(_message.Message):
    ...
    user_id: str
    def __init__(self, start_date: _Optional[_Union[datetime.datetime, _timestamp_pb2.Timestamp, _Mapping]] = ..., end_date: _Optional[_Union[datetime.datetime, _timestamp_pb2.Timestamp, _Mapping]] = ..., rates: _Optional[_Iterable[_Union[RateDefinition, _Mapping]]] = ..., user_id: _Optional[str] = ...) -> None: ...
...
class RateDefinition(_message.Message):
    ...
    config_sha: str
    thread_id: str
    def __init__(self, rate_definition_id: _Optional[str] = ..., event_type: _Optional[_Union[_event_types_pb2.EventType, str]] = ..., config_type: _Optional[_Union[RateDefinitionConfigType, str]] = ..., matching_rule: _Optional[_Union[_matching_pb2.MatchingRule, str]] = ..., matching_config: _Optional[_Union[_matching_pb2.MatchingConfig, _Mapping]] = ..., matching_sha: _Optional[str] = ..., create_time: _Optional[_Union[datetime.datetime, _timestamp_pb2.Timestamp, _Mapping]] = ..., update_time: _Optional[_Union[datetime.datetime, _timestamp_pb2.Timestamp, _Mapping]] = ..., delete_time: _Optional[_Union[datetime.datetime, _timestamp_pb2.Timestamp, _Mapping]] = ..., effective_time: _Optional[_Union[datetime.datetime, _timestamp_pb2.Timestamp, _Mapping]] = ..., config: _Optional[_Union[RateDefinitionConfig, _Mapping]] = ..., group_id: _Optional[str] = ..., config_sha: _Optional[str] = ..., thread_id: _Optional[str] = ...) -> None: ...

class RateDefinitionConfig(_message.Message):
    __slots__ = ("agent_seats", "connected_inbox_poll", "connected_inbox_created", "agent_message_chat", "agent_message_chat_size", "agent_message_chat_units", "agent_message_chat_size_total", "agent_message_email", "agent_message_email_size", "agent_message_email_units", "agent_message_email_size_total", "agent_message_sms", "agent_message_sms_size", "agent_message_sms_units", "agent_message_sms_size_total", "manager_message_chat", "manager_message_chat_size", "manager_message_chat_units", "manager_message_chat_size_total", "manager_message_email", "manager_message_email_size", "manager_message_email_units", "manager_message_email_size_total", "manager_message_sms", "manager_message_sms_size", "manager_message_sms_units", "manager_message_sms_size_total", "system_message_chat", "system_message_chat_size", "system_message_chat_units", "system_message_chat_size_total", "system_message_email", "system_message_email_size", "system_message_email_units", "system_message_email_size_total", "system_message_sms", "system_message_sms_size", "system_message_sms_units", "system_message_sms_size_total", "customer_message_chat", "customer_message_chat_size", "customer_message_chat_units", "customer_message_chat_size_total", "customer_message_email", "customer_message_email_size", "customer_message_email_units", "customer_message_email_size_total", "customer_message_sms", "customer_message_sms_size", "customer_message_sms_units", "customer_message_sms_size_total", "compliance_rnd_query", "compliance_rnd_query_cached")
    ...
    AGENT_MESSAGE_CHAT_SIZE_TOTAL_FIELD_NUMBER: _ClassVar[int]
    ...
    AGENT_MESSAGE_EMAIL_SIZE_TOTAL_FIELD_NUMBER: _ClassVar[int]
    ...
    AGENT_MESSAGE_SMS_SIZE_TOTAL_FIELD_NUMBER: _ClassVar[int]
    ...
    MANAGER_MESSAGE_CHAT_SIZE_TOTAL_FIELD_NUMBER: _ClassVar[int]
    ...
    MANAGER_MESSAGE_EMAIL_SIZE_TOTAL_FIELD_NUMBER: _ClassVar[int]
    ...
    MANAGER_MESSAGE_SMS_SIZE_TOTAL_FIELD_NUMBER: _ClassVar[int]
    ...
    SYSTEM_MESSAGE_CHAT_SIZE_TOTAL_FIELD_NUMBER: _ClassVar[int]
    ...
    SYSTEM_MESSAGE_EMAIL_SIZE_TOTAL_FIELD_NUMBER: _ClassVar[int]
    ...
    SYSTEM_MESSAGE_SMS_SIZE_TOTAL_FIELD_NUMBER: _ClassVar[int]
    ...
    CUSTOMER_MESSAGE_CHAT_SIZE_TOTAL_FIELD_NUMBER: _ClassVar[int]
    ...
    CUSTOMER_MESSAGE_EMAIL_SIZE_TOTAL_FIELD_NUMBER: _ClassVar[int]
    ...
    CUSTOMER_MESSAGE_SMS_SIZE_TOTAL_FIELD_NUMBER: _ClassVar[int]
    ...
    agent_message_chat_size_total: _modules_pb2.BasicUnitConfig
    ...
    agent_message_email_size_total: _modules_pb2.BasicUnitConfig
    ...
    agent_message_sms_size_total: _modules_pb2.BasicUnitConfig
    ...
    manager_message_chat_size_total: _modules_pb2.BasicUnitConfig
    ...
    manager_message_email_size_total: _modules_pb2.BasicUnitConfig
    ...
    manager_message_sms_size_total: _modules_pb2.BasicUnitConfig
    ...
    system_message_chat_size_total: _modules_pb2.BasicUnitConfig
    ...
    system_message_email_size_total: _modules_pb2.BasicUnitConfig
    ...
    system_message_sms_size_total: _modules_pb2.BasicUnitConfig
    ...
    customer_message_chat_size_total: _modules_pb2.BasicUnitConfig
    ...
    customer_message_email_size_total: _modules_pb2.BasicUnitConfig
